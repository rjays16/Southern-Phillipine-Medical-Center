...
class UploadHandler
{
	...
	*/
    ...
    public function delete($print_response = true) {
        ...
        if ($success) {
            foreach($this->options['image_versions'] as $version => $options) {
                ...
                $info = '';
                #dirname($_SERVER['SCRIPT_FILENAME']).'/files/'
    ...
    function add_info_db($data){
        ...
        $values = "'".$encounter_nr."','".$name."','".$type."','".$size."','".$description."','".$url."','".$path."','".$path_thumb."','".$doc_type."','".$uploader."','".$date_created."',".$history.",'".$encounter_nr."'";
