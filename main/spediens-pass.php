<?php
# created by: syboy 11/19/2015 : meow
# Report Launcher in System Admin Tool
...
{
	case "reportgen": 
                    $allowedarea=array('_a_1_sptool_report_launcher');
                    $dept_nr = '214';
                    $fileforward=$root_path."modules/reports/report_launcher.php".$append."&from=".$src."&dept_nr=".$dept_nr;
                    break;
