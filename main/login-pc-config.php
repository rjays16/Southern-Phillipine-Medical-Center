...
# href for the  help button
 ...
 # Body onLoad js code
 $welcome_text = "Welcome, <b>".$HTTP_SESSION_VARS['sess_login_username']."</b>&nbsp;|";
 $smarty->assign('sOnLoadJs','onLoad="window.parent.document.getElementById(\'banner\').contentDocument.getElementById(\'logout_link\').style.display=\'inline\';window.parent.document.getElementById(\'banner\').contentDocument.getElementById(\'login_link\').style.display=\'none\';window.parent.document.getElementById(\'banner\').contentDocument.getElementById(\'login_username\').innerHTML=\''.addslashes($welcome_text).'\';window.parent.STARTPAGE.location.href=\'indexframe.php'.URL_REDIRECT_APPEND.'\'"');
