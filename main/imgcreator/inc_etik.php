...
#		ImageTTFText($im,10,0,105,24,$black,$arial,formatDate2Local($result['encounter_date'],$date_format));   # burn commented: May 9, 2007

		if ($result['encounter_type']==3 || $result['encounter_type']==4){
			ImageTTFText($im,10,0,105,24,$black,$arial,formatDate2Local($result['admission_dt'],$date_format));
		}else{
			ImageTTFText($im,10,0,105,24,$black,$arial,formatDate2Local($result['er_opd_datetime'],$date_format));
		}

		ImageTTFText($im,9,0,195,11,$black,$arial,"$LDAdmitTime:");
#		ImageTTFText($im,10,0,205,24,$black,$arial,formatDate2Local($result['encounter_date'],$date_format,1,1)); # burn commented: May 9, 2007

		if ($result['encounter_type']==3 || $result['encounter_type']==4){
			ImageTTFText($im,10,0,205,24,$black,$arial,formatDate2Local($result['admission_dt'],$date_format,1,1));
		}else{
			ImageTTFText($im,10,0,205,24,$black,$arial,formatDate2Local($result['er_opd_datetime'],$date_format,1,1));
		}
	...
	// diagnosis, therapie, 
		...
		ImageString($im,1,100,1,"$LDAdmitDate:az",$black);
#		ImageString($im,4,105,9,formatDate2Local($result['encounter_date'],$date_format),$black);   # burn commented : May 9, 2007

		if ($result['encounter_type']==3 || $result['encounter_type']==4){
			ImageString($im,4,105,9,formatDate2Local($result['admission_dt'],$date_format),$black);
		}else{
			ImageString($im,4,105,9,formatDate2Local($result['er_opd_datetime'],$date_format),$black);
		}

		ImageString($im,1,195,1,"$LDAdmitTime:",$black);
#		ImageString($im,4,205,9,formatDate2Local($result['encounter_date'],$date_format,1,1),$black);   # burn commented : May 9, 2007
		if ($result['encounter_type']==3 || $result['encounter_type']==4){
			ImageString($im,4,205,9,formatDate2Local($result['admission_dt'],$date_format,1,1),$black);
		}else{
			ImageString($im,4,205,9,formatDate2Local($result['er_opd_datetime'],$date_format,1,1),$black);
		}
		ImageString($im,1,290,1,"$LDDept:",$black);
#		ImageString($im,4,295,9,$result['current_dept'],$black);   # burn commented : May 9, 2007
		ImageString($im,4,295,9,$result['name_formal'],$black);   # burn addeded : May 9, 2007
...
#		ImageString($im,4,485,9,$result['encounter_type'],$black);   # burn commented : May 9, 2007
		if ($result['encounter_type']==1){
			ImageString($im,4,485,9,"ER",$black); 
		}elseif ($result['encounter_type']==2){
			ImageString($im,4,485,9,"Outpatient",$black); 
		}elseif ($result['encounter_type']==3){
			ImageString($im,4,485,9,"Inpatient(ER)",$black); 
		}elseif ($result['encounter_type']==4){
			ImageString($im,4,485,9,"Inpatient(OPD)",$black); 
		}
...
#		ImageString($im,3,10,90,$result['addr_str'].' '.$result['addr_str_nr'],$black);   # burn commented : May 9, 2007
#		ImageString($im,3,10,105,$result['addr_zip'].' '.$result['name'],$black);   # burn commented : May 9, 2007
		ImageString($im,3,10,90,$result['street_name'].', '.$result['brgy_name'],$black);   # burn added : May 9, 2007
		ImageString($im,3,10,105,$result['mun_name'].' '.$result['zipcode'].' '.$result['prov_name'],$black);   # burn added : May 9, 2007
...
#			ImageTTFText($im,12,0,10,185,$black,$arial,ucfirst($result['addr_str']).' '.$result['addr_str_nr']);   # burn commented : May 9, 2007
#			ImageTTFText($im,12,0,10,200,$black,$arial,ucfirst($result['addr_zip']).' '.$result['name']);   # burn commented : May 9, 2007
			ImageTTFText($im,12,0,10,185,$black,$arial,ucfirst($result['street_name']).', '.$result['brgy_name']);   # burn added : May 9, 2007
			ImageTTFText($im,12,0,10,200,$black,$arial,$result['mun_name'].' '.$result['zipcode'].' '.$result['prov_name']);   # burn added : May 9, 2007
		}else{
			ImageString($im,3,10,160,$result['name_last'].', '.$result['name_first'],$black);
#			ImageString($im,3,10,175,$result['addr_str'].' '.$result['addr_str_nr'],$black);   # burn commented : May 9, 2007
#			ImageString($im,3,10,190,$result['addr_zip'].' '.$result['name'],$black);   # burn commented : May 9, 2007
			ImageString($im,3,10,175,$result['street_name'].', '.$result['brgy_name'],$black);   # burn added : May 9, 2007
			ImageString($im,3,10,190,$result['mun_name'].' '.$result['zipcode'].' '.$result['prov_name'],$black);   # burn added : May 9, 2007
		}
	} else {
...
#		ImageTTFText($label,11,0,$lmargin,$tmargin+30,$eblack,$arial,formatDate2Local($result['encounter_date'],$date_format));   # burn commented : May 9, 2007

		if ($result['encounter_type']==3 || $result['encounter_type']==4){
			ImageTTFText($label,11,0,$lmargin,$tmargin+30,$eblack,$arial,formatDate2Local($result['admission_dt'],$date_format));
		}else{
			ImageTTFText($label,11,0,$lmargin,$tmargin+30,$eblack,$arial,formatDate2Local($result['er_opd_datetime'],$date_format));
		}
...
#		ImageTTFText($label,11,0,$lmargin,$tmargin+93,$eblack,$arial,ucfirst($result['addr_str'].' '.$result['addr_str_nr']));   # burn commented : May 9, 2007
		ImageTTFText($label,11,0,$lmargin,$tmargin+93,$eblack,$arial,$result['street_name'].', '.$result['brgy_name']);
		# Address, zip, city/town name
#		ImageTTFText($label,11,0,$lmargin,$tmargin+108,$eblack,$arial,ucfirst($result['addr_zip']).' '.$result['name']);   # burn commented : May 9, 2007
		ImageTTFText($label,11,0,$lmargin,$tmargin+108,$eblack,$arial,$result['mun_name'].' '.$result['zipcode'].' '.$result['prov_name']);		
		# Sex
		...
		# encounter date
#		ImageString($label,2,2,18,formatDate2Local($result['encounter_date'],$date_format),$black);    # burn commented : May 9, 2007

		if ($result['encounter_type']==3 || $result['encounter_type']==4){
			ImageString($label,2,2,18,formatDate2Local($result['admission_dt'],$date_format),$black);
		}else{
			ImageString($label,2,2,18,formatDate2Local($result['er_opd_datetime'],$date_format),$black);
		}
...
#		ImageString($label,4,10,75,$result['addr_str'].' '.$result['addr_str_nr'],$black);    # burn commented : May 9, 2007
#		ImageString($label,4,10,90,$result['addr_zip'].' '.$result['name'],$black);    # burn commented : May 9, 2007
		ImageString($label,4,10,75,$result['street_name'].', '.$result['brgy_name'],$black);
		ImageString($label,4,10,90,$result['mun_name'].' '.$result['zipcode'].' '.$result['prov_name'],$black);
...
#		ImageTTFText($label2,9,0,105,45,$black,$arial,formatDate2Local($result['encounter_date'],$date_format));   # burn commented : May 9, 2007

		if ($result['encounter_type']==3 || $result['encounter_type']==4){
			ImageTTFText($label2,9,0,105,45,$black,$arial,formatDate2Local($result['admission_dt'],$date_format));
		}else{
			ImageTTFText($label2,9,0,105,45,$black,$arial,formatDate2Local($result['er_opd_datetime'],$date_format));
		}
...
#		ImageString($label2,2,110,34,formatDate2Local($result['encounter_date'],$date_format),$black);   # burn commented : May 9, 2007

		if ($result['encounter_type']==3 || $result['encounter_type']==4){
			ImageString($label2,2,110,34,formatDate2Local($result['admission_dt'],$date_format),$black);
		}else{
			ImageString($label2,2,110,34,formatDate2Local($result['er_opd_datetime'],$date_format),$black);
		}
...
#	$addr1=$result['addr_str'].' '.$result['addr_str_nr'];   # burn commented : May 9, 2007
#	$addr2= $result['addr_zip'].' - '.$result['name'];   # burn commented : May 9, 2007
	$addr1 = $result['street_name'].', '.$result['brgy_name'];   # burn added : May 9, 2007
	$addr2 = $result['mun_name'].' '.$result['zipcode'].' '.$result['prov_name'];   # burn added : May 9, 2007
	
	if($ttf_ok){
		ImageTTFText($label3,12,0,10,11,$black,$arial,$full_en);
#		ImageTTFText($label3,9,0,110,11,$black,$arial,formatDate2Local($result['encounter_date'],$date_format));   # burn commented : May 9, 2007

		if ($result['encounter_type']==3 || $result['encounter_type']==4){
			ImageTTFText($label3,9,0,110,11,$black,$arial,formatDate2Local($result['admission_dt'],$date_format));
		}else{
			ImageTTFText($label3,9,0,110,11,$black,$arial,formatDate2Local($result['er_opd_datetime'],$date_format));
		}
...
#		ImageString($label3,2,110,2,formatDate2Local($result['encounter_date'],$date_format),$black);   # burn commented : May 9, 2007

		if ($result['encounter_type']==3 || $result['encounter_type']==4){
			ImageString($label3,2,110,2,formatDate2Local($result['admission_dt'],$date_format),$black);
		}else{
			ImageString($label3,2,110,2,formatDate2Local($result['er_opd_datetime'],$date_format),$black);
		}
