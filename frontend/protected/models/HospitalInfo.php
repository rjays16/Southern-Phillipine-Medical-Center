 ...
 */
class HospitalInfo extends \CareActiveRecord
{
    /**
     ...
     * @return HospitalInfo the static model class
     */
    ...
    /**
     * Header data for reports
     * @return self
     */
    public static function getReportHeaderInfo()
    {
        $hospitalInfo = self::model()->find(array(
            'select' => 'hosp_country,hosp_agency,hosp_name,hosp_addr1'
        ));
        if (!$hospitalInfo) {
            $hospitalInfo->hosp_country = "Republic of the Philippines";
            $hospitalInfo->hosp_agency = "DEPARTMENT OF HEALTH";
            $hospitalInfo->hosp_name = "DAVAO MEDICAL CENTER";
            $hospitalInfo->hosp_addr1 = "JICA Bldg., JP Laurel Avenue, Davao City";
        }
        return $hospitalInfo;
    }
