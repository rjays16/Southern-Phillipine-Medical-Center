 ...
 */
class NotificationRestConnection extends \CApplicationComponent
{
    public $url;
    public $company = 0;
    public $userid;
    ...
    public function get($resource, $urlData = array(), $data = array())
    {
        try {
            ...
            \Yii::log($ex->getMessage(), 'error', 'notification.NotificationActiveResource.get');
            throw $ex;
    ...
    public function post($resource, $urlData = array(), $data)
    {
        try {
            ...
            \Yii::log($ex->getMessage(), 'error', 'notification.NotificationActiveResource.post');
            throw $ex;
