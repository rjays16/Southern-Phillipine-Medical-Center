 ...
 * @property LaboratoryRequest $request
 */
class LaboratoryRequestItem extends \CareActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('is_in_house, is_forward, is_served, is_converted, is_monitor, is_posted_lis', 'numerical', 'integerOnly'=>true),
			...
			array('manual_doctor, clerk_served_by, sent_out_by', 'length', 'max'=>100),
			...
			array('refno, service_code, price_cash, price_cash_orig, price_charge, request_doctor, manual_doctor, request_dept, is_in_house, clinical_info, status, is_forward, is_served, is_converted, date_served, clerk_served_by, clerk_served_date, quantity, old_qty_request, reason_sent_out, sent_out_date, sent_out_by, is_monitor, parent_refno, request_flag, no_gel_tubes, cancel_reason, is_posted_lis, history', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'request' => array(self::BELONGS_TO, 'SegHis\modules\laboratory\models\LaboratoryRequest', 'refno'),                    
                        'service' => array(self::BELONGS_TO, 'SegHis\modules\packageManager\models\LabServices', 'service_code')
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('is_converted',$this->is_converted);
	 ...
	 * @return LaboratoryRequestItem the static model class
	 */
