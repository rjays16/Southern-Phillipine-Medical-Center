 ...
 * @property RadiologyRequestItem[] $items
 */
class RadiologyRequest extends \CareActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('refno, request_date, request_time, is_cash, modify_id, create_id', 'required'),
	...
	public function relations()
	{
		...
		return array(
			'items' => array(self::HAS_MANY, 'SegHis\modules\radiology\models\RadiologyRequestItem', 'refno')
		);
	}
	 ...
	 * @return RadiologyRequest the static model class
	 */
