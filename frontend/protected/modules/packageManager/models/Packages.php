...
class Packages extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('is_surgical, is_zpackage, is_er, is_dialysis,is_opd, is_ipd,is_hssc, is_deleted, clinic_id', 'numerical', 'integerOnly'=>true),
			...
			array('package_id, package_name, package_price, is_surgical, pkg_phiccode, is_zpackage, is_er, is_opd, is_ipd,is_hssc, create_id, modify_id, create_time, modify_time, history, clinic_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('is_hssc',$this->is_hssc);
		$criteria->compare('is_deleted',$this->is_deleted);
		$criteria->compare('is_dialysis',$this->is_dialysis);
