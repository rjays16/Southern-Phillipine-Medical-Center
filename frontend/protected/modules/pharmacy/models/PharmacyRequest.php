 ...
 * @property PharmacyRequestItem[] $items
 */
class PharmacyRequest extends \CareActiveRecord
{
    /**
    ...
    public function relations()
    {
        ...
        return array(
            'items' => array(self::HAS_MANY, 'SegHis\modules\pharmacy\models\PharmacyRequestItem', 'refno')
        );
    }
     ...
     * @return PharmacyRequest the static model class
     */
