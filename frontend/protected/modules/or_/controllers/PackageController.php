...
class PackageController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if(!empty($_GET['search'])){
            ...
            // CVarDumper::dump($packageDetailsModel);die;
        ...
        // CVarDumper::dump($package_name);die;
        $this->render(
            'index',
            array(
                ...
                switch ($value->item_purpose) {
                    case 'PH':
                        ...
                        if (strtoupper($pharmaProductModel->prod_class)
                            ...
                            $drfIndex = array_search($pharmaProductModel->bestellnum, $item_code);
                            $this->savePharmaCf4(
                                $pharmaHId, $pharmaProductModel->bestellnum,
                                $dosage[$drfIndex], $frequency[$drfIndex], $route[$drfIndex]
                            );
