...
class PharmaProductsMain extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('unit, item_name, item_code, barcode, bestellnum, artikelnum, industrynum, artikelname, generic, description, packing, prod_class, minorder, maxorder, proorder, picfile, encoder, enc_date, enc_time, lock_flag, is_fs, is_socialized, is_restricted, classification, medgroup, cave, status, price_cost, price_cash, price_charge, history, modify_id, modify_time, create_id, create_time, ref_source, is_deleted, category_id, remarks', 'safe', 'on'=>'search'),
		);
	}
