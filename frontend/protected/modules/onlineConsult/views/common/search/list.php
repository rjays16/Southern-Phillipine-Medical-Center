...
if(($_a_2_opdonlinerequest && !($_a_2_opdonlinecreateconsult)  ||  $_a_2_opdonlineregister)){
    $access_create = true;
}else{
     $access_create = false;
}
                ...
                <div class="span4">
                    ...
                    if($access_create){
                          $this->widget('bootstrap.widgets.TbButton', array(
                                        ...
                                        'htmlOptions' => array(
                                            'class' => 'pull-right',
                                            'data-param-url' => Yii::app()->createUrl("onlineConsult/online/createPatient")
                                        )
                            ));
                    }else{
                           $this->widget('bootstrap.widgets.TbButton', array(
                            ...
                            'buttons'           => array(
                                'viewHistory' => array(
                                    ...
                                    'options' => array(
                                        ...
                                        'data-param-url'       => Yii::app()->createUrl("onlineConsult/online/view_history")
                                    ),
                                )
                            ),
                            'headerHtmlOptions' => array(
