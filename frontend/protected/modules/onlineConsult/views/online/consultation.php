...
$form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
    ...
    'htmlOptions'          => array(
        'data-url' => $this->createUrl('/onlineConsult/consultation/saveConsultation')
    )
));
...
<script type="text/javascript">
    ...
    $('#create-consultation-form').submit(function (e) {
        ...
        if(typeof enc_nr !== typeof undefined && enc_nr != ''){
            url = loc.protocol + "//"+ loc.host + "/" + loc.pathname.split('/')[1]+'/index.php?r=onlineConsult/consultation/updateConsultation/encounter_nr/'+ enc_nr;
