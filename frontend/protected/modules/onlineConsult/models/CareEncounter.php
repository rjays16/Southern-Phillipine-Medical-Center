...
Yii::import('application.models.EncounterType');
 ...
 * @property integer $to_be_discharge
 ...
 * @property string $DEPOvaccine_history
 * @property integer $er_location
 * @property integer $er_location_lobby
 * @property integer $is_expired
 *
 * The followings are the available model relations:
 * @property AccommodationTrail[] $accommodationTrails
 * @property AuditDiet[] $auditDiets
 * @property BillingEncounter[] $billingEncounters
 * @property BillingappliedDiscount[] $billingappliedDiscounts
 * @property CbgReading[] $cbgReadings
 * @property CharityGrants[] $charityGrants
 * @property CharityGrantsExpiry[] $charityGrantsExpiries
 * @property CreditCollectionLedger[] $creditCollectionLedgers
 * @property CreditcollectionCashGrants[] $creditcollectionCashGrants
 * @property DialysisRequest $dialysisRequest
 * @property DietOrder[] $dietOrders
 * @property DietOrderCutOff[] $dietOrderCutOffs
 * @property DischargeSlipInfo[] $dischargeSlipInfos
 * @property DoctorsDiagnosis[] $doctorsDiagnosises
 * @property CarePersonell[] $carePersonells
 * @property EclaimsCf4[] $eclaimsCf4s
 * @property EclaimsEligibility[] $eclaimsEligibilities
 * @property EclaimsVerificationLog $eclaimsVerificationLog
 * @property EncounterCase[] $encounterCases
 * @property EncounterConfinement[] $encounterConfinements
 * @property EncounterDrMgt[] $encounterDrMgts
 * @property CareIcd10En[] $careIcd10Ens
 * @property CareOps301En[] $careOps301Ens
 * @property EncounterLocationAddtl[] $encounterLocationAddtls
 * @property CareEncounterLocation[] $careEncounterLocations
 * @property EncounterMemcategory $encounterMemcategory
 * @property EncounterProfile[] $encounterProfiles
 * @property EncounterReimbursed $encounterReimbursed
 * @property EncounterSservice $encounterSservice
 * @property EncounterVitalSign[] $encounterVitalSigns
 * @property EtransmittalXml[] $etransmittalXmls
 * @property IndustrialTransaction[] $industrialTransactions
 * @property MiscChrg[] $miscChrgs
 * @property MiscOps[] $miscOps
 * @property MiscService[] $miscServices
 * @property MorePhorder[] $morePhorders
 * @property OpsServ[] $opsServs
 * @property OrRequest[] $orRequests
 * @property PayDeposit[] $payDeposits
 * @property PdpuProgressNotes[] $pdpuProgressNotes
 * @property PharmaReturns[] $pharmaReturns
 * @property PocOrder[] $pocOrders
 * @property Referral[] $referrals
 * @property Transmittal[] $segTransmittals
 * @property UsedCoverage[] $usedCoverages
 */
class CareEncounter extends CareActiveRecord
{
    public $meeting_id;
    ...
    public function rules()
    {
        ...
        return array(
            array('encounter_nr, encounter_type, referrer_diagnosis, referrer_dr, referrer_notes, consulting_dr, extra_service, post_encounter_notes, status, history, modify_id, modify_time, create_id, mgh_setdte', 'required'),
            array('encounter_class_nr, encounter_type, consulting_dept_nr, consulting_dr_nr, financial_class_nr, insurance_class_nr, guarantor_pid, contact_pid, current_ward_nr, current_room_nr, in_ward, current_dept_nr, in_dept, current_firm_nr, current_att_dr_nr, is_discharged, to_be_discharge, monthly_income, nr_dependents, is_medico, is_confidential, is_DOA, category, is_served, is_maygohome, er_location, er_location_lobby, is_expired', 'numerical', 'integerOnly'=>true),
            ...
            array('smoker_history, drinker_history, DEPOvaccine_history', 'length', 'max'=>3),
    ...
    public function relations()
    {
        ...
        return array(
            'department' => array(self::BELONGS_TO, 'CareDepartment', 'current_dept_nr'),
            'enctype' => array(self::BELONGS_TO, 'EncounterType', 'encounter_type'),
            'onlinemeeting' => array(self::HAS_MANY, 'ConsultMeeting', 'encounter_nr')
        );
    }
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'DEPOvaccine_history' => 'Depovaccine History',
            'er_location' => 'Er Location',
            'er_location_lobby' => 'Er Location Lobby',
    ...
    public function search()
    {
        ...
        $criteria->compare('to_be_discharge',$this->to_be_discharge);
        ...
        $criteria->compare('DEPOvaccine_history',$this->DEPOvaccine_history,true);
        $criteria->compare('er_location',$this->er_location);
        $criteria->compare('er_location_lobby',$this->er_location_lobby);
     ...
     * @return CareEncounter the static model class
     */
    ...
    public function getTransactionHistory($pid){
        $type = new EncounterType;
        $criteria = new CDbCriteria();

        $criteria->select = array("t.*", "scm.id AS meeting_id");

        $criteria->addCondition('t.pid = "' . $pid . '"');

        $criteria->addNotInCondition('t.encounter_type', array($type::TYPE_DIALYSIS,$type::TYPE_WELLBABY));

        $criteria->addNotInCondition('t.status', array('deleted','hidden','inactive','void'));

        $criteria->order = "t.encounter_date DESC";
        $criteria->join = "LEFT JOIN seg_consult_meeting scm ON t.encounter_nr = scm.encounter_nr";
