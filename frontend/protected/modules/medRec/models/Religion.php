 ...
 */
class Religion extends CareActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('religion_name, modify_id, create_id', 'length', 'max'=>50),
            array('modify_date, create_date', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('religion_nr, religion_name, modify_id, modify_date, create_id, create_date', 'safe', 'on'=>'search'),
        );
    }
    ...
    public static function model($className=__CLASS__)
    {
     ...
     public function getAllReligion(){
        ...
        $criteria->order = "religion_name ASC";
