...
use SegHis\modules\medRec\services\PersonService;
...
class OnlineController extends Controller
{
    ...
    {
        $model = ConsultRequest::model()->getTriagedOnlineRequests();
    ...
    public function actionView_history($pid, $id)
    {
        ...
        $this->render('view_history', array(
                ...
                'selected_dept'    => $getRequest->dept_nr,
                'selected_doctor'  => $getRequest->doctor_id
            )
        );
    }
