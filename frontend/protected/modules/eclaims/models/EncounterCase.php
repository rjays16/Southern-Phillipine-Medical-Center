 ...
 * @property TypeCase $casetype
 */
class EncounterCase extends CActiveRecord
{
    /**
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'casetype' => array(self::BELONGS_TO, 'TypeCase', 'casetype_id'),
        );
    }
     ...
     * @return EncounterCase the static model class
     */
