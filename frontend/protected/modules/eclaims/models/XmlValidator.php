<?php
    class XmlValidator {
        ...
        private $_encounterNr;

        public function __construct (DOMDocument $pDocument,$_encounterNr) {
            $this->_delegate = $pDocument;
            $this->_validationErrors = array();
            $this->_encounterNr = $_encounterNr;
            $this->_validationErrors[] =  $this->_encounterNr;
        }
