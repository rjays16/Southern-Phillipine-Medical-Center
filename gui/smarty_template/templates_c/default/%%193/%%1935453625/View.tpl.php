<?php /* Smarty version 2.6.0, created on 2021-01-06 12:37:36
...
&w=96" width="96" height="96" style="-moz-border-radius:8px" /></span>
							<br/>
							<br/>
...
><img src="../../gui/img/common/default/rx.png"/>Prescription</button>
							...
							<button class="button" onclick="PatientHistory_openDischargeSlip();return false;" <?php echo $this->_tpl_vars['show_er'];  echo $this->_tpl_vars['enable'];  echo $this->_tpl_vars['disableRad']; ?>
><img src="../../gui/img/common/default/page_green.png"/>Discharge Slip</button>

							<button class="button" onclick="OpenPH_IpbmSlip(<?php echo $this->_tpl_vars['pat']['encounter_type']; ?>
);return false;"<?php echo $this->_tpl_vars['show_ipbm'];  echo $this->_tpl_vars['enable'];  echo $this->_tpl_vars['disableRad']; ?>
><img src="../../gui/img/common/default/page_paste.png"/>Discharge Slip</button>

							<button class="button" onclick="open_medicalAbstract('<?php echo $this->_tpl_vars['pat']['encounter']; ?>
',0);return false;" <?php echo $this->_tpl_vars['disableabst'];  echo $this->_tpl_vars['hide_abstract']; ?>
><img src="../../gui/img/common/default/pdf-icon.png"/>Medical Abstract</button>					
							<!-- <button class="button" onclick="PatientHistory_IpbmDischargeSlipIPD();return false;"<?php echo $this->_tpl_vars['show_ipbm'];  echo $this->_tpl_vars['enable'];  echo $this->_tpl_vars['disableRad']; ?>
><img src="../../gui/img/common/default/page_paste.png"/>Discharge Slip</button> -->
							...
							<?php echo $this->_tpl_vars['psymedcert']; ?>

							<!-- end -->
							<?php echo $this->_tpl_vars['sDeathButton']; ?>
...
<?php echo $this->_tpl_vars['isinfant']; ?>

<?php echo $this->_tpl_vars['hasSaved']; ?>
...
function PatientHistory_IpbmDischargeSlip()
{
	Dashboard.launcher.launch({
		...
		href:'../../modules/dashboard/ipbm-discharge-slip.php<?php echo $this->_tpl_vars['URL_APPEND']; ?>
&encounter_nr=<?php echo $this->_tpl_vars['pat']['encounter']; ?>
&encounter_type=<?php echo $this->_tpl_vars['pat']; ?>
',
		width: 820,
		height: 450
	})
...
function PatientHistory_IpbmDischargeSlipIPD()
{
	Dashboard.launcher.launch({
		...
		href:'../../modules/dashboard/ipbm-discharge-slip-ipd.php<?php echo $this->_tpl_vars['URL_APPEND']; ?>
&encounter_nr=<?php echo $this->_tpl_vars['pat']['encounter']; ?>
&encounter_type=<?php echo $this->_tpl_vars['pat']; ?>
',
		width: 820,
...
function PatientHistory_IpbmDischargeSlipIPDnew()
{
	Dashboard.launcher.launch({
		title:'IPBM Discharge Slip IPD',
		href:'../../modules/dashboard/ipbm-discharge-slip-ipd-new.php<?php echo $this->_tpl_vars['URL_APPEND']; ?>
&encounter_nr=<?php echo $this->_tpl_vars['pat']['encounter']; ?>
&encounter_type=<?php echo $this->_tpl_vars['pat']; ?>
',
		width: 820,
...
&user_from=DOCTOR'+'&enc_accomodation=<?php echo $this->_tpl_vars['pat']['accomodation']; ?>
...
function PatientHistory_referPatient(doc_nr){
	var penc = "<?php echo $this->_tpl_vars['pat']['encounter']; ?>
";
...
function PatientInformation_deathCertificate() {
	...
	Dashboard.launcher.launch({
		...
		href:'../../modules/dashboard/DeathCertificate.php<?php echo $this->_tpl_vars['URL_APPEND']; ?>
&encounter_nr=<?php echo $this->_tpl_vars['pat']['encounter']; ?>
&pid=<?php echo $this->_tpl_vars['pat']['pid']; ?>
&isinfant='+isinfant,
		width: 1195,
