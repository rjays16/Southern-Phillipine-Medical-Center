<?php /* Smarty version 2.6.0, created on 2020-10-30 13:29:00
         compiled from system_admin/discount.tpl */ ?>
<br>
<div align="center">
			...
			<table class="segList" width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tbody>
					<tr>
						...
						<td><?php echo $this->_tpl_vars['sSetBillAreasApplied']; ?>
&nbsp;<input type="button" style="font:bold 12px Arial" value="Add" onClick="js_prepareAdd()"></td>
						<!-- -->						
					</tr>
				</tbody>
			</table>
...
<table border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td width="2">&nbsp;</td>
		<td><?php echo $this->_tpl_vars['sBreakButton']; ?>
</td>
	</tr>
</table>
</div>
...
<?php echo $this->_tpl_vars['sHiddenFields']; ?>
