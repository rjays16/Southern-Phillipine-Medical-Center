<?php /* Smarty version 2.6.0, created on 2021-08-10 11:14:44
...
<script>
	...
	var appid = "<?php echo $this->_tpl_vars['appID']; ?>
";

	if (window.parent[0]) {
		document.getElementById("onesignalidLogin").value = window.parent.$('onesignalid').value;
		console.log(document.getElementById("onesignalidLogin").value);
	}else{
	       ...
	       OneSignal.init({
	            appId: appid,
			   	...
			   	OneSignal.getUserId().then(function(userId) {
				   	...
				   	document.getElementById('onesignalidLogin').value = userId;
		   		});
	        });
	    });
	}
