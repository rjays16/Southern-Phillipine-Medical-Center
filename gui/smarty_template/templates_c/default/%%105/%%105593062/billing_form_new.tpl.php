<?php /* Smarty version 2.6.0, created on 2021-08-20 16:59:31
         compiled from billing_new/billing_form_new.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'billing_new/billing_form_new.tpl', 130, false),)), $this); ?>
...
<div id="mainTablediv" align="center">
    <table width="96%" cellpadding="0" cellspacing="3">
        ...
        <tr>
            ...
            -->
            <td style="min-width: 110px; max-width: 150px;" valign="bottom" align="right"><?php echo $this->_tpl_vars['sBtnAuditTrail']; ?>
</td>
            <td width="8" valign="bottom" align="left"><?php echo $this->_tpl_vars['sBtnInsurance2']; ?>
</td>
            ...
            <!-- <?php echo $this->_tpl_vars['sBtnCSFp2Blank']; ?>
 // commented by carriane 02/14/2020 BUG 2694-->
            <!-- <?php echo $this->_tpl_vars['sBtnCSFp2']; ?>
 // commented by carriane 02/14/2020 BUG 2694-->
            <?php echo $this->_tpl_vars['sBtnPrint32']; ?>

            <!-- <?php echo $this->_tpl_vars['sBtnCF2Part3']; ?>
 // commented by carriane 02/14/2020 BUG 2694-->
			<?php echo $this->_tpl_vars['sBtnCF2Part3']; ?>

            <?php echo $this->_tpl_vars['sBtnRecalc']; ?>
    ...
    <table width="96%" cellpadding="2" cellspacing="2" id="mainTable"
        ...
        <tr>
            <th id="billcol_01" colspan="2" rowspan="2" align="left" class="jedPanelHeader" style="border-right:none">
                BILLING STATEMENT&nbsp;&nbsp;<?php echo $this->_tpl_vars['sBillStatus']; ?>
</th>
            ...
            <th class="jedPanelHeader" style="border-left:none" align="right">
                <div id="categ_col" style="display:none; float:right;"><?php echo $this->_tpl_vars['sMembershipCategory']; ?>
&nbsp;MEMBERSHIP CATEGORY:<img
 ...
 <span name="eclaims_dte"
                        ...
                        <td id="confine_cbobox" width="15%" align="left" valign="top"
                            style="display:none"><?php echo $this->_tpl_vars['sDrpConfinement']; ?>
</td>
                    </tr>
                    <tr class="jedPanel">
 ...
 <?php echo $this->_tpl_vars['sOverwrite']; ?>
</td>
                    ...
                    <tr class="jedPanel">
                        ...
                        <td width="15%" align="left" valign="middle"> 
                            <select id="opd_area" name="opd_area" class="segInput" onchange="jsonChangeOpdArea()">
                                ...
                                <?php if (isset($this->_foreach['areas'])) unset($this->_foreach['areas']);
$this->_foreach['areas']['name'] = 'areas';
$this->_foreach['areas']['total'] = count($_from = (array)$this->_tpl_vars['opdAreas']);
$this->_foreach['areas']['show'] = $this->_foreach['areas']['total'] > 0;
if ($this->_foreach['areas']['show']):
$this->_foreach['areas']['iteration'] = 0;
    foreach ($_from as $this->_tpl_vars['area']):
        $this->_foreach['areas']['iteration']++;
        $this->_foreach['areas']['first'] = ($this->_foreach['areas']['iteration'] == 1);
        $this->_foreach['areas']['last']  = ($this->_foreach['areas']['iteration'] == $this->_foreach['areas']['total']);
?>
                                <option value="<?php echo $this->_tpl_vars['area']['id']; ?>
" data-atype="<?php echo $this->_tpl_vars['area']['accomodation_type']; ?>
">
                            ...
                            <!-- <?php echo smarty_function_html_options(array('id' => 'opd_area','class' => 'segInput','onchange' => "jsonChangeOpdArea();",'options' => $this->_tpl_vars['opdAreas'],'name' => 'opd_area'), $this);?>
 -->
                        </td>
                    </tr>
                            <tr>
                                <td width="*" align="right"><strong>Remarks:</strong></td>
                                <td width="50px" align="left"><?php echo $this->_tpl_vars['sRemarks']; ?>
</td>
                    ...
                    <tr class="jedPanel">
                        ...
                        <td colspan="5">&nbsp&nbsp<?php echo $this->_tpl_vars['trailnotebtn']; ?>
</td>
                    </tr> 
                </table>
            </td>
        ...
        <div id="accommodation_div" align="center">
                        ...
                        <table id="accListDetails" width="100%" cellpadding="0" cellspacing="0" border="1"
                            ...
                            <tr>
                                ...
                                <th align="left" width="*" style="font-weight:bold; font-size:15px;">
                                    Accommodation&nbsp;<?php echo $this->_tpl_vars['sBtnAddAccommodation']; ?>

                                    <label onmouseover="return overlib('Payward settlement used for printing SOA');"
                                           onmouseout="nd();">
                                        <?php echo $this->_tpl_vars['sChckPaywardSettlement']; ?>
                            ...
                            <tr>
                                <td class="billftr1" align="left" colspan="2">
                                    ...
                                    <span id="accProgBar"
                                          class="acc-loading loading-ui-animation"><?php echo $this->_tpl_vars['sProgBar']; ?>
</span><br/>
                                    <span>&nbsp;</span>
                                </td>
            ...
            <div id="xlo-tabs">
                <ul>
                    ...
                    <li><?php echo $this->_tpl_vars['sBtnAddMiscService']; ?>
</li>
                    <li><?php echo $this->_tpl_vars['sConvertCpsUnpaid']; ?>
</li>
                    <li>
                        <span id="hsProgBar" class="xlo-loading loading-ui-animation"><?php echo $this->_tpl_vars['sProgBar']; ?>
</span>
                                            </li>
                </ul>
                    ...
                    <table id="mdListDetails" width="100%" border="1" cellpadding="0" cellspacing="0" class="segList">
                        ...
                        <tr>
                            <td class="billftr1" align="left" colspan="2">
                                ...
                                <span id="mdProgBar" class="med-loading loading-ui-animation"><?php echo $this->_tpl_vars['sProgBar']; ?>
</span><br/>
                                <span>&nbsp;</span>
                            </td>
                            <td class="billftr2" align="right" colspan="2">
...
&nbsp;
                            ...
                            <tr>
                                <td class="billftr1" align="left" colspan="2">
                                    ...
                                    <span id="opsProgBar"
                                          class="ops-loading loading-ui-animation"><?php echo $this->_tpl_vars['sProgBar']; ?>
</span><br/>
                                    <span>&nbsp;</span>
                                </td>
                                <td class="billftr2" align="right" colspan="2">
                    ...
                    <table id="mscListDetails" width="100%" border="1" cellpadding="0" cellspacing="0" class="segList">
                        ...
                        <tr>
                            <td class="billftr1" align="left" colspan="2">
                                ...
                                <span id="mscProgBar"
                                      class="misc-loading loading-ui-animation"><?php echo $this->_tpl_vars['sProgBar']; ?>
</span><br/>
                                <span>&nbsp;</span>
                            </td>
                            <td class="billftr2" align="right" colspan="2">
                            ...
                            <td class="billftr2" align="right">
                                <div class="left-align">
                                    ...
                                    <span id="subTotalDetailsProgBar"
                                          class="total-loading loading-ui-animation"><?php echo $this->_tpl_vars['sProgBar']; ?>
</span><br/>
                                    <span>&nbsp;</span>
                                </div>
                            ...
                            <tr>
                                <td class="billftr2" colspan="5">
                                    <div class="left-align">
                                        ...
                                        <span id="pfProgBar"
                                              class="doc-loading loading-ui-animation"><?php echo $this->_tpl_vars['sProgBar']; ?>
</span><br/>
                                        <span>&nbsp;</span>
                                    </div>
                                    <div class="right-align">
                ...
                <td width="100%">
                    <table width="100%" class="segList" width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr class="final-loading loading-ui-text">
                            <td><span class="final-loading loading-ui-animation"><?php echo $this->_tpl_vars['sProgBar']; ?>
</span></td>
...
<div class="segPanel" id="dialogProcedureList" style="display:none;overflow:auto;">
 ...
 $root_path <?php echo '?>'; ?>
images/loading6.gif" align="absmiddle" border="0"
         style="display:none"/>
...
<!-- <?php if ($this->_tpl_vars['autoPopulate']): ?>
...
<div id="selectPrint-dialog" style="display: none;background: #f2f2f2;">
        <fieldset>
           <!--  <legend>Please select want to Print:</legend> -->
            <br/>
             <?php echo $this->_tpl_vars['sBtnPrint2']; ?>

            <?php echo $this->_tpl_vars['sBtnPrintForPatientCopy']; ?>
