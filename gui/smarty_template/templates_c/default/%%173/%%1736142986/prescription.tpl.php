<?php /* Smarty version 2.6.0, created on 2021-08-21 19:13:11
         compiled from clinics/prescription.tpl */ ?>
<?php echo $this->_tpl_vars['sFormStart']; ?>

<div align="left" style="width: 775px; margin-top:4px">
    <label style="color:#2d2d2d; font-weight: bold">DD/DDP License No.:</label>
    <?php echo $this->_tpl_vars['doctorLicenseNr']; ?>
...
<div align="center" style="width: 775px; margin-top:4px">
							...
							<table id="" width="100%" border="0" cellpadding="0" cellspacing="2" style="font:12px Arial bold;">
								<tbody>
									<tr>
										...
										<td valign="middle"><?php echo $this->_tpl_vars['sPatientID']; ?>
</td>
									</tr>
                                    <tr>
                                        <td width="" align="right" valign="middle"><label>Encounter no.:</label></td>
                                        <td valign="middle"><?php echo $this->_tpl_vars['sPatientEnc']; ?>
</td>
                                    </tr>
									<tr>
 ...
 <?php echo $this->_tpl_vars['sSelectEnc'];  echo $this->_tpl_vars['sClearEnc']; ?>
									...
									<tr>
										...
										<td valign="middle"><?php echo $this->_tpl_vars['sPatientAddress']; ?>
</td>
									</tr>
									<tr>
										<td align="right" valign="middle"><label>Age : </label></td>
										<td valign="middle"><?php echo $this->_tpl_vars['sPatientAge']; ?>
</td>
									</tr>
									<tr>
										<td align="right">Gender:</label></td>
										<td valign="middle"><?php echo $this->_tpl_vars['sPatientGender']; ?>
</td>
									</tr>
								</tbody>
							</table>
							...
							<table id="" width="100%" border="0" cellpadding="0" cellspacing="2" style="font:12px Arial bold;">
								<tbody>
									<tr>
										...
										<td>
											<?php echo $this->_tpl_vars['sRequestDate']; ?>
									...
									<tr>
										...
										<td valign="middle">
                                            <button type="button" class="segButton" onclick="$J('#clinical-impression').val(''); return false"><img src="<?php echo $this->_tpl_vars['sRootPath']; ?>
gui/img/common/default/delete.png"/>Clear</button>
                                        </td>
									</tr>
									<tr>
										<td align="center" valign="middle" colspan="2">
                                            <textarea id="clinical-impression" name="clinical_impression" class="segInput" style="width: 90%" rows="4"><?php echo $this->_tpl_vars['clinicalImpression']; ?>
</textarea>
                                        </td>
									</tr>
								</tbody>
				...
				<tbody>
					<tr>
						<td width="1%" align="left" nowrap="nowrap">
							<button type="button" class="segButton" onclick="searchDrug(); return false"><img src="<?php echo $this->_tpl_vars['sRootPath']; ?>
gui/img/common/default/pill_add.png"/>Add drug</button>
							<button type="button" class="segButton" onclick="openPrescriptionTemplates(); return false"><img src="<?php echo $this->_tpl_vars['sRootPath']; ?>
gui/img/common/default/table_multiple.png"/>Templates</button>
							<!--<button class="segButton" onclick="openPatientHistory(); return false"><img src="<?php echo $this->_tpl_vars['sRootPath']; ?>
gui/img/common/default/calendar.png"/>Patient history</button>-->
						</td>
	...
	<div style="text-align:left; margin-top: 20px">
		<button id="save_prescription" type="button" class="segButton" onclick="savePrescription();return false;"><img src="<?php echo $this->_tpl_vars['sRootPath']; ?>
gui/img/common/default/tag_blue.png" />Save prescription</button>
		<button id="print_prescription" type="button" class="segButton" onclick="printPrescription();return false;" style="display:none"><img src="<?php echo $this->_tpl_vars['sRootPath']; ?>
gui/img/common/default/page_white_acrobat.png" />Print prescription</button>
		<button id="done_prescription" type="button" class="segButton" onclick="self.close();"><img src="<?php echo $this->_tpl_vars['sRootPath']; ?>
			...
			<tr>
				<td>
					<div class="segPanel" style="padding: 5px">
						...
						<button class="segButton" type="button" onclick="addEmptyDrug(); return false;" id="addemptydrug_btn"><img src="<?php echo $this->_tpl_vars['sRootPath']; ?>
gui/img/common/default/pill_add.png"/>Add to Rx</button>
                        <button class="segButton" type="button" onclick="addExternalDrug(); return false"><img src="<?php echo $this->_tpl_vars['sRootPath']; ?>
gui/img/common/default/pill_add.png"/>Add external</button>
					</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					<div class="segPanel" style="padding: 5px">
						...
						<button type="button" class="segButton" onclick="searchTemplate(); return false;"><img src="<?php echo $this->_tpl_vars['sRootPath']; ?>
