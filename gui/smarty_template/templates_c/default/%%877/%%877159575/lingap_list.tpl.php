<?php /* Smarty version 2.6.0, created on 2020-02-07 16:57:14
         compiled from sponsor/lingap_list.tpl */ ?>
			...
			<tr>
				<td class="segPanel" nowrap="nowrap" align="right">
					<table width="100%" cellpadding="2" cellspacing="1" border="0">
						<tr>
							<td width="50" align="right"><?php echo $this->_tpl_vars['patientCheck']; ?>
</td>
							<td width="5%"><label for="patient_options" class="segInput">Search patient</label></td>
							<td>
								<div id="patient_options_panel">
									<span id="p_name" style=""><?php echo $this->_tpl_vars['patientName']; ?>
</span><br/>
