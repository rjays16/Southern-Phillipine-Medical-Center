<?php /* Smarty version 2.6.0, created on 2020-02-05 12:14:21
						...
						<table width="100%">
							<tr>
								<td valign="middle">
									...
									<div style="margin-top:5px; vertical-align:middle; "><?php echo $this->_tpl_vars['sCardNo']; ?>
</div>
									<br>
		...
		<table id="order-list" class="segList" border="0" cellpadding="0" cellspacing="0" width="100%">
			<thead>
				<tr id="order-list-header">
					...
					<th width="13%" align="center">Served</th>
				</tr>
			</thead>
			<tbody>
