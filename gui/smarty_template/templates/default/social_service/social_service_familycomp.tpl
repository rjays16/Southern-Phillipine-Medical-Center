                ...
                <td rowspan="3" class="segPanel" align="center" valign="top">
                  <table width="100%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px">
                    ...
                    <table width="100%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px">
                        ...
                        <tr>
                            <td valign="top"><strong>HRN</strong></td>
                            <td width="1" valign="middle">
                                {{$sPID}}
                            </td>
                        </tr>
                        <tr>
                            <td valign="top"><strong>Case No.</strong></td>
                            <td width="1" valign="middle">
                                {{$sCaseNo}}
                            </td>
                        </tr>
                    ...
                    <td width="25%">
                        <table width="100%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px">
                        <tr>
                            <td valign="top" width="40%" align="left"><strong>Age</strong></td>
                            <td width="1" valign="middle">
                                {{$sAge}}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td valign="top"><strong>MSS No.</strong></td>
                            <td width="1" valign="middle">
                                {{$sOrderMSS}}
                            </td>
                        </tr>
        ...
        <table id="dep-list" class="segList" border="0" cellpadding="0" cellspacing="0" width="100%">
            <thead>
                <tr id="dep-list-header">
                    ...
                    <th width="10%" nowrap align="left">&nbsp;&nbsp;CaseNo</th>
                    <th width="*" nowrap align="left">&nbsp;&nbsp;Name</th>
