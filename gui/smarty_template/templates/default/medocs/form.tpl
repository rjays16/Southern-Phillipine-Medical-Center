        ...
        <tr bgcolor="#f6f6f6">
            ...
            <td colspan="2">
                <table width="*" border="0" bordercolor="#F6F6F6">
                    <tr>
                        <td>Referred by :</td>
                        <td>{{html_options id="list_reffrom" class="segInput" name="list_reffrom" selected=$referrer_dr options=$list_reffrom }}</td>
                        <td> {{$other_inputs_reffrom}} </td>
                    </tr>
                    <tr>
                        <td>Reason :</td>
                        <td>{{html_options id="list_reason" class="segInput" name="list_reason" selected=$reason_dr options=$list_reason }}</td>
                        <td>{{$other_inputs_reason}}</td>
                    </tr>
                </table>              
            </td>
        </tr>
