{{* lingap_walkin_request.tpl  Form template for Grants module *}}
...
<div style="width:700px; margin-top:5px" align="center">
	<table border="0" cellspacing="2" cellpadding="2" align="center" width="100%;margin:4px">
		<tr>
			<td class="segPanelHeader">Lingap request entry details (Walk-in)</td>
		</tr>
		<tr>
...
<div id="rqsearch" style="width:700px; margin-top:10px; overflow:hidden" align="center">
	<div style="width:80%; margin:1px; margin-right:5px; float:left">
		<div class="dashlet">
			<table cellspacing="0" cellpadding="0" border="0" width="100%" class="dashletHeader" style="font-family: Arial">
				<tr>
					<td width="30%" valign="top"><h1 style="white-space:nowrap">Request list</h1></td>
					<td width="*" align="right" valign="top" nowrap="nowrap">Date of request {{$sRequestFilterDate}}</td>
				</tr>
			</table>
		</div>
		<div>
{{$lstRequest}}
	...
	<div style="width:18%; margin:1px; float:left">
		...
		<div>
			<table width="100%" style="font-size: 12px;  margin-top:6px;" border="0" cellspacing="2" cellpadding="1">
				<tbody>
					<tr>
						<td width="20%" align="left" class="segPanelHeader" ><strong>Total items</strong></td>
					</tr>
					<tr>
