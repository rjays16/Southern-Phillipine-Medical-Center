	...
	<table border="0" cellspacing="2" cellpadding="2" width="95%" align="center">
		<tbody>
			<tr>
				...
				<td class="segPanelHeader" width="250">
					Request Date
				</td>
			</tr>
			<tr>
				<td rowspan="3" class="segPanel" align="center" valign="top">
					...
					<table width="95%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px">
						<tr>
							<td align="right" valign="top"><strong>RID</strong></td>
							<td colspan="3">{{$sRID}}</td>
						</tr>
						<tr>
						...
						<tr>
							<td valign="top" colspan="4">
								<strong>Social Service Classification</strong>
								&nbsp;&nbsp;{{$sSSClassID}}
							</td>
						</tr>
					</table>
			...
			<tr>
				<td class="segPanelHeader">Adjusted Amt.</td>
