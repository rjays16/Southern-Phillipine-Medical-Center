				...
				<td class="segPanel" align="center" valign="top">
					<table width="95%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px">
                        ...
                        <tr>
                            ...
                            <td valign="middle"></strong><span id="blood_type" style="font:bold 12px Arial; color:#0000FF;">{{$sBloodType}}</span></td>
                        </tr>
                        <tr>
                            <td align="left" width="20%"><strong>Sex</strong></td>
                            <td valign="middle"></strong><span id="sex" style="font:bold 12px Arial; color:#0000FF;">{{$sSex}}</span></td>
                            <td align="right" width="1"><strong>&nbsp;</strong></td>
                            <td align="left" width="15%"><strong>Age</strong></td>
                            <td valign="middle"></strong><span id="age" style="font:bold 12px Arial; color:#0000FF;">{{$sAge}}</span></td>
                        </tr>
						<tr>
