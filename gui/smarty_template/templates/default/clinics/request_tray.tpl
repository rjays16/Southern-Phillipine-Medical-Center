					...
					<tbody>
						<tr>
							...
							<td align="right">
								...
								<button class="segButton" onclick="openLabResults();return false;" style="cursor:pointer" {{$disableRes}}><img src="../../gui/img/common/default/page_white_acrobat.png" border="0"/>Results</button>
							</td>
						</tr>
						<tr>
				...
				<tbody>
					<tr>
						...
						<td align="right">
							...
							<button class="segButton" onclick="openBloodResults();return false;" style="cursor:pointer" {{$disableRes}}><img src="../../gui/img/common/default/page_white_acrobat.png" border="0"/>Results</button>
						</td>
					</tr>
					<tr>
						<td align="left" style="font: bold 12px Arial;"><strong>TOTAL Charge: </strong></td>
				...
				<tbody>
					<tr>
						...
						<td align="right">
							...
							<button class="segButton" onclick="openRadioResults();return false;" style="cursor:pointer" {{$disableRes}}><img src="../../gui/img/common/default/page_white_acrobat.png" border="0"/>Results</button>
						</td>
					</tr>
					<tr>
						<td align="left" style="font: bold 12px Arial;"><strong>TOTAL Charge: </strong></td>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" class="dashletHeader" style="font: bold 12px Tahoma;">
				<tbody>
					<tr>
						<td width="10%" valign="top"><h1 style="white-space:nowrap">List of Requests</h1></td>
						<td align="right">
							<button class="segButton" id="openOBGyneRequestBtn" name="openOBGyneRequestBtn" onclick="openOBGYNERequest();return false;" style="cursor:pointer" {{$btnDisableOB}}><img src="../../gui/img/common/default/film.png" border="0"/>New request</button>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" class="dashletHeader" style="font: bold 12px Tahoma;">
				<tbody>
					<tr>
						<td width="10%" valign="top"><h1 style="white-space:nowrap">List of Requests</h1></td>
						<td align="right">
							<!-- <button class="segButton" id="openOutsidePackageBtn" name="openOutsidePackageBtn" onclick="openOutdieMedsModal();return false;" style="cursor:pointer" {{$newMedsDisable}}><img src="../../gui/img/common/default/add.png" border="0"/>Add Outside Medicine</button> -->
							<button class="segButton" id="openPackageBtn" name="openPackageBtn" onclick="openPackageModal();return false;" style="cursor:pointer" {{$packageDisable}}><img src="../../gui/img/common/default/add.png" border="0"/>Add Package</button>
							<button class="segButton" id="openPharmaRequestBtnIP" name="openPharmaRequestBtnIP" onclick="openPharmaRequest('{{$defaultArea}}');return false;" style="cursor:pointer"><img src="../../gui/img/common/default/pill.png" border="0"/>New request</button>
						</td>
					</tr>
					<tr>
						<td align="left" style="font: bold 12px Arial;"><strong>TOTAL Charge: </strong></td>
...
{{$form_end}}
{{$ptype}}
{{$user_from}} <!-- added by Christian 12-03-2019 -->
{{$request_source}}
{{$is_bill_final}}
{{$is_bill_deleted}}
{{$encounter_nr}}
