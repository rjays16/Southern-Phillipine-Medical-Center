...
<div style="width:100%" align="left">
	<table border="0" cellspacing="1" cellpadding="0" width="75%" align="left" style="" >
		<tbody>
			<tr>
				<td colspan="4" class="">{{$outputResponse}}</td>
					...
					<table border="0" cellspacing="1" cellpadding="2" width="100%" style="font-family:Arial, Helvetica, sans-serif">
						<tbody>
							<tr>
								...
								<td class="segInput" align="left" valign="middle" width="*" nowrap="nowrap">{{$hrn}}</td>
							...
							<tr>
								...
								<td class="segInput" align="left" valign="middle" width="*" nowrap="nowrap">{{$full_name}}</td>
							</tr>
							<tr>
								<td class="" align="left" valign="middle" width="20%">Address</td>
								<td class="segInput" align="left" valign="middle" width="*" nowrap="nowrap">{{$address}}</td>
							</tr>
							<tr>
								<td class="" align="left" valign="middle" width="20%"><strong>Age</strong></td>
								<td class="seg_input" align="left" valign="middle" width="*" nowrap="nowrap">{{$age}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Birthday&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$birthday}}</td>
							</tr>
							<tr>
								<td class="" align="left" valign="middle" width="20%"><strong>Gender</strong></td>
								<td class="seg_input" align="left" valign="middle" width="*" nowrap="nowrap">{{$gender}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Civil Status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$civil_status}}</td>
							</tr>
					...
					<table border="0" cellspacing="1" cellpadding="2" width="100%" style="font-family:Arial, Helvetica, sans-serif">
						<tbody>
							<tr>
								...
								<td class="segInput" align="left" valign="middle" width="50" nowrap="nowrap">{{$transaction_date}}</td>
								<td class="segInput" align="left" valign="middle" width="*" nowrap="nowrap">{{$transaction_time}}</td>
							</tr>
							<tr>
								<td class="" align="left" valign="middle" width="30%"><strong>Case No</strong></td>
								<td class="segInput" align="left" valign="middle" width="*" nowrap="nowrap">{{$caseNo}}</td>
							</tr>
							<tr>
								<td class="" align="left" valign="middle" width="30%"><strong>Charge to Agency</strong></td>
								<td class="seg_input" align="left" valign="middle" width="*" nowrap="nowrap">{{$chargeToAgency}}</td>
							</tr>
						</tbody>
					</table>
				</td>
					...
					<table border="0" cellspacing="1" cellpadding="2" width="100%" style="font-family:Arial, Helvetica, sans-serif">
						<tbody>
							<tr>
								...
								<td class="segInput" align="left" valign="middle" width="*" nowrap="nowrap">{{$agency_organization}}</td>
							</tr>
							<tr>
								<td class="" align="left" valign="middle" width="30%"><strong>Position</strong></td>
								<td class="segInput" align="left" valign="middle" width="*" nowrap="nowrap">{{$position}}</td>
							</tr>
							<tr>
								<td class="" align="left" valign="middle" width="30%"><strong>ID No.</strong></td>
								<td class="segInput" align="left" valign="middle" width="*" nowrap="nowrap">{{$id_no}}</td>
							</tr>
							<tr>
								<td class="" align="left" valign="middle" width="10%" rowspan="4" ><strong>Status</strong></td>
								<td class="segInput" align="left" valign="middle" width="*" nowrap="nowrap">{{$status}}</td>
							</tr>
						</tbody>
					</table>
				</td>
                                        ...
                                        <table border="0" cellspacing="1" cellpadding="2" width="100%" style="font-family: Arial, Helvitica, sans-serif">
                                                <tbody>
                                                        <tr>
                                                                ...
                                                                <td class="segInput" align="left" valign="middle" width="*" nowrap="nowrap">{{$hSmoking}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="" align="left" valign="middle" width="30%"><strong>Alcohol Drinker</strong></td>
                                                            <td class="segInput" align="left" valign="middle" width="*" nowrap="nowrap">{{$hDrinker}}</td>
                                                        </tr>
                                                </tbody>
                                        </table>
                                </td>
					...
					<table border="0" cellspacing="1" cellpadding="2" width="100%" style="font-family:Arial, Helvetica, sans-serif">
						<tbody>
							<tr>
								...
								<td class="segInput" align="left" valign="middle" width="*" nowrap="nowrap">{{$purpose_exam}}{{$others}}</td>
							</tr>
							<tr>
								<td class="" align="left" valign="middle" width="30%"><strong>Remarks</strong></td>
								<td class="segInput" align="left" valign="middle" width="*" nowrap="nowrap">{{$remarks}}</td>
							</tr>
						</tbody>
					</table>
				</td>
				...
				<td class="">
					<table border="0" cellspacing="1" cellpadding="2" width="100%" style="font-family:Arial, Helvetica, sans-serif">
						<tbody>
							...
							<tr>
								<td class="" align="right" valign="middle" width="70%"><strong>{{$submitButton}}</strong></td>
								<td class="" align="right" valign="middle" width="*" nowrap="nowrap">{{$cancelButton}}</td>
							</tr>
						</tbody>
					</table>
				</td>
