	...
	<table width="90%">
		<tbody id="tbl_transmit_details_header">
			...
			<tr id="tbl_transmit_details_hdr_row2" {{$sShowButtons}}>
				<td align="left" colspan="6">{{$sBtnAddItem}}{{$sBtnDelete}}{{$sBtnPrintAll}}{{$sAuditTrail}}</td>
								<td align="right">{{$sCheckboxSur}}{{$sCheckboxMed}}{{$sCheckboxCas}}{{$sBtnSummary}}{{$btnXml}}{{$sBtnPrint}}{{$sBtnSave}}</td>
			</tr>
		</tbody>
	</table>
