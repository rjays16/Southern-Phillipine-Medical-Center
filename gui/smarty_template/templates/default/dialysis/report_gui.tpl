				...
				<td class="segPanel">
					<table width="100%" border="0" cellpadding="2" cellspacing="2" style="font:12px Arial;color:#000000">
						<tr align="center">
							...
							<td align="left">
								<select class="segInput" name="selreport" id="selreport">
						...
						<tr>
							<td width="150px" align="right"><label>Select Report Format: </label></td>
							<td align="left">
								<select class="segInput" name="selreporttype" id="selreporttype">
						...
						<tr id="seltimeto" style="display:none">
							<td align="right"><label>Time To</label></td>
							<td>{{$sShift_to}}</td>
						</tr>
						<tr>
