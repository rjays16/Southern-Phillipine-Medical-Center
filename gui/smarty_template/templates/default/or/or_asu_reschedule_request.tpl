...
<div id="or_main_approve_request" align="left">
	...
	<fieldset>
		...
		<table border="0" width="90%">
			<tr>
				<td width="25%" align="left">OR Receipt</td>
				<td width="*" align="left"><span class="value">{{$or_receipt}}</span></td>
			</tr>

			<tr>
				<td width="25%" align="left">OP Room {{$required_mark}}</td>
				<td width="*" align="left">
			...
			<tr>
				<td width="25%" align="left">Bed {{$required_mark}}</td>
				<td width="*" align="left">{{$sbed}}</td>
			</tr>
			<tr>
				<td width="25%" align="left">Estimated Length of Operation {{$required_mark}}</td>
				<td width="*" align="left"><span class="value">{{$length_operation}}</span></td>
			</tr>

			<tr>
				<td width="10%">Final Date of Operation {{$required_mark}}</td>
				<td width="*">
					<table>
						<tr>
							<td width="5%">{{$final_operation_date_display}}{{$final_operation_date}}</td>
							<td width="*" valign="bottom">{{$final_operation_dt_picker}}{{$final_operation_calendar_script}}</td>
						</tr>
					</table>
				</td>
			</tr>
			...
			<tr>
				...
				<td width="*" align="left"><span class="value">{{$remarks}}</span></td>
			</tr>

		</table>
	</fieldset>

	{{$or_main_schedule_approve}}
	<!--{{$or_approve_submit}}
	{{$or_disapprove_submit}}-->
	{{$or_main_cancel}}
	{{$current_bed_nr}}
