...
<div id="approve_or" align="left">
  <span style="font: normal 11px Arial;color:#000" align="left">
...
<div id="search_bar" align="left">
  {{$search_field}}
  {{html_options name="qtype" options=$departments selected=$selected_department}}
  {{html_options name="qtype2" options=$statuses selected=$selected_status}}
  {{$search_button}}
</div>
<div id="navigation">
