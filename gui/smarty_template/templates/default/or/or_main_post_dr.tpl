...
<div id="or_main_oxygen" align="left">
  <div id="header" class="jqDrag"><span style="float:left">Select Oxygen Serial Number</span>{{$close_anesthesia}}<br style="clear:both" /></div>
...
<div id="or_main_schedule" align="left">
  ...
  <table>
      ...
      <td>Case No.</td>
      <td>:</td>
      <td><span class="value">{{$or_request_encounter_no}}</span></td>      
    </tr>
    <tr>
      <td>Department</td>
      <td>:</td>
    ...
    <legend>Equipments</legend>
        ...
        <table class="segList" width="100%" id="equipment_list">
          <thead>
            <tr>
              <th width="1%" nowrap="nowrap">&nbsp;</th>
              <th width="20%" nowrap="nowrap" align="left">Equipment</th>
  ...
  {{$or_main_anesthesia_report}}
  {{$or_main_op_room_report}}
  {{$patient_pid}}
  {{$encounter_nr}}
  {{$hospital_number}}
  {{$submitted}}
