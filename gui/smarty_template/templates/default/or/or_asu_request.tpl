...
<div id="or_main_request" align="left">
	...
	<table>
		...
		<tr>
			<td><label>Requesting Doctor:</label> {{$required_mark}} </td>
				<td>
	...
	-->
		...
		<tr>
		 ...
		 <tr>
			...
			<td width="160px">{{$or_request_date_display}}{{$or_request_date}}</td>
		...
		<tr>
			...
			<td><span id="procedure_name_msg">{{$error_input}}</span></td>
		</tr>
	...
	<fieldset>
		...
		<table>
			<tr>
				<td width="210px"><label>Date of Operation:</label> {{$required_mark}} </td>
				<td width="160px"><!--{{$or_operation_date_display}}-->{{$or_operation_date}}</td>
				<td>{{$or_operation_dt_picker}}</td>
				<td>{{$or_operation_calendar_script}}</td>
				<!--<td valign="middle"><span id="or_operation_date_msg">{{$error_input}}</span></td> -->
			</tr>
			<!--
			<tr id="op_time">
				<td width="210px" valign="middle"><label>Time of Operation:</label> {{$required_mark}} </td>
				<td width="180px">{{html_radios name="time_of_operation" options=$time_of_operation separator="<br/>" selected=$time_of_operation_selected onClick=checkType(this.value);}}</td>
				<!--<td valign="middle"><span id="time_of_operation_msg">{{$error_input}}</span></td>
			</tr>-->
		</table>
