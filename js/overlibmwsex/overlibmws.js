...
if(OLud('fgclass'))var ol_fgclass="olfg";
if(OLud('bgclass'))var ol_bgclass="olbg";
if(OLud('cgclass'))var ol_cgclass="olcg";
if(OLud('textpadding'))var ol_textpadding=2;
if(OLud('textfontclass'))var ol_textfontclass="oltxt";
if(OLud('captionpadding'))var ol_captionpadding=2;
if(OLud('captionfontclass'))var ol_captionfontclass="olcap";
if(OLud('closefontclass'))var ol_closefontclass="olclo";
