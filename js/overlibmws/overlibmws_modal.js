...
if(OLud('modalcolor'))var ol_modalcolor="#666666";
if(OLud('modalopacity'))var ol_modalopacity=60;
if(OLud('modalscroll'))var ol_modalscroll=0;
// END CONFIGURATION

var o3_modal=0,o3_modalcolor="#bbbbbb",o3_modalopacity=40,o3_modalscroll=1;
