...
class Core {
	    ...
	    if(!is_array($array)){ 
			return FALSE;
	   		...
	   		$this->ref_array=$array;
				#echo "function setRefArray : $this->ref_array";
			return TRUE;
		}
	}
	/**
	...
	*/
	function Transact($sql='') {
		...
		if($this->ok) {
			$db->CommitTrans();
#            echo " <br> hello burn enter Transact TRUE sql= ".$sql. "<br> this->sql=".$this->sql;
#            echo " <br> hello burn enter Transact TRUE this->ok= ".$this->ok."<br>";
			return TRUE;
		} else {
			$db->RollbackTrans();
#            echo " <br> hello burn enter Transact FALSE sql= ".$sql. "<br> this->sql=".$this->sql;
#            echo " <br> hello burn enter Transact FALSE this->ok= ".$this->ok."<br>";
			return FALSE;
		}
	}
	/**
...
#echo "<br>".$this->sql;
	...
	*/
    function updateDataFromInternalArray($item_nr='',$isnum=TRUE) {
	 #echo "<br>updateDataFromInternalArray = '".$item_nr."'";
    $this->_prepSaveArray();
...
/*        echo " <br> hello burn enter stringTrim ";	     
        echo " <br> hello burn enter stringTrim str=".$str;	     
        echo " <br> hello burn enter stringTrim BEFORE01 strlen(str)=".strlen($str);	     
*/
        /* Change a sequence of white spaces to a single white space */
        $new_str = preg_replace("/\s+/", " ", trim($str));
 //       echo " <br> hello burn enter stringTrim AFTER01 strlen(new_str)=".strlen($new_str);	     
		return $new_str;
	}
}//end of class Core # burn added: August 25, 2006
?>
