...
require_once($root_path.'classes/phpSniff/phpSniff.class.php'); # Sniffer for PHP
...
if($createwarn||$installwarn||$md5warn){
	...
	include_once($root_path.'include/inc_charset_fx.php');
	if($createwarn){
		include($root_path.'include/inc_create_admin_warning.php');
	}
	if($initwarn){
		include($root_path.'include/inc_init_warning.php');
	}
	if($md5warn){
		include($root_path.'include/inc_md5_warning.php');
	}
	if($installwarn){
		include($root_path.'include/inc_install_warning.php');
	}
	#
...
?>
<!--<img src="images/seghis_logo.jpg" height="30">-->
<!--<img src="images/segworks.gif" height="30">-->
<h4>LOGIN <img src="images/lock.gif" alt="lock"></h4>
<form method="post" name="loginform" id="loginform" action="welcome.php">
	<!--
	<p id="screen">Username : &nbsp;<input type="text" name="username" id="username" size="20"></p>
	<p id="screen">Password : &nbsp;<input type="password" name="password" id="password" size="20"></p>
	<input type="submit" name="submit" id="submit" value="LOGIN">
	&nbsp;&nbsp;
	<input type="reset" id="reset" name="reset" value="CANCEL">
	-->
	<p>
		<label for="login-name"><font color="red" style="font-weight:bold">User name:</font></label> 
		<input type="text" name="username" id="username" />
	</p>
	<p>
		<label for="login-pwd" class="block"><font color="red" style="font-weight:bold">Password:</font></label> 
