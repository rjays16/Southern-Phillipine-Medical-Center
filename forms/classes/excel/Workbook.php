...
require_once($root_path."/classes/excel/Format.php");
require_once($root_path."/classes/excel/BIFFwriter.php");
require_once($root_path."/classes/excel/Worksheet.php");
require_once($root_path."/classes/excel/Parser.php");                        
#require_once($root_path."classes/excel/OLE/Root.php");
#require_once($root_path."classes/excel/OLE/File.php");
require_once($root_path."/classes/excel/OLE/Root.php");                        
require_once($root_path."/classes/excel/OLE/File.php");                        
