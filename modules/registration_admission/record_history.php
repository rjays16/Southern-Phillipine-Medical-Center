...
?>
   <tr bgcolor="#ffffff">
	 ...
	 echo preg_replace($patterns, $replace, $buffer);
	 ?>
	 &nbsp;
	 </td>
   </tr>
...
<script type="text/javascript">
	function viewDBHistory(){
		...
		window.open("<?=$root_path?>modules/registration_admission/record_history_pdf.php?&table="+table+"&pid="+pid+"&showBrowser=1","viewDBHistory","width=600,height=440,menubar=no,resizable=yes,scrollbars=yes")
		...
		/*Added by JEFF 05-10-17*/
		//Added this function for resizing the pop-up window, you can also adjust if you want...
		window.resizeTo(640,625);
		/*END of Modification by JEFF 05-10-17*/
</script>
<p>
