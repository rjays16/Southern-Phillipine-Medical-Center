...
$TP_date_end='<input type="text" id="date_text" name="date_end" size=10 maxlength=10 '.$date_checker.'>';
//$TP_href_des='<a href="javascript:show_calendar(\'sickform.date_end\',\''.$date_format.'\')" >';
$TP_date_start='<input type="text" id="date_text1" name="date_start" size=10 maxlength=10 '.$date_checker.'>';
//$TP_href_dss='<a href="javascript:show_calendar(\'sickform.date_start\',\''.$date_format.'\')" >';

$TP_date_confirm='<input type="text" id="date_text2" name="date_confirm" size=10 maxlength=10 '.$date_checker.'>';
//$TP_href_dcs='<a href="javascript:show_calendar(\'sickform.date_confirm\',\''.$date_format.'\')" >';
//$TP_href_end='</a>';

$TP_img_calendar='<img '.createComIcon($root_path,'show-calendar.gif','0','absmiddle',TRUE).' id="date_trigger" style="cursor:pointer">';
$TP_img_calendar1='<img '.createComIcon($root_path,'show-calendar.gif','0','absmiddle',TRUE).' id="date_trigger1" style="cursor:pointer">';
$TP_img_calendar2='<img '.createComIcon($root_path,'show-calendar.gif','0','absmiddle',TRUE).' id="date_trigger2" style="cursor:pointer">';
