 ...
 <table border=0 cellpadding=2 width=100%>
   <tr bgcolor="#f6f6f6">
     ...
     <td colspan=3>
		 ...
		 <input type="text" name="msr_date" id="date_text" size=10 maxlength=10  onBlur="IsValidDate(this,'<?php echo $date_format ?>')" onKeyUp="setDate(this,'<?php echo $date_format ?>','<?php echo $lang ?>')">
	 <!--<a href="javascript:show_calendar('wtht_form.msr_date','<?php echo $date_format; ?>')">--><img <?php echo createComIcon($root_path,'show-calendar.gif','0','absmiddle',TRUE); ?> id="date_trigger" style="cursor:pointer ">
