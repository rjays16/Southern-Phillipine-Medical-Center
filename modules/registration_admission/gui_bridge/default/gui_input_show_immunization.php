...
<form method="post" name="reportform" onSubmit="return chkform(this)">
 ...
 <table border=0 cellpadding=2 width=100%>
   <tr bgcolor="#f6f6f6">
     ...
     <td><input type="text" name="date" id="date_text" value='<?php echo formatDate2Local(date('Y-m-d'), $date_format); ?>' size=10 maxlength=10 onBlur="IsValidDate(this,'<?php echo $date_format ?>')" onKeyUp="setDate(this,'<?php echo $date_format ?>','<?php echo $lang ?>')">
	 	 <!--<a href="javascript:show_calendar('reportform.date','<?php echo $date_format; ?>')">--><img <?php echo createComIcon($root_path,'show-calendar.gif','0','absmiddle',TRUE); ?> id="date_trigger" style="cursor:pointer ">
   ...
   <tr bgcolor="#f6f6f6">
     ...
     <td><input type="text" name="refresh_date" id="date_text2" size=10 maxlength=10 onBlur="IsValidDate(this,'<?php echo $date_format ?>')" onKeyUp="setDate(this,'<?php echo $date_format ?>','<?php echo $lang ?>')">
	 	<!-- <a href="javascript:show_calendar('reportform.refresh_date','<?php echo $date_format; ?>')">--><img <?php echo createComIcon($root_path,'show-calendar.gif','0','absmiddle',TRUE); ?> id="date_trigger2" style="cursor:pointer ">
	 	 	<!--EDITED: SEGWORKS -->
	<script type="text/javascript">
	Calendar.setup ({
