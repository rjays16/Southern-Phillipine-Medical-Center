...
<?
	...
	$smarty->assign('sDateInput','<input type="text" id="date_text" name="date" size=10 maxlength=10 onFocus="this.select()"  onBlur="IsValidDate(this,\''.$date_format.'\')" onKeyUp="setDate(this,\''.$date_format.'\',\''.$lang.'\')">');
...
<?
	...
	$sTemp = '<img '.createComIcon($root_path,'show-calendar.gif','0','absmiddle',TRUE).' id="date_trigger" style="cursor:pointer" >
 						<font size=1>['.$calendarSetup;
