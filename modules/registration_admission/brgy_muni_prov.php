...
require('./roots.php');
require($root_path."modules/pharmacy/ajax/brgy_muni_prov.common.php");
...
function startAJAXSearch(searchID, page) { 
	...
	if (searchEL) {
		...
		$("bmp-list-body").style.display = "none";
		 AJAXTimerID = setTimeout("xajax_populateBMPList('"+searchID+"','"+searchEL.value+"',"+page+","+searchLastname+","+includeEnc+")",100);
					...
					<table width="95%" border="0" cellpadding="0" cellspacing="0" style="font:bold 12px Arial; color:#2d2d2d; margin:1%">
						<tr>
							...
							<td valign="middle" width="*">
								<input id="search" class="jedInput" type="text" style="width:60%; font: bold 12px Arial" align="absmiddle" onkeyup="if (this.value.length >= 3) startAJAXSearch(this.id,0)" />
			...
			<tr>
				<td>
					<div style="display:block; border:1px solid #8cadc0; overflow-y:scroll; height:290px; width:100%; background-color:#e5e5e5">
						<table id="bmp-list" class="jedList" cellpadding="0" cellspacing="0" width="100%">
							<thead>
								<tr class="nav">
									<th colspan="9">
...
?>
									<th width="40%">Brgy.</th>
									<th width="*">Municipality/Province</th>									
<?php
		break;
		case 'm':
?>
...
?>
							...
							<tbody id="bmp-list-body">
								<tr>
									<td colspan="10" style="font-weight:normal">No such item exists...</td>
								</tr>
							</tbody>
						</table>
	...
	<input type="hidden" name="mode" value="<?= strtolower($_GET['mode']) ?>">
