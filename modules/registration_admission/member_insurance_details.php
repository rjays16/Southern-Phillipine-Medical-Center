...
//$smarty->assign('javascript_css_array', $javascript_css_array);
...
$smarty->assign('street_name', '<input type="text" name="street_name" />');
...
var z = window.parent.window.parent.document.getElementById('insurance_' + J("input[@name='fnr']").val());
...
function get_parent_details() {
  ...
  var fnr = <?=$_GET['fnr']?>;
  var inr = '<?=$_GET['inr']?>';
  var parent_window = window.parent.window.parent;
  
  J("input[@name='last_name']").val(parent_window.document.getElementById('ln_'+fnr).value);
  J("input[@name='first_name']").val(parent_window.document.getElementById('fn_'+fnr).value);
  J("input[@name='middle_name']").val(parent_window.document.getElementById('mn_'+fnr).value);
  J("input[@name='street_name']").val(parent_window.document.getElementById('st_'+fnr).value);
  J("input[@name='barangay_nr']").val(parent_window.document.getElementById('ba_'+fnr).value);
  J("input[@name='municipality_nr']").val(parent_window.document.getElementById('mu_'+fnr).value);
  J("input[@name='fnr']").val(parent_window.document.getElementById('fnr_'+fnr).value);
  J("input[@name='inr']").val(inr);
  xajax_get_barangay_municipality_name(parent_window.document.getElementById('ba_'+fnr).value, parent_window.document.getElementById('mu_'+fnr).value);
...
function validate() {
 ...
 window.parent.prepareAdd(J("input[@name='fnr']").val(), true);

  var array_elements = [{type: 'hidden', name: 'last_name[]', value: J("input[@name='last_name']").val(), id: 'ln_'+J("input[@name='fnr']").val()},
  ...
  var parent_window = window.parent.window.parent.document.getElementById('row_column'+J("input[@name='fnr']").val());
  var z = window.parent.window.parent.document.getElementById('insurance_' + J("input[@name='fnr']").val());
...
//  var parent_window = window.parent.window.parent.document.getElementById('firm_'+id);
//  var z = window.parent.window.parent.document.getElementById('edit_insurance_'+id);
//  if (z) {
//    parent_window.removeChild(z);
//  }
...
$smarty->assign('sMainBlockIncludeFile','registration_admission/member_insurance_details.tpl'); //Assign the member_insurance_details template to the frameset
