	...
	if ((update == 1)&&(dept_belong=="Admission")){
		...
		if (dept_belong=="Admission"){
			...
			if ((encounter_type == 1)||(encounter_type == 2)){
				d.referrer_dr.value = d.consulting_dr.value;
				d.referrer_dept.value = dr_dept;
			}	
		}
...
#			$smarty->assign('referrer_diagnosis','<input name="referrer_diagnosis" type="text" size="60" value="'.ucwords(strtolower(trim($referrer_diagnosis))).'">');   # burn commented: April 20, 2007
			$smarty->assign('referrer_diagnosis','<textarea name="referrer_diagnosis" id="referrer_diagnosis" cols="60" rows="5" wrap="VIRTUAL">'.ucwords(strtolower(trim($referrer_diagnosis))).'</textarea>');   # burn added: April 20, 2007
...
#			$smarty->assign('referrer_recom_therapy','<input name="referrer_recom_therapy" type="text" size="60" value="'.ucwords(strtolower(trim($referrer_recom_therapy))).'">');   # burn commented: April 20, 2007
			$smarty->assign('referrer_recom_therapy','<textarea name="referrer_recom_therapy" id="referrer_recom_therapy" cols="60" rows="5" wrap="VIRTUAL">'.ucwords(strtolower(trim($referrer_recom_therapy))).'</textarea>');   # burn added: April 20, 2007
			...
			if ((($patient_enc['encounter_type']==1)||($patient_enc['encounter_type']==2))&&($update==1)&&($dept_belong['id']=="Admission")){
				...
				$smarty->assign('referrer_dr','<input name="referrer_dr"  type="text" size="60" onKeyUp="ReferralHandler()" value="'.ucwords(strtolower(trim($referrer_dr))).'">');
				$smarty->assign('referrer_dept','<input name="referrer_dept" type="text" size="60" value="'.$patient_enc['referrer_dept'].'">');
			}
