...
#Added by Borj fontsize 2014-2-5
...
$fontSizeInput = 11;
$fontSizeText = 12;
#Added by Borj UI fontsize link 2014-2-5
$fontSizeTextUI = $_GET['fsize'];
#end borj
$fontSizeHeader = 14;
//fontstyle setup
$fontStyle = "Arial";
...
if($mun_name == '' && $prov_name == '') {
	$address = trim($street_name);
}else {
...
*/
$pdf->SetFont($fontStyle,"",$fontSizeTextUI);
$pdf->Cell(10,3,'',"",0,'L');
...
if ($medCertInfo['is_doc_sig']){
	...
	if ($docInfo['custom_middle_initial'] != "") {
		$name_doctor = "".$docInfo['name_first']." ".$docInfo['custom_middle_initial'].". ".$docInfo['name_last'];
	}else{
...
$pdf->code ="SPMC-F-HIM-14"; #edited HIMD -> HIM art 03/25/2014
