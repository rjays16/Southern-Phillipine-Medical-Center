...
#echo"aufnahme_start.php : encounter_nr = '".$encounter_nr."' <br> \n"; 
...
#echo"aufnahme_start.php : patient_enc['encounter_status'] = '".$patient_enc['encounter_status']."' <br> \n"; 
...
echo "pid = '".$pid."' <br> \n";
echo "aufnahme_start.php : mode = '".$mode."' <br> \n";
...
/*
									...
									echo "HTTP_POST_VARS['encounter_status'] = '".$HTTP_POST_VARS['encounter_status']."' <br> \n";
...
#echo "add_citytown_name: <br>\n"; print_r($addr_citytown_name); echo "<br> \n";
...
/*
			...
			alert("Please select the Admitting Department.");
...
//		alert("jsGetEROPDDepartment : aPersonell_nr ='"+aPersonell_nr+"'");
...
//		alert("jsGetEROPDDepartment : aDepartment_nr ='"+aDepartment_nr+"'");
...
#					else $smarty->assign('LDDepartment',"$LDClinic/$LDDepartment");   # burn commented : May 16, 2007
				...
				if($in_dept){
#echo "aufnahme.php : in_dept = '".$in_dept."' <br>\n";					
...
#echo "hello 3 <br> \n";
			...
			*/
			...
			if($dept_belong['id']=="Admission"){
				...
				$smarty->assign('insurance_nr','<input name="insurance_nr" id="insurance_nr" type="text" size="60" readonly="1" onChange="FillInsuranceNo();" value="'.$sTemp.'">');
				...
				$sBuffer ="<a href=\"javascript:popSearchWin('insurance','aufnahmeform.insurance_firm_id','aufnahmeform.insurance_firm_name')\" onBlur=\"FillInsuranceCo();\"><img ".createComIcon($root_path,'l-arrowgrnlrg.gif','0','',TRUE)."></a>";
