...
require('./roots.php');
require($root_path."modules/registration_admission/ajax/walkin-psearch.common.php");
...
<script type="text/javascript" src="<?=$root_path?>modules/registration_admission/js/walkin-search-gui.js?t=<?=time()?>"></script>
...
$lg_options =   array(
	'LIST_ID' => 'wlst',
	'COLUMN_HEADERS' => array('wID','Sex','Fullname','Address','Transaction',''),
	'COLUMN_SORTING' => array(LG_SORT_NONE, LG_SORT_ASC, LG_SORT_NONE, LG_SORT_NONE, LG_SORT_NONE, LG_SORT_UNSORTABLE),
	'AJAX_FETCHER' => 'populateWalkin',
	'INITIAL_MESSAGE' => "Enter search key...",
	'ADD_METHOD' => 'addWalkin',
	'FETCHER_PARAMS' => array(),
	'COLUMN_WIDTHS' => array("10%", "8%", "*", "30%", "20%", "5%")
);
$wlst = $listgen->createList($lg_options);
#$smarty->assign('lstRequest',);

# Buffer page output
ob_start();

?>
	<table width="98%" cellspacing="4" cellpadding="0" style="margin:1%">
		<tbody>
			<tr>
				<td style="font:bold 12px Arial; background-color:#e5e5e5; color: #2d2d2d; border: 1px solid #c0c0c0" >
