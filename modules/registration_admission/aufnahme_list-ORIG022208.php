...
#		$select="SELECT p.name_last,p.name_first,p.date_birth,p.addr_zip, p.sex,e.encounter_nr,e.encounter_class_nr,e.is_discharged,e.encounter_date FROM ";   # burn commented: March 9, 2007
		$select=" SELECT p.name_last,p.name_first,p.date_birth,p.addr_zip, p.sex,
					 e.encounter_nr,e.encounter_class_nr,e.is_discharged,e.encounter_date 
					 , sb.brgy_name, sm.zipcode, sm.mun_name, sp.prov_name, sr.region_name 					 
					 FROM ";   # burn added: March 9, 2007
