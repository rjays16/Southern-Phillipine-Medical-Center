...
$title = "Blood Compatibility Results (LIS)";
...
<script type="text/javascript" src="<?= $root_path ?>modules/bloodBank/js/seg-blood-result-list.js" ></script>
...
function load_labresult_list(){
    ListGen.create($('labresult-list'),{
        id: 'reportlist',
		url: '<?=$root_path?>modules/bloodBank/ajax/ajax_bloodresult_list.php',
                ...
                render: function(data, index){
					var row = data[index];
						return '<div align="center">'+
								   '<span>'+
                                        '<img id="rptbtn" onclick="viewResult(\''+row['service_code']+'\',\''+row['serial_no']+'\',\''+row['refno']+'\',\''+row['test_code']+'\');" title="Print results" src="<?=$root_path?>img/icons/pdf_icon.gif" style="cursor:pointer">'+
                                    '</span>'+
                                '</div>';
				}
			}
...
$smarty->assign('sMainBlockIncludeFile','blood/seg-lab-result-list.tpl');
