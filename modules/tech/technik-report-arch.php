...
<p>
  ...
  <table border=0 cellspacing=2 cellpadding=3>
    ...
    <tr bgcolor=#ffffdd>
      ...
      <td><input type="text" name="sdate" id="date<?php echo $i ?>_text" size=10 maxlength=10   onBlur="IsValidDate(this,'<?php echo $date_format ?>')" onKeyUp="setDate(this,'<?php echo $date_format ?>','<?php echo $lang ?>')">
	  		<a href="javascript:show_calendar('suchform.sdate','<?php echo $date_format ?>')">
			<img <?php echo createComIcon($root_path,'show-calendar.gif','0','absmiddle'); ?> id="date<?php echo $i ?>_trigger" style="cursor:pointer"></a>
  
			<!--EDITED: SEGWORKS -->
	<script type="text/javascript">
	Calendar.setup ({
		inputField : "date<?php echo $i?>_text", ifFormat : "<?php echo $phpfd?>", showsTime : false, button : "date<?php echo $i ?>_trigger", singleClick : true, step : 1
	
	});
</script>
	
	  <?php echo $LDTo ?>&nbsp;<input type="text" name="edate"  id="date<?php echo $i ?>_text" size=10 maxlength=10   onBlur="IsValidDate(this,'<?php echo $date_format ?>')" onKeyUp="setDate(this,'<?php echo $date_format ?>','<?php echo $lang ?>')">
