...
function startAJAXSearch(searchID, page) {
	...
	var prod_class = $('prod_class').value;
...
<script type="text/javascript" src="js/pharma-request-tray.js?t=<?=time()?>"></script>
...
?>
	...
	<table width="100%" cellspacing="2" cellpadding="2" style="">
		<tbody>
				...
				<td>
					<div class="segPanel" style="padding:4px 2px; padding-left:10px;">
						<table width="100%" border="0" cellpadding="0" cellspacing="2">
							<tr>
								<td width="12%" nowrap="nowrap"><span style="font:bold 12px Arial;color:#2d2d2d;">Select product classification</span></td>
								<td width="40%">
									<select class="segInput" id="prod_class" name="prod_class" onchange="startAJAXSearch('search');return false;" style="width:95%; margin-left:10px; font: bold 12px Arial">
										<option value="">-Select classification-</option>
										<option value="M">Medicines</option>
										<option value="S">Supplies</option>
									</select>
								</td>
							</tr>
							<tr>
			...
			<tr>
				<td>
					<div class="segPanel" style="padding:4px;height:290px;overflow-x:hidden;overflow-y:auto">
