...
$title = "Dialysis :: List of Requests";
...
function initialize() {
	ListGen.create( $('show_requests'), {
		id: 'requests',
		url: '<?=$root_path?>modules/dialysis/ajax/ajax_request_list.php',
		params: { 'check':'none'},
		width: 750,
		height: 200,
		autoLoad: true,
...
function startSearch()
{
	...
	var chk2 = document.getElementsByName('status_check');
...
$smarty->assign('statusCheck', '<input type="checkbox" id="status_check" name="status_check">');
...
$smarty->assign('sMainBlockIncludeFile','dialysis/request_list.tpl');
