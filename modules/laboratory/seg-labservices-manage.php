...
# Title in toolbar
 $smarty->assign('sToolbarTitle',"$LDLabServ :: $LDManager");

 # href for help button
 $smarty->assign('pbHelp',"javascript:gethelp('seg-labservices-manage.php')");

 # href for close button
 $smarty->assign('breakfile',$breakfile);

 # Window bar title
 $smarty->assign('sWindowTitle',"$LDLabServ :: $LDManager");
