...
function startAJAXSearch(searchID,page,groupCode) {
...
function addProductToList(listID, id, ipd_id, opd_id,er_id,ic_id,name, cash, charge, sservice, codenum, available, is_ER, in_lis) {
		...
		if (id) {
			...
			*/
			...
			rowSrc = '<tr class="wardlistrow'+alt+'" id="row'+addslashes(id)+'">'+
                            ...
                            '<td align="left"><span style="font:bold 11px Arial;color:#660000">'+er_id+'</span></td>'+
                            '<td align="left"><span style="font:bold 11px Arial;color:#660000">'+ic_id+'</span></td>'+
...
function validateData(){
	...
	if (data.value.length >=3){
		// alert(dataArray[2]);
		startAJAXSearch(data.id,0,dataArray);
	}
			...
			<table width="100%" cellpadding="4" border="0">
				...
				<tr>
					...
					<td>
						...
						<input id="search" name="search" class="segInput" type="text" size="30" style="background-color:#e2eaf3; border-width:thin; font:bold 13px Arial" align="absmiddle" onkeyup="validateData()"/>
						...
						<input type="image" id="search_img" name="search_img" src="<?= $root_path ?>images/his_searchbtn.gif" onclick="startAJAXSearch('search',0,dataArray);return false;" align="absmiddle" /><br />
					</td>
				</tr>
			</table>
		</div>
...
<br>
<div  style="display:block; border:1px solid #8cadc0; overflow-y:hidden; width:80%; background-color:#e5e5e5">
...
<div style="display:block; border:1px solid #8cadc0; overflow-y:scroll; height:305px; width:80%; background-color:#e5e5e5">
<table id="ServiceList" class="segList" width="100%" border="0" cellpadding="0" cellspacing="0">
	<thead>
		<tr>
            ...
            <th width="10%" align="left">ER Code</th>
            <th width="10%" align="left">IC Code</th>
