...
function countItem(groupID){
	//alert("count");
	//alert("groupID = "+groupID);
	//alert("countItem = "+document.inputform.svcChk0.value);
	//$('selectedcount').innerHTML=countSelected('grp'+groupID, mod); #commented by VAN
	$("selectedcount").innerHTML = countSelected(groupID);
}
		...
		if (code) {
			...
			if (chk!=0){
				...
				newRowSrc = '<tr class="wardlistrow1" id="svcRow'+lastRowNo+'">' +
					'<td><input type="checkbox" name="svcChk'+lastRowNo+'" id="svcChk'+lastRowNo+'" value="'+code+'" checked onClick="countItem(\''+groupID+'\');"></td>'+
					'<td>'+code+'<input type="hidden" id="svcCode'+lastRowNo+'" name="svcCode'+lastRowNo+'" value="'+code+'"></td>'+
					'<td>'+name+'<input type="hidden" id="svcName'+lastRowNo+'" name="svcName'+lastRowNo+'" value="'+name+'"></td>'+
					'<td align="right">'+price+'<input type="hidden" id="svcPrice'+lastRowNo+'" name="svcPrice'+lastRowNo+'" value="'+price+'"></td>'+
				'</tr>';	
			}else {
				//alert("false");
				newRowSrc = '<tr class="wardlistrow1" id="svcRow'+lastRowNo+'">' +
					'<td><input type="checkbox" name="svcChk'+lastRowNo+'" id="svcChk'+lastRowNo+'" value="'+code+'" onClick="countItem(\''+groupID+'\');"></td>'+
					'<td>'+code+'<input type="hidden" id="svcCode'+lastRowNo+'" name="svcCode'+lastRowNo+'" value="'+code+'"></td>'+
					'<td>'+name+'<input type="hidden" id="svcName'+lastRowNo+'" name="svcName'+lastRowNo+'" value="'+name+'"></td>'+
					'<td align="right">'+price+'<input type="hidden" id="svcPrice'+lastRowNo+'" name="svcPrice'+lastRowNo+'" value="'+price+'"></td>'+
				'</tr>';	
...
function gui_addSrcDetailRow(srvCode, srvDesc, srvPrice) {
	...
	if (srcTable=document.getElementById("srcRowsTable")) {
		...
		if (productID) {
			newRowSrc = '<tr class="wardlistrow1" id="srcRow'+lastRowNo+'">' +
					'<td>'+srvCode+'<input type="hidden" id="srcCode'+lastRowNo+'" name="srcCode'+lastRowNo+'" value="'+srvCode+'"></td>'+
					'<td>'+srvDesc+'<input type="hidden" id="srcDesc'+lastRowNo+'" name="srcDesc'+lastRowNo+'" value="'+srvDesc+'"></td>'+
					'<td align="center"><input type="button" id="srcAdd'+lastRowNo+'" name="srcAdd'+lastRowNo+'" value=">" onclick="addValidate('+lastRowNo+')" style="width:25px"></td>'+
				'</tr>';
		}
		else {
			newRowSrc = '<tr class="wardlistrow1" id="srcRow'+lastRowNo+'">' +
	...
	if (destTable=document.getElementById("destRowsTable")) {		
		...
		if (productID) { 
				newRowDest = '<tr class="wardlistrow1" id="destRow'+lastRowNo+'">' +
					...
					'<input type="hidden" id="destEntryNo'+lastRowNo+'" name="destEntryNo'+lastRowNo+'" value="'+productEntryNo+'">'+
					'<input type="hidden" id="destProductName'+lastRowNo+'" name="destProductName'+lastRowNo+'" value="'+productName+'">'+
					'<input type="hidden" id="destPrice'+lastRowNo+'" name="destPrice'+lastRowNo+'" value="'+productPrice+'">'+
					'<input type="hidden" id="destQty'+lastRowNo+'" name="destQty'+lastRowNo+'" value="'+productQty+'">'+
					'<input type="hidden" id="destID'+lastRowNo+'" name="destID'+lastRowNo+'" value="">'+
					productID+
					'</td>'+
					'<td>'+productName+'</td>'+
					'<td>'+productQty+'</td>'+
