...
function startAJAXSearch(searchID, page) {
	...
	if (searchEL) {
		...
		if (AJAXTimerID) clearTimeout(AJAXTimerID);
		$("ajax-loading").style.display = "";
		//AJAXTimerID = setTimeout("xajax_populateRequestList('"+searchID+"','"+keyword+"',"+page+","+searchLastname+",1)",100);
...
function startAJAXSearch2(searchID,section, page) {
  var searchEL = $(searchID);
  var keyword;
  //alert(searchEL.value);
...
function enableSearch(objValue){
	//alert(enableSearch);
	var rowSrc, list;
  ...
  startAJAXSearch2('search',objValue,0);
}
...
function preSet(){
	...
	if(ptype)
	{
		$('show_checklist').style.display="";
		$('checklist_header').style.display="";
		//$('nonchecklist_header').style.display="none";
		//$('show_nonchecklist').style.display="none";
		$('show_nav').style.display="none";
		$('search_labserv').style.display="none";
	}
	else
	{
...
function populate_checklist(val)
{
	xajax_populate_lab_checklist(val);
}
//end CHa
...
?>
	...
	<table width="98%" cellspacing="2" cellpadding="2" style="margin:0.7%">
		<tbody>
				...
				<td style="font:bold 12px Arial; background-color:#e5e5e5; color: #2d2d2d" >
					<div style="padding:4px 2px; padding-left:10px; ">
						<table width="95%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px">
							...
							<tr>
								<td valign="top" width="30%" align="left"><strong>Requesting Dept</strong></td>
								<td align="left">
							...
							<tr>
								<td valign="top" width="30%" align="left"><strong>Requesting Doctor</strong></td>
								<td align="left">
									<select name="request_doctor_in" id="request_doctor_in" onChange="jsSetDepartmentOfDoc();">
									</select>
							</tr>		
							<tr>		
								<td valign="top" width="30%" align="left"><strong>Non-Resident Doctor</strong></td>
								<td align="left">
							...
							<tr>		
								<td valign="top" width="30%" align="left"><strong>Other Hospital Dept</strong></td>
								<td align="left">
			...
			<tr id="show_checklist" style="display:none">
				<td style="font:bold 12px Arial; background-color:#e5e5e5; color: #2d2d2d" >
					<div style="padding:4px 2px; padding-left:10px; ">
						Laboratory Service Section &nbsp;&nbsp;&nbsp;&nbsp;<!--<select name="parameterselect" id="parameterselect" onChange="enableSearch(this.value);">-->
						<select name="parameterselect" id="parameterselect" onChange="populate_checklist(this.value);">
			...
			<tr id="search_labserv" style="display">
				<td style="font:bold 12px Arial; background-color:#e5e5e5; color: #2d2d2d" >
					<div style="padding:4px 2px; padding-left:10px; ">
			...
			<tr>
				<td>
					...
					<table class="segList" cellpadding="1" cellspacing="1" width="100%">
						<thead>
								<tr id="show_nav" style="display" class="nav">
									<th colspan="9">
							...
							<!--	
                <tr id="checklist_header" style="display:none">
									<th width="8%"></th> 
									<th width="*" align="center">&nbsp;Name/Description</th>
								...
								<tr id="nonchecklist_header" style="display">
