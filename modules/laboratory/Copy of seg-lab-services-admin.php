...
$sel='';
if ($parameterselect==$gr['group_id'] || empty($parameterselect)) $sel='selected';
$sTemp = '<select name="parameterselect" size="1">
						<option value="-1" $sel>&lt;No group&gt;</oprion>
';
...
$smarty->assign('sNewGroupName','<input type="text" name="gname" value="">');
