<?php
    ...
    if ($db->Affected_Rows()) {
        ...
        $text2 = "There are still pending results and no result in PDF format was released.
                  View the result in HTML format instead. Click the other icon with blue color.
                  Thank you.";
