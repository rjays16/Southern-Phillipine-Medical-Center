...
if ($saveok){
	$smarty->assign('sReferenceNoInput',$refno . '<input type="hidden" name="refno" size="20" maxlength="20" value="'.$refno.'"><input type="hidden" name="refnoex" size="20" maxlength="20" value="'.$refno.'">');
	...
	$smarty->assign('sPayerNameInput',$pname . '<input type="hidden" id="payer_text" name="pname" size="20" maxlength="20" readonly="1" value="'.$pname.'">');
	$smarty->assign('sPayerID','<input type="hidden" id="payer_id" name="pid"  value="'.$pid.'">');
	$smarty->assign('sIsCashCheckBox',($is_cash?"Cash":"Others").'<input type="hidden" name="is_cash" value="'.($is_cash?1:0).'">');
	
}else{
	$smarty->assign('sReferenceNoInput','<input type="text" name="refno" size="20" maxlength="20" value="'.$refno.'"><input type="hidden" name="refnoex" size="20" maxlength="20" value="'.$refnoex.'">');
	...
	$smarty->assign('sPayerNameInput','<input type="text" id="payer_text" name="pname" size="20" maxlength="20" readonly="1" value="'.$pname.'">');
	$smarty->assign('sPayerID','<input type="hidden" id="payer_id" name="pid"  value="'.$pid.'">');
	...
	if (!isset($is_cash))
		$smarty->assign('sIsCashCheckBox','<input type="radio" name="is_cash" id="is_cash_0" value="1" checked> Cash<br><input type="radio" name="is_cash" id="is_cash_1" value="0"> Others');
	else
		$smarty->assign('sIsCashCheckBox','<input type="radio" name="is_cash" id="is_cash_0" value="1" '.(($is_cash)?"checked":"").'> Cash<br><input type="radio" name="is_cash" id="is_cash_1" value="0" '.((!$is_cash)?"checked":"").'> Others');
...
");
	...
	if (!$saveok) $smarty->assign('sContinueButton','<input type="image" '.createLDImgSrc($root_path,'continue.gif','0','left').' align="absmiddle">');
