 ...
 */
 ...
 $smarty->assign('sOnLoadJs','onLoad="window.parent.$(\'d'.$_GET['ref'].'\').style.height=document.body.offsetHeight-10;" style="margin:0;padding:0"');
...
function prepareAdd(id) {
	...
	result = window.parent.parent.appendItem(details,null)
	if (result) {
			...
			<tr>
				<td>
					<table id="product-list" cellpadding="1" cellspacing="1" width="100%" style="border:1px solid #006699">
						<tbody>
							<tr>
								<td width="16%" class="segPanelHeader">Code</td>
								<td width="*" class="segPanelHeader" nowrap="nowrap">Item</td>
								<td width="5%" class="segPanelHeader" align="center">Quantity</td>
								<td width="5%" class="segPanelHeader" nowrap="nowrap" align="center">Returned</td>
								<td width="12%" class="segPanelHeader" nowrap="nowrap" align="center">Price</td>
								<td width="5%" class="segPanelHeader" nowrap="nowrap" align="center">Served?</td>
								<td width="12%" class="segPanelHeader" nowrap="nowrap" align="center"></td>
							</tr>
<?php
	$ref = $_GET['ref'];
	$Nr = $_GET['nr'];
...
?>
							<tr>
								<td class="segPanel3" align="center">
...
?>
								...
								<td class="segPanel3" align="right">
...
?>
									...
									<input id="add_<?= $count ?>" type="button" class="segButton" value="Add item" onclick="prepareAdd('<?= $count ?>')" style="margin:0;<?= ($find === FALSE ? '' : 'display:none') ?>"/>
...
?>
									<input id="add_<?= $count ?>" type="button" class="segButton" value="Add item" disabled="disabled"/>
...
?>
							<tr>
								<td class="segPanel3" align="center" colspan="10"></td>
							</tr>
...
?>
							<tr>
								<td class="segPanel3" align="center" colspan="10"><?= $rc->sql ?></td>
							</tr>
