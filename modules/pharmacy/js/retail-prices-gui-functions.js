	...
	if (destTable=document.getElementById("ppriceTable")) {			
		...
		if (pid) {
			newRowDest = '<tr class="wardlistrow1" id="ppriceRow'+lastRowNo+'">' +
				...
				'<td align="center"><input type="button" id="ppriceUpdate'+lastRowNo+'" value="GO!" onclick="prepareUpdate('+lastRowNo+')" style="color:#000066"></td>'+
			'</tr>';
		}
		else {
			newRowDest = '<tr class="wardlistrow1" id="destRow'+lastRowNo+'">' +
				'<td colspan="6">No such product exists in the Pharmacy database...</td>' +
			 '</tr>';
		}
