...
switch($target)
{
	case "ordernew":
		...
		$fileforward=$root_path."modules/pharmacy/seg-pharma-order.php".$append.$userck."&target=new&area=".($area_code_row['area_code']?$area_code_row['area_code']:$_GET['area'])."&from=".$src;
	break;

	case "orderlist":
	/*Edited By MARK 06-05-2016*/
	    $fromBloodBank ="";
		$fromBloodBank =$_GET['areaFROM'];
		$title="Pharmacy::Order list";
		$userck="ck_prod_order_user";
		$allowedarea=array("_a_1_pharmaordermanage");
		$fileforward=$root_path."modules/pharmacy/seg-pharma-order.php".$append.$userck."&target=list&from=".$src."&areaFrom=".$fromBloodBank;
	break;
	...
	case "inventory":
		...
		$userck="ck_prod_db_user";
		$allowedarea=array("_a_1_pharmainventory");
		$fileforward="seg-inventory-manager.php".$append.$userck."&from=".$src;
	break;
	...
	case "reportsjasper":
		...
		$allowedarea=array("_a_1_pharmareports");
		/*$fileforward="seg-pharma-reports.php".$append.$userck."&from=".$src;*/
		$fileforward = $root_path."modules/reports/report_launcher.php".URL_REDIRECT_APPEND."&user_origin=".$user_origin."&dept_nr=169";
	break;
	...
	// case "pharsearchdoctor":  $title="Pharmacy::Search Active and Inactive employee";
	// 					$userck="ck_prod_order_user";
	// 					$allowedarea=array("_a_1_searchempdependent");
	// 					$fileforward=$root_path."modules/personell_admin/personell_search.php?from=medocs&department=Pharmacy";
	// 					break;					
	case "menu":
