...
$aSubMenuItem=array(
										'LDPharmaRetail' => "<a href=\"apotheke-pass.php".URL_APPEND."&mode=retail\">$LDPharmaRetail</a>",
										'LDPharmaOrder' => "<a href=\"apotheke-pass.php".URL_APPEND."&mode=order\">$LDPharmaOrder</a>",
										'LDPharmaOrderOld' => "<a href=\"apotheke-pass.php".URL_APPEND."&mode=order2\">$LDPharmaOrder Old</a>",
