...
<!--								<td width="5%" class="jedPanelHeader" nowrap="nowrap" align="center">Returned</td> -->
								...
								<td width="12%" class="jedPanelHeader" nowrap="nowrap" align="center">Return</td>
							</tr>
<?php
	$ORNo = $_GET['or'];
	$Nr = $_GET['nr'];
	...
	$result = $rc->GetORDetailsForReturn($ORNo, $Nr);
	#print_r($rc->sql);
	$deptArray = array();
	if ($result) {
		$count = 0;
...
<!--
								<td class="jedPanel3" align="center">
									...
									<span style="color:#006000"><?= (int)$row["previous_returns"] ?></span>
								</td>
-->
...
<?php
	if ($status == "S") {
		$find = strpos($_COOKIE["__ret_ck"],"<".$row["ref_no"]."_".$row["service_code"].">");
	if ($row['returned']) $find = TRUE;
?>
									...
									<span id="added_<?= $count ?>" style="color:#006000;<?= ($find === FALSE ? 'display:none' : '') ?>"><?= $row['returned'] ? '<span style="color:#0060ff">Returned</span>' : 'Added' ?></span>
<?php
	}
	else {
?>
									<img src="<?= $root_path ?>/images/panel_down_grey.gif" border="0" align="absmiddle" style="opacity:.7">
<?php
	}
?>
								</td>
...
?>
							<tr>
								<td class="jedPanelHeader">Code</td>
								<td class="jedPanelHeader" nowrap="nowrap">Item</td>
								<td class="jedPanelHeader" align="center">Quantity</td>
<!--								<td class="jedPanelHeader" nowrap="nowrap" align="center">Returned</td> -->
								<td class="jedPanelHeader" nowrap="nowrap" align="center">Price</td>
								<td class="jedPanelHeader" nowrap="nowrap" align="center">Served?</td>
								<td class="jedPanelHeader" nowrap="nowrap" align="center">Return</td>
							</tr>
						</tbody>
					</table>
				</td>
