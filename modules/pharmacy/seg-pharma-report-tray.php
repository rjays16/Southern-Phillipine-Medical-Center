...
var disableInput = <?= $_GET['noinput'] = "1"; ?>
...
<script type="text/javascript" src="<?=$root_path?>modules/pharmacy/js/order-report-tray-gui.js?t=<?=time()?>"></script>
...
?>
	...
	<table width="100%" cellspacing="2" cellpadding="2" style="">
		<tbody>
			...
			<tr>
				<td>
					<div style="display:block; border:1px solid #0d4688; overflow-y:scroll; height:305px; width:100%; background-color:#e5e5e5">
