...
# Added for the common header top block
 ...
 $smarty->assign('sToolbarTitle',"Pharmacy::Retail::Manage transactions");
 # Added for the common header top block
 ...
 # Form tags
 $smarty->assign('sFormStart','<form name="frmmanagemain" action="'.$root_path.'modules/pharmacy/seg-pharma-retail-new.php" method="post">');
...
<?php 
	...
	echo '<script type="text/javascript" src="'.$root_path.'modules/pharmacy/js/retail-manage-gui-functions.js"></script>'."\r\n";
