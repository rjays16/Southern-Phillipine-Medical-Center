...
/**
* Dashlet for Patient OBGyne Results
*/
class PatientOBGyneResults extends Dashlet {

	protected static $name 	= 'OB Gyne Results';
	protected static $icon 	= 'ob.png';
	...
	*/
	public function render($renderParams=null) {
		...
		if ($mode->is(DashletMode::VIEW_MODE))
		{
			...
			return $smarty->fetch($root_path.'modules/dashboard/dashlets/PatientOBGyneResults/templates/ListView.tpl');
		}
		elseif ($mode->is(DashletMode::EDIT_MODE))
		{
			...
			$smarty->assign('settings', $preferencesSmarty);
			return $smarty->fetch($root_path.'modules/dashboard/dashlets/PatientOBGyneResults/templates/Config.tpl');
		}
		else
		{
