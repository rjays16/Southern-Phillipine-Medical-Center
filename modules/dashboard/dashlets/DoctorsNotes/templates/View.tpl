	...
	<div class="dashlet-contents-tabs-container">
		<div id="DoctorsNotes-subjective-tab" class="dashlet-contents-tabs-content">
			<form id="DoctorsNotes-subjective" onsubmit="return false;">
				<table width="100%" cellpadding="0" cellspacing="5">
							...
							<tr>
									<td><textarea rows="8" style="width:100%; font: normal 14px 'Courier New'; overflow:visible;" name="chief_complaint" class="segInput" onblur="DoctorsNotes_SaveNote('DoctorsNotes-subjective')" spellcheck="false" {{$disable}}>{{$data.chief_complaint}}</textarea></td>
							</tr>
				</table>
			</form>
		</div>
		<div id="DoctorsNotes-objective-tab" class="dashlet-contents-tabs-content">
			...
			<table width="100%" cellpadding="0" cellspacing="5">
				...
				<tr>
						<td><textarea rows="8" style="width:100%; font:normal 14px 'Courier New'; overflow:visible;" name="physical_examination" class="segInput" onblur="DoctorsNotes_SaveNote('DoctorsNotes-objective')" spellcheck="false" {{$disable}}>{{$data.physical_examination}}</textarea></td>
				</tr>
				</table>
			</form>
		</div>
		<div id="DoctorsNotes-assessment-tab" class="dashlet-contents-tabs-content">
			...
			<table width="100%" cellpadding="0" cellspacing="5">
				<tr style={{$sHideDiagnosisList}}>
					<td style="font:normal 18px Arial">Search Diagnosis</td>
				</tr>
				<tr style={{$sHideDiagnosisList}}>
					<td><input type="text" class="segInput" name="diagnosis" id="DoctorsNotes-diagnosis-{{$dashlet.id}}" style="width:100%; font: bold 16px 'Times';" / {{$disable}}></td>
				</tr>
				<tr style={{$sHideDiagnosisList}}>
					<div id="DoctorsNotes-diagnosis-list-{{$dashlet.id}}" style="width:100%; overflow:hidden; padding:0; margin-top:10px; {{$sHideDiagnosisList}}"></div>
				</tr>
				<!-- edited by Jasper Ian Q. Matunog 11/10/2014 -->
				<tr style={{$sHideClinicalImpression}}>
					<td style="font:normal 18px Arial">
						Clinical Impression
						<!-- Added by Robert 05/26/2015 -->
						<span style="float: right;">
							<button class="button" id="clinical_impression_button" name="clinical_impression_button" onclick="saveClinicalImpressionOnButton()" {{$disable_clinical_button}} {{$disable}}><img src="../../gui/img/common/default/save.png"/>
								Save
							</button>
						</span>
						<!-- End add by Robert -->
				...
				<tr style={{$sHideClinicalImpression}}>
						<td><textarea rows="8" style="width:100%; font:normal 14px 'Courier New'; overflow:visible;" id="clinical_impression" name="clinical_impression" class="segInput" onblur="" spellcheck="false" {{$disable}} {{$disable_clinical}}>{{$sClinicalImpression}}</textarea></td>
				</tr>
				...
				<tr style={{$sHideClinicalImpression}}>
					<td style="font:normal 18px Arial">
						...
						<span style="float: right;">
							...
							<button class="button" id="edit_diagnosis_button" name="edit_diagnosis_button"  {{$disabled_edit_btn}} {{$hide_edit_button}} onclick="editFinalDiagnosis()" ><img src="../../gui/img/common/default/save.png"/>
								Edit
							</button>
							<button class="button" id="final_diagnosis_button" name="final_diagnosis_button" onclick="saveFinalDiagnosisOnButton()"   {{$hide_save_button}}><img src="../../gui/img/common/default/save.png"/>
								Save
							</button>
				...
				<tr style={{$sHideClinicalImpression}}>
						<td><textarea rows="8" style="width:100%; font:normal 14px 'Courier New'; overflow:visible;" id="final_diagnosis" name="final_diagnosis" class="segInput" onblur="" spellcheck="false" {{$disable}}>{{$sFinalDiagnosis}}</textarea></td>
				</tr>
				<tr style={{$sHideClinicalImpression}}>
					<td style="font:normal 18px Arial">
						Other Diagnosis
						<span style="float: right;">
							<button class="button" id="edit_other_diagnosis_button" name="edit_other_diagnosis_button"  {{$disabled_edit_btn}} {{$hide_edit_button}} onclick="editOtherDiagnosis()" ><img src="../../gui/img/common/default/save.png"/>
								Edit
							</button>
							<button class="button" id="other_diagnosis_button" name="other_diagnosis_button" onclick="saveOtherDiagnosisOnButton()" {{$hide_save_button}}><img src="../../gui/img/common/default/save.png"/>
								Save
							</button>
						</span>
					</td>
				...
				<tr style={{$sHideClinicalImpression}}>
						<td><textarea rows="8" style="width:100%; font:normal 14px 'Courier New'; overflow:visible;" id="other_diagnosis" name="other_diagnosis" class="segInput" onblur="" spellcheck="false" {{$disable}}>{{$sOtherDiagnosis}}</textarea></td>
				</tr>
		...
		<div id="DoctorsNotes-plan-tab" class="dashlet-contents-tabs-content">
			<form id="DoctorsNotes-plan" onsubmit="return false;">
				<table width="100%" cellpadding="0" cellspacing="5">
					...
					<tr>
						<td><textarea rows="8" style="width:100%; font: normal 14px 'Courier New'; overflow:visible;" name="clinical_summary" class="segInput" onblur="DoctorsNotes_SaveNote('DoctorsNotes-plan')" spellcheck="false" {{$disable}}>{{$data.clinical_summary}}</textarea></td>
					</tr>
				</table>
			</form>
		</div>
		<div id="edit-dialog" class="edit-dialog" style="display: none;">
			...
			<table>
				<tr>
				<td><textarea rows="8" style="width:220%; font: normal 14px 'Courier New'; overflow:visible;" name="edit_summary_diagnosis"   id="edit_summary_diagnosis" class="segInput" spellcheck="false "  {{$disable_edit}}>{{$sEditFinalDiagnosis}}</textarea></td>
				</tr>
			</table>
			</form>
    	</div>
    	<div id="edit-other-dialog"   class="edit-other-dialog"style="display: none;">
			...
			<table>
				<tr>
				<td><textarea rows="8" style="width:220%; font: normal 14px 'Courier New'; overflow:visible;" name="edit_summary_other_diagnosis"   id="edit_summary_other_diagnosis" class="segInput" spellcheck="false "  {{$disable_edit}}>{{$sEditOtherDiagnosis}}</textarea></td>
				</tr>
			</table>
			</form>
    	</div>
    	<div id="audit-dialog" style="display: none;">
    		<div id="audit-list-{{$dashlet.id}}" style="width:100%; overflow:hidden; padding:0; margin-top:10px; {{$sHideDiagnosisList}}"></div>
    	</div>
	</div>
</div>
...
// 	Dashboard.dashlets.sendAction("{{$dashlet.id}}", "saveClinicalImpression", {
...
function saveClinicalImpressionOnButton() {
	Dashboard.dashlets.sendAction("{{$dashlet.id}}", "saveClinicalImpressionOnButton", {
		data:$J('#clinical_impression').val()
	});
...
function saveFinalDiagnosisOnButton() {
	...
	/*if($J('#final_diagnosis').val()!="") {*/
		Dashboard.dashlets.sendAction("{{$dashlet.id}}", "saveFinalDiagnosisOnButton", {
...
function saveOtherDiagnosisOnButton() {
	...
	//if($J('#other_diagnosis').val()!="") {
		Dashboard.dashlets.sendAction("{{$dashlet.id}}", "saveOtherDiagnosisOnButton", {
...
function saveEditFinalDiagnosis(data){
	...
	Dashboard.dashlets.sendAction("{{$dashlet.id}}", "saveEditFinalDiagnosis", {
			data:data
		});
		alert('Final Diagnosis successfully saved');
}
function saveEditOtherDiagnosis(data){
	...
	Dashboard.dashlets.sendAction("{{$dashlet.id}}", "saveEditOtherDiagnosis", {
			data:data
		});
		alert('Other Diagnosis successfully saved');
}
...
function DoctorsNotes_refreshAudit() {
	$('audit-list-{{$dashlet.id}}').list.refresh();
}
...
ListGen.create("audit-list-{{$dashlet.id}}", {
	id:'DoctorsNotes-audit-listgen-{{$dashlet.id}}',
	width: "350px",
	height: "auto",
