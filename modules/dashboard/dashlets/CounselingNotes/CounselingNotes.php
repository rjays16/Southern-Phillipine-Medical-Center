...
*/
class CounselingNotes extends Dashlet {

	protected static $name 	= 'Counseling Notes';
	...
	*/
	public function render($renderParams=null) {
		...
		if ($mode->is(DashletMode::VIEW_MODE))
		{
			...
			return $smarty->fetch($root_path.'modules/dashboard/dashlets/CounselingNotes/templates/ListView.tpl');
		}
		elseif ($mode->is(DashletMode::EDIT_MODE))
		{
			...
			$smarty->assign('settings', $preferencesSmarty);
			return $smarty->fetch($root_path.'modules/dashboard/dashlets/CounselingNotes/templates/Config.tpl');
		}
		else
		{
