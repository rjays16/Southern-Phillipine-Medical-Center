 ...
 */
class PatientRadioFindingsDashlet extends Dashlet
{

	protected static $name 	= 'Radiology Findings';
	protected static $icon 	= 'magnifier.png';
	...
	public function render($renderParams=null)
	{
		...
		if ($mode->is(DashletMode::VIEW_MODE)) {
			...
			return $smarty->fetch($root_path.'modules/dashboard/dashlets/PatientRadioFindingsDashlet/templates/ListView.tpl');
			...
			$smarty->assign('settings', $preferencesSmarty);
			return $smarty->fetch($root_path.'modules/dashboard/dashlets/PatientRadioFindingsDashlet/templates/Config.tpl');
		} else {
