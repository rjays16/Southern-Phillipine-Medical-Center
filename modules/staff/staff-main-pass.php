...
switch($target)
{
	case 'dutyplan': $fileforward="staff-dienstplan-planen.php".URL_REDIRECT_APPEND."&dept_nr=$dept_nr&retpath=$retpath&pmonth=$pmonth&pyear=$pyear";
							$title=$LDORNOCScheduler;
							break;
	case 'setpersonal': $fileforward="staff-dienst-personalliste.php".URL_REDIRECT_APPEND."&ipath=$retpath&retpath=$retpath";
							$title=$LDNursesList;
							break;
