...
switch($retpath)
{
	...
	case "qview": $rettarget='staff-dienst-schnellsicht.php'.URL_APPEND.'&hilitedept='.$dept_nr; break;
...
function popinfo(l)
{
	...
	ww=400;
	wh=400;
	urlholder="staff-dienstplan-popinfo.php<?php echo URL_REDIRECT_APPEND ?>&nr="+l+"&dept_nr=<?php echo $dept_nr ?>&route=validroute&user=<?php echo $aufnahme_user.'"' ?>;
...
$smarty->assign('sNewPlan',"<a href=\"staff-main-pass.php".URL_APPEND."&target=dutyplan&dept_nr=$dept_nr&pmonth=$pmonth&pyear=$pyear&retpath=$retpath\"><img ".createLDImgSrc($root_path,'newplan.gif','0')."  alt=\"$LDNewPlan\"></a>");
