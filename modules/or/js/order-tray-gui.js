...
//	alert("prep"+id);
	...
	//added by angelo m. 09.06.2010
	//start
	if(details.name.toLowerCase().search("sponge")>-1){
		var sponge_row='sponge_row'+details.id;
			if(window.parent.document.getElementById(sponge_row)==null){
				window.parent.add_to_sponge(details);
			}
	}
