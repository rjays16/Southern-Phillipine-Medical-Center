...
require($root_path."modules/or/ajax/op-request-procedure.common.php");
...
function startAJAXSearch(searchID, page) {     
    ...
    if (searchEL && searchEL.value.length >= 3) {
        ...
        AJAXTimerID = setTimeout("xajax_populateProcedureList('"+searchID+"','"+searchText+"',"+page+","+searchLastname+","+includeEnc+")",100);
...
-->
<script type="text/javascript" src="<?=$root_path?>modules/or/js/or-request-procedure-tray-gui.js?t=<?=time()?>"></script>
                        ...
                        <table id="person-list" class="jedList" cellpadding="0" cellspacing="0" width="100%">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th width="90%">Name/Description</th> 
                                    <th width="10%">&nbsp;</th>
                                </tr>
                            </thead>
                            <tbody id="person-list-body">
                                <tr>
                                    <td colspan="9">No such OR package exists...</td>
                                </tr>
                            </tbody>
                        </table>
