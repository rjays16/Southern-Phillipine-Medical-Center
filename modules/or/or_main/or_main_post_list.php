...
$smarty->assign('sToolbarTitle',"OR Main::List of Scheduled Requests"); //Assign a toolbar title
$smarty->assign('sWindowTitle',"OR Main::List of Scheduled Requests");
...
({
 url: '<?=$root_path?>modules/or/ajax/ajax_or_main_post.php',
 dataType: 'json',
 colModel : [
