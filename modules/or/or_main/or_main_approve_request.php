...
if($or_main_info['room_nr']){
	...
	$cur_bed_nr = $or_main_info['bed_nr'];
	$_POST['length_operation'] = $or_main_info['length_op'];
...
$operation_date_display = isset($_POST['final_operation_date']) ? date('F d, Y h:ia', strtotime($_POST['final_operation_date'])) : date('F d, Y h:ia');
$operation_date = isset($_POST['final_operation_date']) ? date('Y-m-d H:i', strtotime($_POST['final_operation_date'])) : date('Y-m-d H:i');
...
$smarty->assign('final_operation_date', '<input type="hidden" name="final_operation_date" id="final_operation_date" value="'.$operation_date.'" />');
$smarty->assign('final_operation_dt_picker', '<img src="'.$root_path.'images/pickdate.png" id="final_operation_dt_picker" class="date_time_picker" />');
