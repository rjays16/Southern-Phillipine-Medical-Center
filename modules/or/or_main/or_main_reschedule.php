...
$smarty->assign('sToolbarTitle',"Operating Room Main::List of Pending Requests"); //Assign a toolbar title
$smarty->assign('sWindowTitle',"Operating Room Main::List of Pending Requests"); //Assign a toolbar title
...
({
 url: '<?=$root_path?>modules/or/ajax/ajax_or_main_reschedule.php',
 dataType: 'json',
 colModel : [
