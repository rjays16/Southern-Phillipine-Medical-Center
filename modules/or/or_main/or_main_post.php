...
$breakfile='or_main_post_list.php'.URL_APPEND;
...
$smarty->assign('clinical_summary', '<a href="javascript:void(0)" onclick="openReport(this.id,'.$refno.','.$pid.','.$encounter_nr.');" id="clinical_summary"></a>');
...
$smarty->assign('sponge_count', '<input type="text" name="sponge_count" id="sponge_count" value="'.$sponge_count.'" />');
#added code by angelo m. 09.03.2010
#start here
...
//added by CHA 10-23-09
function openReport(rept_id,refno, pid, enc_nr)
{
	if (typeof(enc_nr) == 'undefined') enc_nr = '';
	...
	else if(rept_id=='clinical_summary') window.open('or_clinical_summary_pdf.php?refno='+refno+'&encounter_nr='+enc_nr+'&pid='+pid,null,'width=620,height=440,menubar=no,resizable=yes,scrollbars=yes');
