...
$breakfile='or_main_reschedule.php'.URL_APPEND;
...
$smarty->assign('final_operation_date', '<input type="text" name="or_operation_date" id="or_operation_date" value="'.$_POST['or_operation_date'].'" checkDate(); />');
...
function openScheduleView() {
	...
	var priority = "<?php echo $or_main_info['request_priority']?>";
			overlib(
				OLiframeContent('<?=$root_path?>modules/or/request/seg_or_schedules.php?m=ormain&dept='+dept+'&priority='+priority, 800, 400,
					'schedView', 0, 'auto'),
