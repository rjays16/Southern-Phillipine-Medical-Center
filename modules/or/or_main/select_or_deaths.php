...
$smarty->assign('sToolbarTitle',"OR Main::List of OR Deaths"); //Assign a toolbar title
$smarty->assign('sWindowTitle',"OR Main::List of OR Deaths");
...
({
 url: '<?=$root_path?>modules/or/ajax/ajax_or_deaths.php',
 dataType: 'json',
 colModel : [
