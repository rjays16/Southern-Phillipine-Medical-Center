...
function savedata(iln,ifn,inx,ipr,person_nr)
{
	x=inx.selectedIndex;
	...
	d.inputdata.value="?";
	d.personell_nr.value = person_nr;
	d.submit();
}
-->
</script>
...
//		   break;
		   echo '
	  		<tr bgcolor="#ffffff">
    			<td class="v13" >
				&nbsp;<a href="javascript:savedata(\''.$result[name_last].'\',\''.$result[name_first].'\',document.infoform.f'.$counter.',\''.$result[job_function_title].'\',\''.$result['nr'].'\')" title="'.str_replace("~tagword~",$title,$LDUseData).'">'.$result[name_last].'</a>
				</td> 
    			<td   class="v13" >
				&nbsp;<a href="javascript:savedata(\''.$result[name_last].'\',\''.$result[name_first].'\',document.infoform.f'.$counter.',\''.$result[job_function_title].'\',\''.$result['nr'].'\')" title="'.str_replace("~tagword~",$title,$LDUseData).'">'.$result[name_first].'</a>
				</td> 
    			<td class="v13" >
    			...
    			<td   class="v13" >
				&nbsp;<a href="javascript:savedata(\''.$result[name_last].'\',\''.$result[name_first].'\',document.infoform.f'.$counter.',\''.$result[job_function_title].'\',\''.$result['nr'].'\')"><img '.createComIcon($root_path,'uparrowgrnlrg.gif','0').' align=absmiddle>
