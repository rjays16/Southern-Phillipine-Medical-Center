...
$smarty->assign('sToolbarTitle',"Operating Room ASU::List of Approved Requests"); //Assign a toolbar title
$smarty->assign('sWindowTitle',"Operating Room ASU::List of Approved Requests"); //Assign a toolbar title
...
$smarty->assign('sMainBlockIncludeFile','or/select_or_asu_approve.tpl'); //Assign the select_or_request template to the frameset
...
({
 url: '<?=$root_path?>modules/or/ajax/pre_operation.php',
 dataType: 'json',
 colModel : [
						 ...
						 {display: 'Patient ID', width:55, name:'patient_id', sortable: false, align: 'left'},
						 ...
						 {display: 'Operation', width:110, name:'cancel', sortable: false, align: 'left'}
						 ],
