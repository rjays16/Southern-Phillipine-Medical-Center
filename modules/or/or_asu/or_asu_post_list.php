...
$smarty->assign('sToolbarTitle',"Operating Room ASU::List of Scheduled Requests"); //Assign a toolbar title
$smarty->assign('sWindowTitle',"Operating Room ASU::List of Scheduled Requests");
...
({
 url: '<?=$root_path?>modules/or/ajax/ajax_or_asu_post.php',
 dataType: 'json',
 colModel : [
						 ...
						 {display: 'Operation', width:115, name:'cancel', sortable: false, align: 'left'}
						 ],
