...
function startAJAXSearch(searchID, page) {
	...
	*/
	...
	var targetItems = "<?=$_GET['targetItem']?>";
	//end CHA
	...
	if (true) {
		...
		if(targetItems)
		{
					var script = "xajax_populateORProductList('"+searchID+"',"+page+",'"+searchEL.value+"'" +
			",'"+discountID+"'" +
			",'"+areaSelected+"'"+
			", "+disableInput+")";
 }
...
<script type="text/javascript" src="<?=$root_path?>modules/or/js/order-tray-gui.js?t=<?=time()?>"></script>
