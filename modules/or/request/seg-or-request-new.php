...
$phpfd=str_replace("yy","%y", strtolower($phpfd));
 ...
 $smarty->assign('sToolbarTitle',"OR::Request::New request");
 ...
 # Window bar title
 $smarty->assign('sWindowTitle',"OR::Request::New request");
...
<script type="text/javascript" src="<?=$root_path?>modules/pharmacy/js/order-gui.js?t=<?=time()?>"></script>
...
$smarty->assign('sSelectEnc','<img id="select-enc" src="../../../images/btn_encounter_small.gif" border="0" style="cursor:pointer"
       onclick="if (warnClear()) { emptyTray(); overlib(
        OLiframeContent(\'../../../modules/pharmacy/seg-order-select-enc.php\', 700, 400, \'fSelEnc\', 0, \'auto\'),
...
$smarty->assign('sContinueButton','<img src="'.$root_path.'images/btn_submitorder" align="center" onclick="if (validate()) document.inputform.submit()"  style="cursor:pointer" />');

# Assign the form template to mainframe
//$smarty->assign('sMainBlockIncludeFile','order/form.tpl');
$smarty->assign('sMainBlockIncludeFile','or/or-request-new.tpl');
