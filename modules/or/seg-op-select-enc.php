 ...
 */
 ...
 # Assign Body Onload javascript code
  ...
  #$smarty->assign('sOnLoadJs','onLoad="$(\'search\').focus();"');		#---added on may28,2008---pet---
  $smarty->assign('sOnLoadJs','onLoad="document.getElementById(\'search\').focus();"'); #---added on may29,2008---trial to check stability in both Firefox & Flock browsers---pet---
