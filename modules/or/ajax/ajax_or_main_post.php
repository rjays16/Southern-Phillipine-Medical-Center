...
$where $sort $limit";
	 ...
	 $post_operative = '<a href="'.$root_path.'modules/or/or_main/or_main_post.php?refno='.$row['refno'].'&mode='.$mode.'&pid='.$row['pid'].'&encounter_nr='.$row['encounter_nr'].'" id="post_operative"></a>';
