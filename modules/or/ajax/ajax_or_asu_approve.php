...
#echo $query;
	 ...
	 while($row = $result->FetchRow()) {
		 if ($row['status'] == 'request') {
			 ...
			 $approve = '<a href="'.$root_path.'modules/or/or_asu/or_asu_approve_request.php'.URL_APPEND.'&refno='.$row['refno'].'&pid='.$row['pid'].'&encounter_nr='.$row['encounter_nr'].'" id="approve_request"></a>';
		 }
		 elseif ($row['status'] == 'approved') {
			 ...
			 $approve = '<a href="'.$root_path.'modules/or/or_asu/or_asu_approve_request.php'.URL_APPEND.'&refno='.$row['refno'].'&pid='.$row['pid'].'&encounter_nr='.$row['encounter_nr'].'" id="disapprove_request"></a>';
		 }
		 else {
			 $status = 'Disapproved';
			 #$approve = '<a href="'.$root_path.'modules/or/or_main/or_main_approve_request.php'.URL_APPEND.'&refno='.$row['refno'].'" id="approve_request"></a>';
