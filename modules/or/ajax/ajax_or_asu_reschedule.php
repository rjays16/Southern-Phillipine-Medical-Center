...
#echo $query;
	 ...
	 $schedule = '<a href="'.$root_path.'modules/or/or_asu/or_asu_reschedule_request.php?refno='.$row['refno'].'&pid='.$row['pid'].'&encounter_nr='.$row['encounter_nr'].'" id="schedule_request"></a>';
