...
$title='Admission';
if (!$_GET['from'])
	$breakfile=$root_path."modules/ipd/seg-ipd-functions.php".URL_APPEND."&userck=$userck";
else {
	if ($_GET['from']=='CLOSE_WINDOW')
		$breakfile = "javascript:window.parent.cClick();";
	else
		$breakfile = $root_path.'modules/ipd/seg-ipd-pass.php'.URL_APPEND."&userck=$userck&target=".$_GET['from'];
}

$imgpath=$root_path."pharma/img/";
$thisfile='seg-ipd-reports.php';
 ...
 */
 ...
 $smarty->assign('sToolbarTitle',"Admission::Reports");
...
// $smarty->assign('pbBack',$returnfile);
 ...
 # Window bar title
 $smarty->assign('sWindowTitle',"Admission Reports");
