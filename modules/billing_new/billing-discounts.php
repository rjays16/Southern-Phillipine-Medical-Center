...
<script>
	...
	function pfResetWarning() {
		var src = "<div style='background:red;'><br><br><h1 style='color:#ffffff;font-size:50px;'><center>PF coverage is reset. Please reapply.</h1>"+ "</div>";
	 	$j(src).dialog({
	            autoOpen: true,
	            modal:true,
	            height: "auto",
	            ...
	            buttons: {
	                "OK": function() 
	                    {
	                        $j(this).dialog("close");
	                        window.parent.closeActiveDialog();
	                    }
	            }
	    });
	}
