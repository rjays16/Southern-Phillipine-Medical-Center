...
# added by: syboy 01/03/2016 : moew
...
{
	case 'Manager':
			$title="Credit and Collection :: Manage Grant Account Types";
			$userck="ck_opd_user";
			$allowedarea=array('_a_1_grant_account_type');
			$fileforward=$root_path."index.php?r=creditCollection/grantAccountType/admin";
	break;
	#added by VAN 07-14-2010
	case 'Guarantor Manager':
			$title="Credit and Collection :: Manage Guarantor Accounts";
			$userck="ck_opd_user";
			$allowedarea=array('_a_1_guarantor_accounts');
			$fileforward=$root_path."index.php?r=grantAccount/grantAccounts/admin";
	break;
...
<p>
<P>
<img src="../../gui/img/common/default/persons.gif" border=0 align="middle">
