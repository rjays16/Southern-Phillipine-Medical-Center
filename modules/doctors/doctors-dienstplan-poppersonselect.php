...
function addelem(elem,hid,freq,last,first,b,nr)
{
	...
	eval("window.opener.document.forms[0].elements[freq].value=0;"); /* burn added: Sept 13, 2006*/
}
...
*/
	    echo '
	    <a href="#" onClick="addelem(\''.$mode.$elemid.'\',\'h'.$mode.$elemid.'\',\'f'.$mode.$elemid.'\',\''.ucfirst($row['name_last']).'\',\''.ucfirst($row['name_first']).'\',\''.$row['date_birth'].'\',\''.$row['personell_nr'].'\')">  
