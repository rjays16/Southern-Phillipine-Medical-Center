...
#echo "doctors-select-dept.php : target = '".$target."'<br> \n";
#echo "doctors-select-dept.php : _GET['target'] = '".$_GET['target']."'<br> \n";
...
#echo "doctors-select-dept.php : fileforward = '".$fileforward."'<br> \n";
