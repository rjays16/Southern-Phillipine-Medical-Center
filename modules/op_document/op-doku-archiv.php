...
<?php
	...
	if($mode=="select"){
 	   ...
 	   echo '
 	<input name="op_date" type="text" id="date_text" size="14" onBlur="IsValidDate(this,\''.$date_format.'\')" onKeyUp="setDate(this,\''.$date_format.'\',\''. $lang.'\')">';
?>
...
if($mode=="select") {
   ...
   echo '<input name="gebdatum" id="date_text1" type="text" size="14" onBlur="IsValidDate(this,\''.$date_format.'\')"  onKeyUp="setDate(this,\''.$date_format.'\',\''. $lang.'\')">';
?>
   <!--	<a href="javascript:show_calendar('opdoc.gebdatum','<?php echo $date_format ?>')"> -->
	<img <?php echo createComIcon($root_path,'show-calendar.gif','0','absmiddle',TRUE); ?> id="date_trigger1" style="cursor:pointer ">
