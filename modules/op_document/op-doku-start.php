...
if($mode=='saveok'){
   echo '<b>'.formatDate2Local($opdoc['op_date'],$date_format).'</b>'; 
    ...
    echo '<input name="op_date" type="text" id="date_text" size="10" maxlength=10 value="';
	if($err_data){
       echo $op_date;
	}else{	  
...
?>
 	 <a href="javascript:show_calendar('opdoc.op_date','<?php echo $date_format; ?>')"><img <?php echo createComIcon($root_path,'show-calendar.gif','0','absmiddle'); ?> id="date_trigger" style="cursor:pointer " ></a>
...
<tr <?php if($mode=='saveok') echo "bgcolor=#ffffff"; ?>>
<td background="<?php echo $bg_img; ?>"><FONT  color=red><?php if($err_therapy) echo '*'; ?><?php echo $LDProcedure//echo $LDTherapy ?>:
</td>
<td>
