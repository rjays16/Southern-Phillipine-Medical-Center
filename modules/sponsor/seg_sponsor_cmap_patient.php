...
//			FILTER,
			...
			CLOSETEXT, '<img src=<?= $root_path ?>/images/close_red.gif border=0 >',
			CAPTIONPADDING,2,
			CAPTION,'Process MAP walkin request entry',
			MIDX,0, MIDY,0,
			STATUS,'Process MAP walkin request entry');
	return false;
}
...
//			FILTER,
			...
			CLOSETEXT, '<img src=<?= $root_path ?>/images/close_red.gif border=0 >',
			CAPTIONPADDING,2,
			CAPTION,'View request entry',
			MIDX,0, MIDY,0,
			STATUS,'View request entry');
	return false;
}
...
$flst = &$listgen->createList(
	array(
		'LIST_ID' => 'flst',
		'COLUMN_HEADERS' => array('Date','MAP No.','Referral No.','Account','Allotted','Balance','Encoder', 'Remarks', ''),
