...
function updateBalance($pid) {
  ...
  $bal = $db->GetOne('SELECT running_balance FROM seg_cmap_patient_balance WHERE pid='.$db->qstr($pid));
...
require_once($root_path.'modules/sponsor/ajax/cmap_adjustment.common.php');
