...
require($root_path."modules/sponsor/ajax/lingap_adjustment_edit.common.php");
...
<!--        <tr>
        ...
        <tr>
          <td class="segPanel" align="right" valign="middle"><strong>Adjustment</strong></td>
          <td class="segPanel2" align="left" valign="middle" style="border-right:0" nowrap="nowrap">
            <label class="segInput" for="set">Set</label><input id="set" name="adjtype" class="segInput" type="radio" value="set">
            <label class="segInput" for="add">+/-</label><input id="add" name="adjtype" class="segInput" type="radio" value="add">
          </td>
          <td class="segPanel2" align="left" valign="middle" style="border-left:0">
            <strong></strong>
          </td>
