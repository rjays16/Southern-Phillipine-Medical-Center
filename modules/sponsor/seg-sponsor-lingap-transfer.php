...
require($root_path."modules/sponsor/ajax/lingap-patient-transfer.common.php");
...
function save() {
  if (validate()) {
    startLoading();
    xajax.call( 'save', { parameters:[xajax.getFormValues('transfer-data', false)] } );
  }
}
...
?>
  ...
  <div style="width:98%; padding:5px 0px">
    <table border="0" cellspacing="1" cellpadding="2" width="99%" align="center" style="">
      <tbody>
        ...
        <tr>
          <td class="segPanel" align="right" valign="middle" width="18%"><strong>Lingap control no.</strong></td>
          ...
          <td class="segPanel2" align="left" valign="middle" width="*" style="">
            <strong>Lingap designated control number for this grant</strong>
          </td>
        </tr>
        <tr>
          <td class="segPanel" align="right" valign="middle" width="18%"><strong>SS control no.</strong></td>
          <td class="segPanel2" align="left" valign="middle" width="30%" style="">
            <input id="ss_nr" name="ss_nr" class="segInput" type="text" size="15" value="" >
          </td>
          <td class="segPanel2" align="left" valign="middle" width="*" style="">
            <strong>Control no. for the Social Service summary</strong>
          </td>
        </tr>
        <tr>
          <td class="segPanel" align="right" valign="middle" width="18%"><strong>Advanced release</strong></td>
          <td class="segPanel2" align="left" valign="middle" width="30%" style="">
            <input id="is_ep" name="is_ep" class="segInput" type="checkbox" size="15" value="1" >
          </td>
          <td class="segPanel2" align="left" valign="middle" width="*" style="">
            <strong>Check if this grant is advanced release</strong>
          </td>
        </tr>
        <tr>
          <td class="segPanel" align="right" valign="middle" width="18%"><strong>HRN</strong></td>
          <td class="segPanel2" align="left" valign="middle" width="30%" style="border-right:0">
            <input id="pid" name="pid" class="segInput" type="text" value="<?= $_REQUEST['pid'] ?>" size="15" readonly="readonly">
          </td>
          <td class="segPanel2" align="left" valign="middle" width="*" style="border-left:0">
            <strong>Hospital reg. number</strong>
          </td>
        </tr>
        <tr>
          <td class="segPanel" align="right" valign="middle"><strong>Fullname</strong></td>
          <td class="segPanel2" align="left" valign="middle" style="border-right:0">
            <input id="name" name="name" class="segInput" type="text" value="<?= $_REQUEST['name'] ?>" size="25" disabled="disabled">
          </td>
        ...
        <tr>
          ...
          <td class="segPanel2" align="left" valign="middle" style="border-right:0">
            <textarea class="segInput" id="remarks" name="remarks" rows="1" cols="23"></textarea>
          </td>
          <td class="segPanel2" align="left" valign="middle" style="border-left:0">
  ...
  <div style="width:99%; padding-left:20%" align="left">
    <input class="segButton" type="button" value="Grant amount" onclick="save()"/>
