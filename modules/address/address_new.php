...
<script type="text/javascript" src="../../js/overlibmws/iframecontentmws.js"></script>
<script type="text/javascript" src="../../js/overlibmws/overlibmws_draggable.js"></script>
<script type="text/javascript" src="../../js/overlibmws/overlibmws_filter.js"></script>
<script type="text/javascript" src="../../js/overlibmws/overlibmws_overtwo.js"></script>
<script type="text/javascript" src="../../js/overlibmws/overlibmws_scroll.js"></script>
...
?>
	/*
			xajax_setAll('region'); // resets the list of provinces
			xajax_setAll('province'); // resets the list of provinces
			xajax_setAll('municity'); // resets the list of municipalities/cities
			xajax_setAll('zipcode'); // resets the list of zipcodes
			xajax_setAll('barangay'); // resets the list of barangays
...
<table border=0>
	...
	<tr>
		<td align=right class="adm_item"><font color=#ff0000><b>*</b></font> Sample : </td>
		<td class="adm_input" colspan="3">
			<input name="" id="" text="text" size="25" value="" />
