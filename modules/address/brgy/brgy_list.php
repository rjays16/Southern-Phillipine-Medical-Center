...
//$address=$address_brgy->getAllActiveCityTown();
$address=&$address_brgy->getLimitAddress($GLOBAL_CONFIG['pagin_address_list_max_block_rows'],$pgx,$oitem,$odir,TRUE);
...
if(isset($totalcount)&&$totalcount){
	...
	$totalcount=$address_brgy->countAllAddress();
	$pagen->setTotalDataCount($totalcount);
}
...
# Title in toolbar
 $smarty->assign('sToolbarTitle',"$segBrgy :: $LDListAll");
 ...
 # Window bar title
 $smarty->assign('sWindowTitle',"$segBrgy :: $LDListAll");
...
?>
	<tr  class="<?php echo $bgc ?>">
		...
		<td><a href="brgy_info.php<?php echo URL_APPEND.'&retpath=list&brgy_nr='.$addr['brgy_nr']; ?>"><?php echo $addr['brgy_name']; ?></a></td>
