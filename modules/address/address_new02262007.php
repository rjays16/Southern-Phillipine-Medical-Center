...
//			alert("ajxAddAddress: grpEl = '"+grpEl+"'");
		...
		/*
				This will set the province's name, municipality/city's name and
				barangay's default name after selecting a region.
				input: NONE
		*/
...
//		alert("setByRegion: ");
	...
	function jsSetRegion() {
		...
		if (aRegionID==0){
			$('prov_nr')=0; // resets the list of provinces
			$('mun_nr')=0; // resets the list of municipalities/cities
			$('brgy_nr')=0; // resets the list of barangays
		} else {
		...
		/*
				...
				barangay's default name after selecting a municipality/city.
				input: region's ID, province's ID
		*/
	function setByProvince(regionID) {
//		alert("setByProvince: regionID = '"+regionID+"' \n");
	...
	function jsSetProvince() {
		...
		alert("jsSetProvince: aProvinceID = '"+aProvinceID+"'");
		if (aProvinceID==0){
			$('mun_nr')=0; // resets the list of municipalities/cities
			$('brgy_nr')=0; // resets the list of barangays
		} else {
		...
		/*
				...
				input: region's ID, province's ID
		*/
	function setByMuniCity(regionID, provID) {
//		alert("setByMuniCity: regionID = '"+regionID+"' \n provID = '"+provID+"' \n");
	...
	function jsSetMuniCity() {
		...
		alert("jsSetMuniCity: aMuniCityID = '"+aMuniCityID+"'");
		if (aMuniCityID==0){
			$('brgy_nr')=0; // resets the list of barangays
		} else {
		...
		*/
	function setByBarangay(regionID, provID, munID) {
//		alert("setByBarangay: regionID = '"+regionID+"' \n provID = '"+provID+"' \n munID = '"+munID+"' \n");
	...
	function jsSetBarangay() {
		...
		alert("jsSetBarangay: aBrgyID = '"+aBrgyID+"'");
//		createCookie("campus",aCampusID,1);
