...
//$address=$address_prov->getAllActiveCityTown();
$address=&$address_prov->getLimitAddress($GLOBAL_CONFIG['pagin_address_list_max_block_rows'],$pgx,$oitem,$odir,TRUE);
...
if(isset($totalcount)&&$totalcount){
	...
	$totalcount=$address_prov->countAllAddress();
	$pagen->setTotalDataCount($totalcount);
}
...
# Title in toolbar
 $smarty->assign('sToolbarTitle',"$segProvince :: $LDListAll");
 ...
 # Window bar title
 $smarty->assign('sWindowTitle',"$segProvince :: $LDListAll");
...
?>
	<tr  class="<?php echo $bgc ?>">
        <td><?php echo $prov_code; //echo $addr['code']; ?></td>
		<td><a href="province_info.php<?php echo URL_APPEND.'&retpath=list&prov_nr='.$addr['prov_nr']; ?>"><?php echo $addr['prov_name']; ?></a></td>
