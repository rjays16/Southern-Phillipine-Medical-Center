...
//		 aRegionID = aRegion.options[aRegion.selectedIndex].value;
//		 aProvinceID = aProvince.options[aProvince.selectedIndex].value;
//		 aMuniCityID = aMuniCity.options[aMuniCity.selectedIndex].value;
//		 aBrgyID = aBrgy.options[aBrgy.selectedIndex].value;
//alert("jsSetBarangay: aRegionID = '"+aRegionID+"' \n aProvinceID = '"+aProvinceID+"' \n aMuniCityID = '"+aMuniCityID+"' \n aBrgyID = '"+aBrgyID+"'");
//			xajax_setZipcode(aZipcodeID);
		}
	}
