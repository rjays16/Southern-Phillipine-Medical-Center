...
$address=&$address_obj->getLimitAddress($GLOBAL_CONFIG['pagin_address_list_max_block_rows'],$pgx,$oitem,$odir);
...
if(isset($totalcount)&&$totalcount){
	...
	$totalcount=$address_obj->countAllAddress();
	$pagen->setTotalDataCount($totalcount);
}
...
# Title in toolbar
 $smarty->assign('sToolbarTitle',"$segRegion :: $LDListAll");
 ...
 # Window bar title
 $smarty->assign('sWindowTitle',"$segRegion :: $LDListAll");
...
?>
	<tr  class="<?php echo $bgc ?>">
		...
		<td><a href="region_info.php<?php echo URL_APPEND.'&retpath=list&region_nr='.$addr['region_nr']; ?>"><?php echo $addr['region_name']; ?></a></td>
