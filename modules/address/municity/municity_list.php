...
//$address=$address_municity->getAllActiveCityTown();
$address=&$address_municity->getLimitAddress($GLOBAL_CONFIG['pagin_address_list_max_block_rows'],$pgx,$oitem,$odir,TRUE);
...
if(isset($totalcount)&&$totalcount){
	...
	$totalcount=$address_municity->countAllAddress();
	$pagen->setTotalDataCount($totalcount);
}
...
# Title in toolbar
 $smarty->assign('sToolbarTitle',"$segMuniCity :: $LDListAll");
 ...
 # Window bar title
 $smarty->assign('sWindowTitle',"$segMuniCity :: $LDListAll");
	...
	<tr class="wardlisttitlerow">
		...
		<td><b>
			<?php 
				...
				echo $pagen->SortLink($segProvinceName,'prov_name',$odir,$flag); 	// replaced $segRegionName, 10-31-2007, fdp---
			?></b>
		</td>
	</tr> 
<?php
...
?>
	<tr  class="<?php echo $bgc ?>">
		...
		<td><a href="municity_info.php<?php echo URL_APPEND.'&retpath=list&mun_nr='.$addr['mun_nr']; ?>"><?php echo $addr['mun_name']; ?></a></td>
