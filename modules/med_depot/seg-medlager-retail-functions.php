 ...
 */
 ...
 $smarty->assign('sToolbarTitle',"$LDMedDepot::$LDPharmaRetail");

 # href for the back button
// $smarty->assign('pbBack',$returnfile);

 # href for the help button
 $smarty->assign('pbHelp',"javascript:gethelp('submenu1.php','$LDMedDepot $LDPharmaDb')");

 # href for the close button
 $smarty->assign('breakfile',$breakfile);

 # Window bar title
 $smarty->assign('title',"$LDMedDepot::$LDPharmaDb");
...
$aSubMenuItem=array(     'LDSegNewPurchase' => '<a href="'.$root_path.'modules/med_depot/seg-medlager-retail-new.php'. URL_APPEND."&userck=$userck".'&cat=med">Create purchase</a>',
					     'LDSegPharmaManageTrans' => '<a href="'.$root_path.'modules/med_depot/seg-medlager-retail-manage.php'. URL_APPEND."&userck=$userck".'&cat=med">Manage transactions</a>',
						 'LDSegPharmaPrices' => '<a href="'.$root_path.'modules/med_depot/seg-medlager-retail-prices.php'. URL_APPEND."&userck=$userck".'&cat=med">Product prices</a>',
					     'LDPharmaDb' => '<a href="'.$root_path.'modules/med_depot/medlager-pass.php'.URL_APPEND."&mode=dbank"."&userck=$userck".'"><nobr>Product databank</nobr></a>'
				   );
