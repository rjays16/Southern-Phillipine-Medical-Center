...
$smarty->append('JavaScript',$sTemp);
 ...
 $aSubMenuIcon=array(                   createComIcon($root_path,'waiting.gif','0'), # burn added: August 3, 2006
...
$aSubMenuText=array(                    $LDMedDepotRetailTxt, # burn added: August 3, 2006
                                        $LDPharmaOrderTxt,
										$LDHow2OrderTxt,
										$LDOrderCatTxt,
										$LDOrderArchiveTxt,
...
$aSubMenuItem=array(                    'LDPharmaRetail' => "<a href=\"medlager-pass.php".URL_APPEND."&mode=retail\">$LDMedDepotRetail</a>",  # burn added: August 3, 2006
                                        'LDPharmaOrder' => "<a href=\"medlager-pass.php".URL_APPEND."&mode=order\">$LDPharmaOrder</a>",
