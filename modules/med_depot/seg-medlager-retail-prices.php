...
# Added for the common header top block
 ...
 $smarty->assign('sToolbarTitle',"Medical Depot::Retail::Product prices");
 # Added for the common header top block
 ...
 $smarty->assign('pbBack',FALSE);
  ...
  # Load the javascript code
	...
	echo '<script type="text/javascript" src="'.$root_path.'modules/med_depot/js/retail-prices-gui-functions.js"></script>'."\r\n";
