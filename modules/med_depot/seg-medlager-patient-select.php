...
switch($origin)
{
    ...
    case 'admit': $breakfile='patient.php';
	                         break;
    default : $breakfile='seg-close-window.php';
}
...
# Added for the common header top block
 ...
 require_once($root_path.'include/care_api_classes/class_gui_search_person_encounter.php');
...
$psearch->setTargetFile('seg-medlager-retail-person-transactions.php');

$psearch->setCancelFile($breakfile);

$psearch->setPrompt($LDEnterPersonSearchKey);

$psearch->prepareSendToInput("opener","payer");
...
{
?>
<form action="seg_pharma_patient.php" method=post>
