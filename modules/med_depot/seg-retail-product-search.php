...
switch($cat)
{
	...
	case "medlager":
							...
							$breakfile=$root_path."modules/med_depot/seg-close-window.php".URL_APPEND."&userck=$userck";
...
$bShowThisForm = TRUE;
require($root_path."include/inc_retail_products_search_result_mod.php");
