...
if (eregi('details',$mode)) {
    ...
    if ($mode=='save') include($root_path.'include/inc_meddepot_retail_db_save_mod.php'); # burn modified: August 16, 2006
}
if ($saveok) include($root_path.'include/inc_meddepot_retail_display_rdetails.php'); # burn modified: August 16, 2006
...
if ($saveok) {
	...
	ob_start();
	include("seg-medlager-retail-new-rdetails.inc.php");
	include("seg-medlager-retail-new-discount.inc.php");
