...
# Window bar title
$smarty->assign('sWindowTitle',"Clinics :: Prescription Writer");
...
<script type="text/javascript" src="<?=$root_path?>js/jquery/jqmodal/jqModal.js"></script>
<script type="text/javascript" src="<?=$root_path?>js/jquery/jqmodal/jqDnR.js"></script>
...
$smarty->assign('sPatientComplaint', '<textarea class="segInput" id="pcomplaint" name="pcomplaint"cols="40" rows="2" style="font:bold 12px Arial;">'.stripslashes($_POST['pcomplaint']).'</textarea>');
...
$smarty->assign('sClearEnc','<input class="segButton" id="clear-enc" type="button" value="Clear" onclick="if (confirm(\'Search for another patient?\')) clearEnc();" disabled="disabled"/>');
