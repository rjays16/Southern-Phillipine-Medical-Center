...
$smarty->assign('sDrugName', '<input type="text" class="jedInput" id="drug_name" name="durg_name" size="35" value="'.$_GET['drugname'].'" readonly=""/>');
$smarty->assign('sDosage', '<input type="text" class="jedInput" id="dosage" name="dosage" size="35" align="absmiddle"/>');
...
$smarty->assign('sMainBlockIncludeFile','clinics/add-sig-gui.tpl');
