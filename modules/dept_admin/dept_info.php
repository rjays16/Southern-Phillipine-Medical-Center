...
<tr>
  ...
  <tr>
    ...
    <td class=pblock><?php echo //trim(htmlspecialchars(nl2br($dept['description'])))
	 										trim(nl2br($dept['description'])); ?>
</td>
  </tr>
...
<tr>
    ...
    <td class=pblock><?php 
	 							#echo "van = ".$dept['parent_dept_nr']."-".$dept['is_sub_dept'];
								if($dept['is_sub_dept']){
									#echo $dept['parent_dept_nr'];
...
<!--
	 <td class=pblock align=right bgColor="#eeeeee"></font><?php echo Classification ?>: </td>
    <td class=pblock><?php 								
/*
								if(($dept['admit_inpatient'])&&($dept['admit_outpatient'])) echo "IPD/OPD";
								elseif($dept['admit_inpatient']) echo "IPD";
								elseif($dept['admit_outpatient']) echo "OPD";
*/							?>
</td>
-->
	</tr> 
