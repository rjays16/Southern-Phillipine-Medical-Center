	...
	switch($mode)
	{
		case 'save':
		{
			...
			$HTTP_POST_VARS['name']=trim($HTTP_POST_VARS['name']);
					$HTTP_POST_VARS['name'] = $address_obj->stringTrim($HTTP_POST_VARS['name']);   # burn added: August 25, 2006
					$HTTP_POST_VARS['iso_country_id'] = $address_obj->stringTrim($HTTP_POST_VARS['iso_country_id']);   # burn added: August 25, 2006
					$HTTP_POST_VARS['unece_locode'] = $address_obj->stringTrim($HTTP_POST_VARS['unece_locode']);   # burn added: August 25, 2006
					$HTTP_POST_VARS['unece_modifier'] = $address_obj->stringTrim($HTTP_POST_VARS['unece_modifier']);   # burn added: August 25, 2006
					$HTTP_POST_VARS['unece_locode_type'] = $address_obj->stringTrim($HTTP_POST_VARS['unece_locode_type']);   # burn added: August 25, 2006
					$HTTP_POST_VARS['unece_coordinates'] = $address_obj->stringTrim($HTTP_POST_VARS['unece_coordinates']);   # burn added: August 25, 2006
					$HTTP_POST_VARS['info_url'] = $address_obj->stringTrim($HTTP_POST_VARS['info_url']);   # burn added: August 25, 2006
