...
//Set color value for the search mask
...
//Initilize page control variables
if($mode == 'paginate'){
...
//check user department set encounter_type_search
...
//check if mode is equal to search || paginate
if(($mode == 'search' || $mode == 'paginate') && ($searchkey)){
	...
	//Get the max nr. of rows from global_config
