...
<body  onunload="window.parent.xajax_listRow();">
					...
					<table width="98%" border="0" cellpadding="0" cellspacing="2" style="font:bold 12px Arial; color:#2d2d2d; margin:1%">
						<tr>
							...
							<td valign="middle" width="*">
							  <input id="service_code" name="service_code" class="segInput" type="text" style="width:20%; font: bold 12px Arial" align="absmiddle" value="<?=$_GET['code']?>" />
								&nbsp;
