<?php
/**
 *	@package SegHIS_modules
 * 
 * 	@Module 	 : Social Service Administrator page
 * 	@author 	 : Mark
 * 	@version	 : 1.0
 * 	@date created: May 31, 2007
 *  @Company 	 : Segworks Technology Corporation
 */
...
$fileforward='social_service_admin.php'.URL_REDIRECT_APPEND;
$thisfile=basename(__FILE__);
$breakfile=$root_path.'main/spediens.php'.URL_APPEND;

$lognote="$LDicd10Mngr ok";
...
<P>
<img <?php echo createComIcon($root_path,'persons.gif','0','top') ?>>
<FONT  COLOR=<?php echo $cfg[top_txtcolor] ?>  SIZE=6  FACE="verdana"> <b><?php echo $swSocialServiceMngr; ?></b></font>
