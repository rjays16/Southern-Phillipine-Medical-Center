...
$smarty->assign('sSearchDrug', '<input type="text" class="jedInput" id="search_key" name="search_key" size="35" align="absmiddle"/>');
...
$smarty->assign('sMainBlockIncludeFile','clinics/add-standard-prescription.tpl');
