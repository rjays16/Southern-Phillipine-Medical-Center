...
switch($target)
{
	...
	// case 'setsearchdoctor': $allowedarea=array('_a_1_searchempdependent');
	// 						$fileforward=$root_path."modules/personell_admin/personell_search.php?from=medocs&department=Nursing";
