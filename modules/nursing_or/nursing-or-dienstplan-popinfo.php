...
<tr>
<td><UL><font face=verdana,arial size=2 ><b><?php echo $LDBeeper ?>:</b><font color=red> 
<?php #echo $person['funk1']; 
	  if ($person['cellphone_1_nr'])
	 	 echo $person['cellphone_1_nr'];
	  else
		 echo $person['cellphone_2_nr']; 
?><br>
<font color=navy><b><?php echo $LDPhone ?>:</b> <?php #echo $person['inphone1']; 
																		if ($person['phone_1_nr'])
																			echo $person['phone_1_nr'];
																		else
																			echo $person['phone_2_nr'];	
																?><br></font></ul>
</td>
</tr>
<tr>
