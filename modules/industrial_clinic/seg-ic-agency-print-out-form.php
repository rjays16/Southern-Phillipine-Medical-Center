...
$title = "Health Service and Specialty Clinic :: All Requested Services Print-out";
...
function initialize()
{
	ListGen.create($('agency-list'),{
		id: 'agency',
		url: '<?=$root_path?>modules/industrial_clinic/ajax/ajax_report_list_agency.php',
...
{
	overlib(
	OLiframeContent('<?=$root_path?>modules/industrial_clinic/seg-ic-agency-report_form_details.php?agency_id='+nr,
...
$smarty->assign('sMainBlockIncludeFile','industrial_clinic/agency_report_form.tpl');
