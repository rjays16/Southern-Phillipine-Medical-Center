...
require('./roots.php');
require($root_path."modules/industrial_clinic/ajax/company_search.common.php");
...
$breakfile=$root_path."modules/industrial_clinic/seg-ic-transaction-form.php".URL_APPEND."&userck=$userck";
...
function prepareSelect(c_id,c_name,c_eid,c_pos,c_jobStatus) {
//		alert(c_id+c_name+c_eid+c_pos+c_jobStatus);
	...
	if(c_eid==''){
		window.parent.$('id_no_status').value="new";
		window.parent.CheckIsEmployeeNew();
	}
...
<script type="text/javascript" src="<?=$root_path?>modules/industrial_clinic/js/company-search.js?t=<?=time()?>"></script>
...
<?php
	...
	$company->columnWidths = array("50%","40%","%");
