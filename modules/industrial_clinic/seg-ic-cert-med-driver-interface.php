...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		<td align="center" bgcolor="#F9FFFB">
				...
				<span class="style15"><?=$row['hosp_name']?></span>
		</td>
	</tr>
	...
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td width="25%" bgcolor="#357EC7" class="style9" align="center">Last Name<br>
					<?
					...
					<?//print_r($encInfo);
					?>
					<td width="25%" bgcolor="#357EC7" class="style9" align="center">First Name<br>
					<?
					...
					<td width="25%" bgcolor="#357EC7" class="style9" align="center">Middle Name<br>
					<input type="text" name="middle_name" id="middle_name" size="20" value="<? echo $middle_name ?>" readonly="readonly">
					</td>
					<td width="25%" bgcolor="#357EC7" class="style9" align="center">Position<br>
				...
				<tr>
					<td colspan="6" bgcolor="#41627E">
						<table width="100%" border="0" cellspacing="1" cellpadding="0">
							<tr>
								<td height="200" align="center" bgcolor="#F9FFFB">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td height="36" colspan="3" valign="top" bgcolor="#41627E">
													<table width="100%" border="0" cellpadding="0" cellspacing="1">
														<tr>
															<td colspan="9" bgcolor="#98D228"></td>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td height="36" colspan="3" valign="top" bgcolor="#41627E">
													<table width="100%" border="0" cellpadding="0" cellspacing="1">
														<tr>
															<td width="5%" valign="top" bgcolor="#98AFC7" class="style9" align="center">Height<br/>
																<input type="text" name="height" id="height" value="" align="middle" size="5">
															</td>
															<td width="5%" valign="top" bgcolor="#98AFC7" class="style9" align="center">Weight<br/>
																<input type="text" name="weight" id="weight" value="" align="middle" size="5">
															</td>
															<td width="14%" valign="top" bgcolor="#98AFC7" class="style9" align="center">Blood Pressure<br/>
																<input type="text" name="blood_pressure" id="blood_pressure" value="" align="middle" size="10">
															</td>
															<td width="10%" valign="top" bgcolor="#98AFC7" class="style9" align="center">Pulse Rate<br/>
																<input type="text" name="pulse_rate" id="pulse_rate" value="" align="middle" size="10">
															</td>
															<td width="14%" valign="top" bgcolor="#98AFC7" class="style9" align="center">Respiratory Rate<br/>
																<input type="text" name="respiratory_rate" id="respiratory_rate" value="" align="middle" size="10">
															</td>
															<td width="*" valign="top" bgcolor="#98AFC7" class="style9" align="left">&nbsp;Body Built
																 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														...
														<tr>
												<td height="36" colspan="6" valign="top" bgcolor="#41627E">
													<table width="100%" border="0" cellpadding="0" cellspacing="1">
														<tr>
															<td width="15%" valign="top" bgcolor="#98AFC7" class="style9" align="center">Visual Acuity<br/></td>
															<td width="5%" valign="top" bgcolor="#98AFC7" class="style9" align="center">OD</td>
															<td width="5%" valign="top" bgcolor="#98AFC7" class="style9" align="center">OS</td>
															<td colspan="2" valign="top" bgcolor="#98AFC7" class="style9" align="center">Color Vision/Ishihara</td>
															...
															<td colspan="3">
																<table width="100%" border="0" cellpadding="0" cellspacing="1">
																	...
																	<tr>
																		<td width="20%" valign="top" bgcolor="#98AFC7" class="style9" align="center">&nbsp;</td>
																		<td width="40%" valign="top" bgcolor="#98AFC7" class="style9" align="center">Conversation</td>
																		<td width="40%" valign="top" bgcolor="#98AFC7" class="style9" align="center">Audiometry</td>
																	</tr>
																</table>
															</td>
															<td width="*" valign="top" bgcolor="#98AFC7" class="style9" align="center">Clarity of Speech<br>
															(Radio Officer only)
															</td>
														</tr>
														<tr>
															<td valign="top" bgcolor="#98AFC7" class="style9" align="center">
																W/O Correction <br>
																With Correction
															</td>
															<td valign="top" bgcolor="#98AFC7" class="style9" align="center">
															...
															<td width="15%" valign="top" bgcolor="#98AFC7" class="style9" align="center">
																Adequate<br>
																Defective
															</td>
															<td width="5%" valign="top" bgcolor="#98AFC7" class="style9" align="center">
														...
														<tr>
															<td colspan="9" bgcolor="#98D228"></td>
																<table width="100%" border="0" cellspacing="1" cellpadding="1">
																<tr>
																	<td valign="middle" bgcolor="#98AFC7" class="style9">&nbsp;</td>
																	<td colspan="2" align="center" valign="top" bgcolor="#98AFC7" class="style9">Normal</td>
																	<td valign="middle" bgcolor="#98AFC7" class="style9" align="center">Remarks</td>
																	<td valign="middle" bgcolor="#98AFC7" class="style9">&nbsp;</td>
																	<td colspan="2" align="center" valign="top" bgcolor="#98AFC7" class="style9">Normal</td>
																	<td valign="middle" bgcolor="#98AFC7" class="style9" align="center">Remarks</td>
																</tr>
																<tr>
																	...
																	<td width="5%" align="center" valign="top" bgcolor="#98AFC7" class="style9">Yes</td>
																	<td width="5%" align="center" valign="top" bgcolor="#98AFC7" class="style9">No</td>
																	<td width="17%" align="center" valign="top" bgcolor="#98AFC7" class="style9">&nbsp;</td>
																	<td width="23%" valign="top" bgcolor="#98AFC7" class="style9">&nbsp;</td>
																	<td width="5%" align="center" valign="top" bgcolor="#98AFC7" class="style9">Yes</td>
																	<td width="5%" align="center" valign="top" bgcolor="#98AFC7" class="style9">No</td>
																	<td width="17%" align="center" valign="top" bgcolor="#98AFC7" class="style9">&nbsp;</td>
																			...
																			$string = '<tr>
																									...
																									if($cnt == 9){
																										$string .=' <td colspan="4" align="center" bgcolor="#F9FFFB" class="style2" >
																																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
																																		<tr>
																																			<td width="15%" align="right" bgcolor="#F9FFFB" class="style2">Upper:</td>
																																			<td width="10%">&nbsp;</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">8<br>
																																				<input type="radio" name="upper_left" id="upper_left" value="8">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">7<br>
																																				<input type="radio" name="upper_left" id="upper_left" value="7">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">6<br>
																																				<input type="radio" name="upper_left" id="upper_left" value="6">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">5<br>
																																				<input type="radio" name="upper_left" id="upper_left" value="5">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">4<br>
																																				<input type="radio" name="upper_left" id="upper_left" value="4">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">3<br>
																																				<input type="radio" name="upper_left" id="upper_left" value="3">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">2<br>
																																				<input type="radio" name="upper_left" id="upper_left" value="2">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">1<br>
																																				<input type="radio" name="upper_left" id="upper_left" value="1">
																																			</td>

																																			<td width="*">&nbsp;</td>

																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">1<br>
																																				<input type="radio" name="upper_right" id="upper_right" value="1">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">2<br>
																																				<input type="radio" name="upper_right" id="upper_right" value="2">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">3<br>
																																				<input type="radio" name="upper_right" id="upper_right" value="3">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">4<br>
																																				<input type="radio" name="upper_right" id="upper_right" value="4">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">5<br>
																																				<input type="radio" name="upper_right" id="upper_right" value="5">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">6<br>
																																				<input type="radio" name="upper_right" id="upper_right" value="6">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">7<br>
																																				<input type="radio" name="upper_right" id="upper_right" value="7">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">8<br>
																																				<input type="radio" name="upper_right" id="upper_right" value="8">
																																			</td>
																										...
																										$string .=' <td colspan="4" align="center" bgcolor="#F9FFFB" class="style2" >
																																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
																																		<tr>
																																			<td width="15%" align="right" bgcolor="#F9FFFB" class="style2">Lower:</td>
																																			<td width="10%">&nbsp;</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">8<br>
																																				<input type="radio" name="lower_left" id="lower_left" value="8">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">7<br>
																																				<input type="radio" name="lower_left" id="lower_left" value="7">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">6<br>
																																				<input type="radio" name="lower_left" id="lower_left" value="6">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">5<br>
																																				<input type="radio" name="lower_left" id="lower_left" value="5">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">4<br>
																																				<input type="radio" name="lower_left" id="lower_left" value="4">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">3<br>
																																				<input type="radio" name="lower_left" id="lower_left" value="3">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">2<br>
																																				<input type="radio" name="lower_left" id="lower_left" value="2">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">1<br>
																																				<input type="radio" name="lower_left" id="lower_left" value="1">
																																			</td>

																																			<td width="*">&nbsp;</td>

																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">1<br>
																																				<input type="radio" name="lower_right" id="lower_right" value="1">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">2<br>
																																				<input type="radio" name="lower_right" id="lower_right" value="2">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">3<br>
																																				<input type="radio" name="lower_right" id="lower_right" value="3">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">4<br>
																																				<input type="radio" name="lower_right" id="lower_right" value="4">
																																			</td>
																																			<td width="1%" align="center" bgcolor="#F9FFFB" class="style2">5<br>
																																				<input type="radio" name="upper_right" id="upper_right" value="5">
																																			</td>
														...
														<tr>
															<td colspan="9" bgcolor="#98D228"></td>
																...
																<!--<tr>
																	...
																	<td colspan="9" bgcolor="#98AFC7"></td>
																<table width="100%" border="0" cellspacing="1" cellpadding="1">
																<tr>
																	<td valign="middle" bgcolor="#98AFC7" class="style9">&nbsp;</td>
																	<td colspan="2" align="center" valign="top" bgcolor="#98AFC7" class="style9">Normal</td>
														...
														<tr>
															<td colspan="6" bgcolor="#41627E">
																<table width="100%" border="0" cellspacing="0" cellpadding="1">
																	<tr>
																		<td width="20%" align="center" bgcolor="#41627E" class="style9" >
																		...
																		<td width="60%" align="center" bgcolor="#41627E" class="style9" >
																			<input type="radio" name="recommendation" id="recommendation" value="2">
																			&nbsp;&nbsp;Pending due to &nbsp;&nbsp;&nbsp;&nbsp;
																			<input type="text" name="reason" id="reason" size="25">
																		</td>
																	</tr>
