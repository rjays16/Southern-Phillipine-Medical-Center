...
<table cellspacing="0 "cellpadding="0" border="0" class="frame">
  <tbody>
      ...
      <td style="color:white; background-color: red; font-weight:bold;">
			&nbsp;List of Interpretations/Findings
		</td>
    </tr>
    <tr>
      <td bgcolor="#ffffff">
	    	<table id="serviceTable" border="0" cellpadding="1" cellspacing="1" width="600" style="border:1px solid #666666;border-bottom:0px">
					<thead>
						<tr class="reg_list_titlebar" style="font-weight:bold;padding:0px">
							<td valign="middle" align="center" width="10%" rowspan="2">No.</td>
							<td valign="middle" align="center" width="45%" rowspan="2">Findings</td>
							<td valign="middle" align="center" width="15%" rowspan="2">Date</td>
							<td valign="middle" align="center" width="10%" rowspan="2">Reporting Doctor</td>
