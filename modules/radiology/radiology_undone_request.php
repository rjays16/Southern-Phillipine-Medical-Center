...
# $smarty->assign('sToolbarTitle', $LDTestRequest." - ".$LDSearchPatient);
 $smarty->assign('sToolbarTitle',($_GET['ob']=='OB' ? "OB-GYN Ultrasound :: Undone Request List" : "Radiology :: Service Request List"));
...
# $smarty->assign('sWindowTitle',$LDTestRequest." - ".$LDSearchPatient);
 $smarty->assign('sWindowTitle',($_GET['ob']=='OB' ? "OB-GYN Ultrasound :: Undone Request List" : "Radiology :: Service Request List"));
