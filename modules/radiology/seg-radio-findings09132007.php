...
?>
	<input type="image" name="referralButton" id="referralButton" <?= $show_referralButton ?> <?php echo createLDImgSrc($root_path,'referral.gif','0') ?>  alt="Referral" onClick="$('save').value=1; referralHandler();">
<?php
		}# end of if-stmt 'if ($radioRequestInfo['status']!='done')'
?>
								</div>
