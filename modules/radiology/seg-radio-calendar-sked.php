...
# Title in toolbar
 $smarty->assign('sToolbarTitle',"Radioloy :: Scheduling ".$LDCalendar);
 ...
 # Window bar title
 $smarty->assign('sWindowTitle',"Radioloy :: Scheduling ".$LDCalendar);
...
//	urlholder=rpath+"modules/radiology/seg-radio-daily-sked.php?sid=<?php echo "$sid&lang=$lang" ?>&day="+d+"&month="+m+"&year="+y;
	urlholder="seg-radio-schedule-daily.php?sid=<?php echo "$sid&lang=$lang" ?>&day="+d+"&month="+m+"&year="+y+"&dept_nr=<?=$dept_nr?>";
	alert("urlholder : \n'"+urlholder+"'");	
