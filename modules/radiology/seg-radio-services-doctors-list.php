 ...
 */
 ...
 $smarty->assign('sToolbarTitle',($_GET['ob']=='OB' ? "OB-GYN :: Co-reader Physician Manager" : "Radiology :: Co-reader Physician Manager"));
...
// $smarty->assign('pbBack',$returnfile);
 ...
 # Window bar title
 $smarty->assign('sWindowTitle',($_GET['ob']=='OB' ? "OB-GYN :: Co-reader Physician Manager" : "Radiology :: Co-reader Physician Manager"));
	...
	if (list) {
	   dBody=list.getElementsByTagName("tbody")[0];
		...
		if (id) {
			...
			if(ob=='OB'){
				rowSrc = '<tr><td colspan="7">No OB-GYN co-reader physician available at this time...</td></tr>';
			}else{
...
function deleteRadioDoctors(id){
	//alert(id);
		...
		var statement  = "";
		if(ob){
			statement = "Are you sure you want to delete the OB-GYN co-reader physician?";
		}else{
			statement = "Are you sure you want to delete the radiology co-reader physician?";
		}
