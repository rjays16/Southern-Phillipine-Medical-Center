...
# Buffer page output
/*
$OR_rooms_temp = $OR_rooms;
$ORoom = $OR_rooms_temp->FetchRow();
echo "or_list_config.php : ORoom ='$ORoom' <br> \n";
echo "or_list_config.php : ORoom : <br> \n "; print_r($ORoom); echo"<br> \n";
*/
ob_start();
 ...
 -->    <td><?php  echo formatDate2Local($ORoom['date_create'],$date_format) ?> </td>
	...
	<?php 
		...
		if(!empty($buf)&&isset($$buf)&&!empty($$buf)) 
			echo $$buf;
#			else echo $ORoom['deptshort'];   # burn commented : November 10, 2007
		else 
			echo $ORoom['deptname'];
	?> </td>
 </tr> 
