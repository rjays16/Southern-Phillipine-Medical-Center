...
function dhtmlXGridCellObject(obj){
 ...
 this.getMathValue = function()
 {
	 ...
	 this.getFont = function()
	 {
		 arOut = new Array(3);
		 if
		 (this.cell.style.fontFamily)arOut[0] = this.cell.style.fontFamily
 ...
 this.setTextColor = function(val)
 {
	 ...
	 {
		 if(val=="")val = null;this.cell.bgColor = val;
		 };
		 this.setHorAlign = function(val)
		 {
			 if(val.length==1){if(val=='c')this.cell.style.textAlign = 'center'
	 ...
	 if(this.isCheckbox()){
		 ...
		 this.isDisabled = function()
		 {
			 ...
			 this.setChecked = function(fl)
			 {
				 if(this.isCheckbox())
				 {
					 if(fl!='true' && fl!=1)fl = false;this.cell.firstChild.checked = fl;
					 };
					 };
					 this.setDisabled = function(fl)
					 {
						 ...
						 if(this.isCheckbox())
						 {
							 ...
							 {
								 if((typeof(val)!="number") && (!val || val.toString()._dhx_trim()=="")){val="&nbsp;"
