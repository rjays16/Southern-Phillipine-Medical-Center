...
//	details.desc        = $('desc_'+code).value;
//	details.ptype		= $('ptype_'+code).value;
//	details.mtype		= $('type_'+code).value;
    ...
    window.parent.addMiscChrg(bill_dt, enc, details.code, details.acct_type, details.msc_charge, details.qty);
}

function addMiscItemToList(listID, code, scode, name, description, actype, price, ptype, mtype, sclass) {
