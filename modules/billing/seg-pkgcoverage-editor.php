...
require($root_path."modules/billing/ajax/pkg-coverage.common.php");
...
$thisfile='seg-pkgcoverage-editor.php';
...
$smarty->assign('sPackageID',$_GET['pkg']);
//added by jasper 09/09/2013 -FIX FOR BUG#305 NEWBORN 
$smarty->assign('sWellBaby',($_GET['pkg']==NEWBORN_A || $_GET['pkg']==NEWBORN_B ? 1:0));
//added by jasper 09/09/2013 -FIX FOR BUG#305 NEWBORN 
...
$smarty->assign('sFreeDistribution','<input style="vertical-align:middle;" type="checkbox" name="is_freedist" id="is_freedist" onclick="this.value = (this.checked) ? 1 : 0;" />');
/*
...
$smarty->assign('sMainBlockIncludeFile','billing/seg-pkgcoverage.tpl');
