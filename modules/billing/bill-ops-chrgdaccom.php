...
require($root_path.'modules/billing/ajax/billing-select-ops.common.php');
...
<script type="text/javascript" src="<?=$root_path?>modules/billing/js/billing-select-ops.js?t=<?=time()?>"></script>
<?php
