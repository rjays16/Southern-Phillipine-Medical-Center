...
<script type="text/javascript" src="<?=$root_path?>modules/billing/js/billing-common.js"></script>
<script type="text/javascript" src="<?=$root_path?>modules/billing/js/billing-misc-chrgs-tray.js?t=<?=time()?>"></script>
<?php
						...
						<table id="miscellaneous-list" class="segList" cellpadding="1" cellspacing="1" width="100%">
							<thead>
								...
								<tr>																									
									...
									<th align="center" width="14%" nowrap="nowrap">Account</th>
									<th align="center" width="14%" nowrap="nowrap">Subtype</th>
									<th align="center" width="12%" nowrap="nowrap">Charge</th>
									<th align="center" width="10%">&nbsp;</th>									
								</tr>
							</thead>
							<tbody>
								<tr>
									<td colspan="6" style="font-weight:normal">No such miscellaneous charge exists...</td>
								</tr>
							</tbody>
						</table>
