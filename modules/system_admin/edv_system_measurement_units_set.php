...
$thisfile='edv_system_measurement_units_set.php';
$editfile='edv_system_measurement_units_add.php'.URL_REDIRECT_APPEND.'&mode=edit&from=set&item_no=';
...
$bottomlink='edv_system_measurement_units_add.php'.URL_APPEND.'&from=set';
$bottomlink_txt=$LDClk2AddCurrency;

require($root_path.'include/inc_measurement_units_set_gui.php');
