...
$refCode=$person_obj->getLimitOccupationInfo($GLOBAL_CONFIG['pagin_icpm_list_max_block_rows'], $pgx, $oitem,$odir);
...
if(isset($totalcount)&&$totalcount){
	...
	$totalcount=$person_obj->countAllOccupation();
	$pagen->setTotalDataCount($totalcount);
}
...
# Title in toolbar
 $smarty->assign('sToolbarTitle',"Occupation :: $LDListAll");
 ...
 # Window bar title
 $smarty->assign('sWindowTitle',"Occupation :: $LDListAll");
...
<table border=0 cellpadding=2 cellspacing=1 id="occupation_list" width="50%">
...
?>
  ...
  <tr  bgcolor="<?php echo $bgc ?>" id="row<?=$refcode['occupation_nr'];?>" >
	  ...
	  <td><a href="occupation_info.php<?php echo URL_APPEND.'&retpath=list&occupation_nr='.$refcode['occupation_nr']; ?>"><?php echo $refcode['occupation_name']; ?></a></td>
  </tr> 
<?php $listID++;
	}
	echo '
