...
if(isset($nr)&&$nr&&($row=$person_obj->getOccupationInfo($nr))){
...
# Title in toolbar
 $smarty->assign('sToolbarTitle',"Occupation :: $segData");
 ...
 # Window bar title
 $smarty->assign('sWindowTitle',"Occupation :: $segData");
...
<?php 
	...
	echo "Occupation has been succesfully saved.";
?>
</b></font>
<?php 
} 
...
<table border=0 cellpadding=4 width="40%" >
  <tr class="wardlisttitlerow">
  	<td width="10%"><b>Occupation</b></td>
  </tr>
  <tr>
    <td class="adm_input"><?php echo $refcode['occupation_name'] ?><br></td>
  </tr> 
  <tr>
    <td  align=center><a href="occupation_update.php<?php echo URL_APPEND.'&retpath='.$retpath.'&occupation_nr='.$refcode['occupation_nr']; ?>"><img <?php echo createLDImgSrc($root_path,'update.gif','0') ?> border="0"></a>&nbsp;&nbsp;<a href="occupation_list.php<?php echo URL_APPEND; ?>"><img <?php echo createLDImgSrc($root_path,'list_all.gif','0') ?> border="0"></a><a href="<?php echo $breakfile; ?>"><img <?php echo createLDImgSrc($root_path,'cancel.gif','0') ?> border="0"></a></td>
  </tr>
</table>
<p>
