...
if(isset($nr)&&$nr&&($row=$person_obj->getReligionInfo($nr))){
...
# Title in toolbar
 $smarty->assign('sToolbarTitle',"Religion :: $segData");
 ...
 # Window bar title
 $smarty->assign('sWindowTitle',"Religion :: $segData");
...
<?php 
	...
	echo "Religion has been succesfully saved.";
?>
</b></font>
<?php 
} 
...
<table border=0 cellpadding=4 width="40%" >
  <tr class="wardlisttitlerow">
  	<td width="10%"><b>Religion</b></td>
  </tr>
  <tr>
    <td class="adm_input"><?php echo $refcode['religion_name'] ?><br></td>
  </tr> 
  <tr>
    <td  align=center><a href="religion_update.php<?php echo URL_APPEND.'&retpath='.$retpath.'&religion_nr='.$refcode['religion_nr']; ?>"><img <?php echo createLDImgSrc($root_path,'update.gif','0') ?> border="0"></a>&nbsp;&nbsp;<a href="religion_list.php<?php echo URL_APPEND; ?>"><img <?php echo createLDImgSrc($root_path,'list_all.gif','0') ?> border="0"></a><a href="<?php echo $breakfile; ?>"><img <?php echo createLDImgSrc($root_path,'cancel.gif','0') ?> border="0"></a></td>
  </tr>
</table>
<p>
