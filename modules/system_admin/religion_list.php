...
$refCode=$person_obj->getLimitReligionInfo($GLOBAL_CONFIG['pagin_icpm_list_max_block_rows'], $pgx, $oitem,$odir);
...
if(isset($totalcount)&&$totalcount){
	...
	$totalcount=$person_obj->countAllReligion();
	$pagen->setTotalDataCount($totalcount);
}
...
# Title in toolbar
 $smarty->assign('sToolbarTitle',"Religion :: $LDListAll");
 ...
 # Window bar title
 $smarty->assign('sWindowTitle',"Religion :: $LDListAll");
...
<table border=0 cellpadding=2 cellspacing=1 id="religion_list" width="50%">
...
?>
  ...
  <tr  bgcolor="<?php echo $bgc ?>" id="row<?=$refcode['religion_nr'];?>" >
	  ...
	  <td><a href="religion_info.php<?php echo URL_APPEND.'&retpath=list&religion_nr='.$refcode['religion_nr']; ?>"><?php echo $refcode['religion_name']; ?></a></td>
  </tr> 
<?php $listID++;
	}
	echo '
