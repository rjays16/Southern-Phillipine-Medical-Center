...
<?php session_start(); ?>
<?php 
	$active_note = display_all_active_meeting(); 
			...
			<div class="form-group custom-input-space has-feedback">
				...
				<div class="page-body clearfix">
					...
					<div class="panel panel-default">
						<div class="panel-heading"> List of Active Meeting(s)</div>
						<div class="panel-body">
							...
							<div class="table-responsive">
								...
								<table class="table table-striped table-hover js-basic-example dataTable">
									...
									$rows=$db->GetOne("SELECT count(note_id) FROM `seg_notice_tbl` WHERE status = 1 AND is_deleted = 1 AND category = 'Meeting' ");
										...
										$nquery=$db->Execute("SELECT * FROM `seg_notice_tbl` WHERE status = 1 AND is_deleted = 1 AND category = 'Meeting' ORDER BY note_date DESC $limit");
