 ...
 */
 ...
 #$smarty->assign('sToolbarTitle',$title);
  $smarty->assign('sToolbarTitle',"Nursing :: News");

  $smarty->assign('sWindowTitle',"Nursing :: News");
...
for($j=1;$j<=$news_num_stop;$j++){
	...
	ob_start();
		...
		include($root_path.'include/inc_news_preview2.php');
...
#$root_path.'"gui/img/common/default/arrow_blueW.gif
$smarty->assign('sMainEditorLink','<img ' . createComIcon($root_path,'arrow_blueW.gif','0','absmiddle') . '">&nbsp;<a href="'.$editorpath.'"><b>'.$LDClk2Compose.'</b></a>');
