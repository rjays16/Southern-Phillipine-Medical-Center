...
require($root_path."modules/insurance_co/ajax/coverage.common.php");
...
$thisfile='seg_coverage_editor.php';
...
?>
	...
	<input type="hidden" name="mode" id="mode" value="<?php echo $mode ? "M" : "" ?>">
...
$smarty->assign('sMainBlockIncludeFile','insurance_co/coverage.tpl');
