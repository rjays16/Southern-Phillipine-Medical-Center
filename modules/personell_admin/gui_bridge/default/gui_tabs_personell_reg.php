...
<!-- Tabs  -->
<tr>
<!-- Edited by: syboy 12/18/2015 : meow -->
<?php if ($_GET['from'] == 'medocs' && $_GET['department'] != ''): ?>
	<td colspan=3><?php if($target=="personell_reg") $img='add_employee_blue.gif'; //echo '<img '.createLDImgSrc($root_path,'such-b.gif','0').' alt="'.$LDSearch.'">';
							...
							echo '<img class="disabled" '.createLDImgSrc($root_path,$img,'0').' alt="'.$LDEnterNewEmployment.'" ';if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)'; echo '>';
							...
							echo '<img '.createLDImgSrc($root_path,$img,'0').' alt="'.$LDFindPersonell.'" ';if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)'; echo '>';
							...
							echo '<img class="disabled" '.createLDImgSrc($root_path,$img,'0').' alt="'.$LDFindPersonell.'" ';if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)'; echo '>';
							echo '<img class="disabled" src="'.$root_path.'gui/img/common/default/pixel.gif" width=20>';
							...
							echo'<img class="disabled" '.createLDImgSrc($root_path,$img,'0').' alt="'.$LDRegNewPerson.'"'; if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)'; echo '>';
							?></td>
<?php else: ?>
	<td colspan=3><?php if($target=="personell_reg") $img='add_employee_blue.gif'; //echo '<img '.createLDImgSrc($root_path,'such-b.gif','0').' alt="'.$LDSearch.'">';
								else{ $img='add_employee_gray.gif'; }
