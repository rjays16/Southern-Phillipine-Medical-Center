...
$aSubMenuItem=array('LDSegPharmaNewOrder' => '<a href="'.$root_path.'modules/supply_office/seg-check-user.php'. URL_APPEND."&userck=$userck".'&target=requestnew">New Request</a>',
                                        'LDSegPharmaOrderManage' => '<a href="'.$root_path.'modules/supply_office/seg-check-user.php'. URL_APPEND."&userck=$userck".'&target=managereq">Manage requests</a>',
                                        'LDSegPharmaOrderServe' => '<a href="'.$root_path.'#'. URL_APPEND."&userck=$userck".'&target=servelist">no_name</a>' );
