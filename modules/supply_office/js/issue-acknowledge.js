        ...
        if (dBody) {
            ...
            if (details) {
                ...
                src+=
                    ...
                    '<td align="center">'+
                        '<input type="radio" id="check'+itemcode+'" name="acknowledge[]" value="approve" style="color:#000066; font-weight:bold; padding:0px 2px" '+
                            //'onclick="prepareAddPc(\''+id+'\')" '+
                            //'onclick="openIssueDetails(\''+itemcode+'\')" '+
                            //'onclick="checkingBox(\''+itemcode+'\',\'approve\')" '+
                        '/>'+
                    '</td>'+
                    /*
                    '<td align="center">'+
                        '<input type="checkbox" id="check'+itemcode+'" name="cancel[]" value="cancel" style="color:#000066; font-weight:bold; padding:0px 2px" '+
                            //'onclick="prepareAddPc(\''+id+'\')" '+
                            //'onclick="openIssueDetails(\''+itemcode+'\')" '+
                            //'onclick="checkingBox(\''+itemcode+'\',\'cancel\')" '+
                        '/>'+
                    '</td>'+
                    */ 
                    '<td align="center">'+
                        '<input type="radio" id="cancel'+itemcode+'" name="acknowledge[]" value="cancel" style="color:#000066; font-weight:bold; padding:0px 2px" '+
                            //'onclick="prepareAddPc(\''+id+'\')" '+
                            //'onclick="openIssueDetails(\''+itemcode+'\')" '+
                            //'onclick="checkingBox(\''+itemcode+'\',\'approve\')" '+
                        '/>'+
