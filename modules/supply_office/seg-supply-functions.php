...
// $smarty->assign('pbBack',$returnfile);
 ...
 $aSubMenuItem=array('LDSegSupplyRequest' => '<a href="'.$root_path.'modules/supply_office/seg-check-user.php'. URL_APPEND."&userck=$userck".'&target=requestnew">Requisition</a>',
                     ...
                     //'LDDocSearch'  => '<a href="'.$root_path.'modules/supply_office/seg-check-user.php'. URL_APPEND."&userck=$userck".'&target=in_searchdoctor">Search employee</a>', # added by: syboy 12/18/2015 : meow
