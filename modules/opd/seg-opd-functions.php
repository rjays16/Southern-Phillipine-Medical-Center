...
<script type="text/javascript">
	...
	function ShortcutKeys(){
		...
		// gen reports added by: syboy 05/29/2015
    ...
    function SearchDoc(){
        // urlholder="<?=$root_path?>";
        urlholder="<?=$root_path?>modules/opd/seg-opd-pass.php?sid=<?=$sid?>&lang=<?=$lang?>&userck=<?=$userck?>&target=opdsearchdoctor&from=opd";
        window.location.href=urlholder;
    }
	...
	function ReportGenFxn(){
		urlholder="<?=$root_path?>modules/opd/seg-opd-pass.php?sid=<?=$sid?>&lang=<?=$lang?>&userck=<?=$userck?>&target=reportgen&from=opd";
		window.location.href=urlholder;
	}

	//Added by Borj 2014-08-04 ISO
	//OpdUserManual
	function OpdUserManualFxn(){
		urlholder="<?=$root_path?>forms/OPD.pdf?sid=<?=$sid?>&lang=<?=$lang?>&userck=<?=$userck?>&target=reports&from=opd";
		window.location.href=urlholder;
	}
	...
	function OnlineConsultationFxn(){
		urlholder="<?=$root_path?>modules/opd/seg-opd-pass.php?sid=<?=$sid?>&lang=<?=$lang?>&userck=<?=$userck?>&target=onlineconsultation&from=opd";
		window.location.href=urlholder;
	}
...
$aSubMenuText=array(
  ...
  "Triage online consultation requests", 
...
$aSubMenuItem=array(
  ...
  'LDOnlineConsultation' => '<a href="javascript:OnlineConsultationFxn();">Online Consultation Request</a>',
  ...
  'LDIcdMedCert' => '<a href="javascript:MedCertFxn();">Medical Certificates</a>',
	...
	// added by : syboy 05-29-2015
	'LDGenerateReport' => '<a href="javascript:ReportGenFxn();">OPD Report Launcher</a>',
	//Added by Borj 2014-08-04 ISO
	'LDOpdUserManual' => '<a href="javascript:OpdUserManualFxn();">User Manual</a>',
);
