...
';*/
 ...
 echo $LDShotDate.'
<input type="text" name="sdate'.$i.'" id="date'.$i.'" size=12 maxlength=12 onFocus="this.select();previewpic(document.srcform.picfile'.$i.'.value)"  onBlur="IsValidDate(this,\''.$date_format.'\')"   onKeyUp="setDate(this,\''.$date_format.'\',\''. $lang.'\')">';
...
<!--	<a href="javascript:show_calendar('srcform.sdate<?php echo $i ?>','<?php echo $date_format ?>')">  -->
	<img <?php echo createComIcon($root_path,'show-calendar.gif','0','absmiddle'); ?> id="date<?php echo $i ?>_trigger" style="cursor:pointer">

	<!--EDITED: SEGWORKS -->
	<script type="text/javascript">
	Calendar.setup ({
		inputField : "date<?php echo $i?>", ifFormat : "<?php echo $phpfd?>", showsTime : false, button : "date<?php echo $i ?>_trigger", singleClick : true, step : 1
