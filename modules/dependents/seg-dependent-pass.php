...
switch($target)
{
  case 'dependents':
		...
		$allowedarea=array('_a_1_dependents_manager','_a_1_searchempdependent');
	    $fileforward=$root_path."modules/dependents/seg-dependents.php".URL_APPEND."&ptype=er&from=".$src."&pid=".$pid."&department=".$_GET['department'];
		break;
