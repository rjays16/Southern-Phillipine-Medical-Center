...
<table cellspacing="0"  class="titlebar" border=0>
	<tr valign=top  class="titlebar" >
  		<td bgcolor="#e4e9f4" valign="bottom">
		    &nbsp;&nbsp;<font size="3" color="#330066"><?php echo $LDPhoneDir ?></font>
		</td>
		<td bgcolor="#e4e9f4" align=right>
		   <!--------Back button removal, conferred with AJMQ; 2007-10-02 FDP
			...
			---------last edited help file 2007-10-06 FDP--->
			<a href="javascript:gethelp('phone_viewDir.php')">
				<img <?php echo createLDImgSrc($root_path,'hilfe-r.gif','0') ?>>
			</a>
			<!---------last edited close button link 2007-10-06 FDP--->
