...
<table cellspacing="0"  class="titlebar" border=0>
	<tr valign=top  class="titlebar" >
  		<td bgcolor="#e4e9f4" valign="bottom">
		    &nbsp;&nbsp;<font size="3" color="#330066"><?php echo "$LDPhoneDir :: $LDSearch" ?></font>
		</td>
		<td bgcolor="#e4e9f4" align=right>
		   <!--------Back button removal, conferred with AJMQ; 2007-10-02 FDP
			...
			---------edited help file 2007-10-05 FDP--->
			<a href="javascript:gethelp('phone_how2useDir.php')">
	<!---	<a href="javascript:gethelp('phone_how2start.php','search','search')">	--->
	...
	<!---		<a href="../../main/startframe.php?sid=ae36a5d334972322d25f7477d1948090&lang=en" > -->
			<a href="<?php echo $breakfile=$root_path.'main/startframe.php'.URL_APPEND; ?>">
...
<INPUT type="image" <?php echo createLDImgSrc($root_path,'searchlamp','0') ?>>
