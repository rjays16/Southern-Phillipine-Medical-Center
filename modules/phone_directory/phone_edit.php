...
<!---commented out, 2007-10-02 FDP
	<FONT  COLOR="<?php echo $cfg[top_txtcolor] ?>" SIZE=6 > <b><?php echo "$LDPhoneDir $LDNewData" ?></b></font>
 --->
<!---added 2007-10-02 FDP---->
 <table cellspacing="0"  class="titlebar" border=0>
	<tr valign=top  class="titlebar" >
  		<td bgcolor="#e4e9f4" valign="bottom">
		    &nbsp;&nbsp;<font size="3" color="#330066"><?php echo "$LDPhoneDir :: $LDNewData" ?></font>
		</td>
		<td bgcolor="#e4e9f4" align=right>
		   <!--------Back button removal, conferred with AJMQ; 2007-10-02 FDP
			<a href="javascript:window.history.back()">
				<img <?php echo createLDImgSrc($root_path,'back2.gif','0') ?>> 
			</a>
			---------help file and reference last edited 2007-10-09 FDP--->
			<a href="javascript:gethelp('phone_newData.php')">
				<img <?php echo createLDImgSrc($root_path,'hilfe-r.gif','0') ?>>
			</a>
			<a href="../../main/startframe.php?sid=ae36a5d334972322d25f7477d1948090&lang=en" >
...
-------with this----------edited 2007-10-04 FDP--->
<a href="phone.php<?php echo URL_APPEND; ?>"><img <?php echo createLDImgSrc($root_path,'such-gray.gif','0') ?> <?php if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a>
<a href="phone_list.php<?php echo URL_APPEND; ?>"><img <?php echo createLDImgSrc($root_path,'phonedir-gray.gif','0') ?> <?php if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a>
<a href="phone_edit_pass.php<?php echo URL_APPEND; ?>"><img <?php echo createLDImgSrc($root_path,'newdata-b.gif','0') ?> <?php if($cfg['dhtml'])echo'style=filter:alpha(opacity=70) onMouseover=hilite(this,1) onMouseOut=hilite(this,0)>';?></a></td>
<!----until here only---FDP--------->
