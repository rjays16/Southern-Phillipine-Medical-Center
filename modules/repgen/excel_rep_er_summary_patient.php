<?php
	...
	class ExcelGen_ER_Summary extends Spreadsheet_Excel_Writer
	{
			var $worksheet;
			var $Headers;
			...
			function ExcelGen_ER_Summary($from, $to, $sclass)
			{
	...
	$rep = new ExcelGen_ER_Summary($_GET['from'], $_GET['to'], $_GET['sclass']);
	$rep->ExcelHeader();
	$rep->FetchData();
	$rep->AfterData();
	$rep->send('rep_er_summary_patient.xls');
	$rep->close();
?>