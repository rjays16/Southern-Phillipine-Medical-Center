...
<!-- 		<td valign="top"><?php echo $LDDate ?>:<br>
 ...
 -->		
        <td valign="top"><?php echo $LDDate ?>:<br>
		<input type=text size=10 maxlength=10  name="dateput" id="date_text" value="<?php echo formatDate2Local(date('Y-m-d'),$date_format); ?>" onBlur="IsValidDate(this,'<?php echo $date_format ?>')" onKeyUp="setDate(this,'<?php echo $date_format ?>','<?php echo $lang ?>')" onFocus=this.select() value="<?php if(!$saved) echo $dateput; ?>"><br>
<!--<a href="javascript:show_calendar('berichtform.dateput','<?php echo $date_format ?>')">-->
 <img <?php echo createComIcon($root_path,'show-calendar.gif','0','absmiddle',TRUE); ?> id="date_trigger" style="cursor:pointer"><font size=1 face="arial">[<?php
...
<!-- 		<td valign="top"><?php echo $LDDate ?>:<br><input type=text size="8" name="dateput2" value="<?php if(!$saved) echo $dateput2; ?>" onKeyUp="setDate(this)" onFocus="this.select()"><br>
 ...
 -->		
		<td valign="top"><?php echo $LDDate ?>:<br>
		<input type=text size=10 maxlength=10  name="dateput2" id="date_text2" value="<?php echo formatDate2Local(date('Y-m-d'),$date_format); ?>" onBlur="IsValidDate(this,'<?php echo $date_format ?>')"  onFocus="this.select()" onKeyUp="setDate(this,'<?php echo $date_format ?>','<?php echo $lang ?>')"><br>
	<!--	<a href="javascript:show_calendar('berichtform.dateput2','<?php echo $date_format ?>')"> -->
 		<img <?php echo createComIcon($root_path,'show-calendar.gif','0','absmiddle',TRUE); ?> id="date_trigger2" style="cursor:pointer" ><font size=1 face="arial">[<?php
		$dfbuffer="LD_".strtr($date_format,".-/","phs");
		echo $$dfbuffer;
		?>]</font>
