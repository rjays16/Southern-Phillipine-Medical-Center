...
#echo "nursing-station-new-createbeds.php : after instantiation : ward_obj <br> "; print_r($ward_obj); echo "<br><br> \n";
...
if(isset($mode)&&$mode=='save_beds'){
	...
	for($i=$room_nr_start;$i<=$room_nr_end;$i++){
		...
		if(!$ward_obj->RoomExists($i)){
			...
			echo "nursing-station-new-createbeds.php : HTTP_POST_VARS <br> "; print_r($HTTP_POST_VARS); echo "<br> \n";
			exit();
...
echo "nursing-station-new-createbeds.php : ward <br> "; print_r($ward); echo "<br><br> \n";
?>
