...
<script type="text/javascript" src="<?=$root_path?>modules/nursing/js/nursing-station-request-tray.js?t=<?=time()?>"></script>
...
-->
			...
			<tr>
				<td style="font:bold 12px Arial; background-color:#e5e5e5; color: #2d2d2d" >
					<div style="padding:4px 2px; padding-left:10px; ">
						Search Request <input id="search" name="search" class="segInput" type="text" style="width:60%; margin-left:10px; font: bold 12px Arial" align="absmiddle" onkeyup="if (this.value.length >= 2) startAJAXSearch(this.id)" />
