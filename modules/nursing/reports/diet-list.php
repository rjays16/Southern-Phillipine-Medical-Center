  ...
  while ($room = $beds->FetchRow()) {
            ...
            if ($row["bedNo"] !=0 AND  !empty($row["RoomName"])) {
              ...
              $getDietNames = $notes_obj->getDietNames();
               ...
               while($diet_name_list =  $getDietNames->FetchRow()){
                  ...
                  // $row['b']=$row['l']=$row['d']=$row['diet_list'];
              //     echo "<pre>";
              // var_dump($row['diet_list']);
              // echo "</pre>";
              // die;
              ...
              // die;
              // echo "<pre>";
              // var_dump($diet_category_list);
              // echo "</pre>";

              //   echo "<pre>";
              // var_dump($update_diet_name);
              // echo "</pre>";
    ...
    while ($nourish = $nourish_data->FetchRow()) 
    {
     ...
     foreach ($diet_list_order as $list_key => $list_value) {
            $getDietName = $notes_obj->getAltNameDiet($list_key);
...
if($category=='NONE'){
  $report_id = 'Diet_List_noDiag';
}else{
  $report_id = 'Diet_List';
}
showReport($report_id,$params,$data,'PDF'); 
