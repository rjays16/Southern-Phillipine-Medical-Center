...
$fileforward="nursing-station.php".URL_REDIRECT_APPEND."&fwd_nr=$fwd_nr&edit=$edit&retpath=".'*'."&pid=$pid&station=$station&ward_nr=$ward_nr&key=".'*'."&pagekey=".'*'."&pday=$pday&pmonth=$pmonth&pyear=$pyear";
