...
<!-- 		<td valign="top"><?php echo $LDDate ?>:<br>
 ...
 -->		
        <td valign="top"><?php echo $LDDate ?>:<br>
		<input type=text size=10 maxlength=10 name="dateput" id="date_text" value="<?php echo formatDate2Local(date('Y-m-d'),$date_format); ?>" onBlur="IsValidDate(this,'<?php echo $date_format ?>')" onFocus="this.select()" value="<?php if(!$saved) echo $dateput; ?>" onKeyUp="setDate(this,'<?php echo $date_format ?>','<?php echo $lang ?>')"><br>
