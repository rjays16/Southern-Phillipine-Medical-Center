...
$aSubMenuItem = array('LDNursingStations' => "<a href=\"".$root_path."modules/nursing/nursing-wardList.php".URL_APPEND."\">$LDNursingStations</a>",
										...
										'LDStationMan1'  => "<a href=\"nursing-station-manage-pass1.php?sid=$sid&lang=$lang\"> test $LDStationMan</a>",
										'LDNursesList'  => "<a href=\"".$root_path."modules/nursing_or/nursing-or-main-pass.php".URL_APPEND."&target=setpersonal&retpath=menu\">$LDNursesList</a>",
										//'LDNews'  => "<a href=\"".$root_path."modules/news/newscolumns.php".URL_APPEND."&dept_nr=36\">$LDNews</a>", //removed by Kenneth 05-07-2016
                                        'LDMiscDeptMngr' => "<a href='".$root_path."modules/nursing/seg-misc-dept-mngr-pass.php".URL_APPEND."&from=nursing'>".$LDMiscDeptMngr.'</a>',
                                        //Added by Borj 2014-08-04 ISO
                                        'LDNursingUserManual' => "<a href='".$root_path."forms/NursingManual2020_v2.pdf".URL_APPEND."&from=nursing'>".$LDNursingUserManual.'</a>',
										);
