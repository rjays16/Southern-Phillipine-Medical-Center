...
if($edit){
 ...
 $tpbuffer='<input type="text" name="op_date" id="date_text"  value="';
...
// $smarty->assign('gifOpCalendar',"<a href=\"javascript:show_calendar('form_test_request.op_date','$date_format')\">
 //		<img ".createComIcon($root_path,'show-calendar.gif','0','absmiddle')." id=\"date_trigger\" style=\"cursor:pointer\"></a>");

	$smarty->assign('gifOpCalendar','<img ' . createComIcon($root_path,'show-calendar.gif','0','absmiddle') . ' id="date_trigger" style="cursor:pointer">' . $calendarSetup);
