...
$sTemp = 'onLoad="if (window.focus){ window.focus(); ShortcutKeys();}';
...
//---------------adde by VAN 02-06-08
	function ShortcutKeys(){
		shortcut.add('Shift+M', BackMainMenu,
							{
								'type':'keydown',
								'propagate':false,
							}
	...
	function BackMainMenu(){
		urlholder="../../modules/laboratory/labor.php<?=URL_APPEND?>";
...
onLoad="if (window.focus){ window.focus(); ShortcutKeys(); }
     ...
     <tr>
       ...
       <td>
	     ...
	     //$phpfd=str_replace("yy","%Y", strtolower($phpfd));
			?>
			 <input type="text" name="transfusion_date" id="date_text" size=20 maxlength=10  value="<?php  if($mode=='edit') echo formatDate2Local($stored_request['transfusion_date'],$date_format); ?>"  onBlur="IsValidDate(this,'<?php echo $date_format ?>')" onKeyUp="setDate(this,'<?php echo $date_format ?>','<?php echo $lang ?>')">
	...
	Calendar.setup ({
     ...
     <tr>
       ...
       <td>
	     ...
	     //$phpfd=str_replace("yy","%Y", strtolower($phpfd));
			?>
			 <input type="text" name="send_date" id="date_text" size=20 maxlength=10  value="<?php  if($mode=="edit") echo formatDate2Local($stored_request['send_date'],$date_format); else echo formatDate2Local(date("Y-m-d"),$date_format) ?>" onBlur="IsValidDate(this,'<?php echo $date_format ?>')" onKeyUp="setDate(this,'<?php echo $date_format ?>','<?php echo $lang ?>')">
