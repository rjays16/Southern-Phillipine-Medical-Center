<?php
    ...
    //encounter info
    $strSQL = "SELECT ce.admission_dt AS DateAdmitted, ce.discharge_date AS DateDischarged, ce.encounter_date
               FROM care_encounter ce WHERE ce.encounter_nr = '$enc_no'";
