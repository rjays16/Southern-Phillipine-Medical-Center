<?php
/* $Id: sqlvalidator.class.php,v 1.2 2005/10/29 20:08:13 kaloyan_raev Exp $ */
...
* $Source: /cvsroot/care2002/Care2002/modules/phpmyadmin/libraries/sqlvalidator.class.php,v $
*
...
*
* @version  $Id: sqlvalidator.class.php,v 1.2 2005/10/29 20:08:13 kaloyan_raev Exp $
*/
    ...
    if (!function_exists('class_exists') || !class_exists('SOAP_Client')) {
		...
		$use_array = array("a_sessionId" => $session->sessionId, "a_sessionKey" => $session->sessionKey, "a_SQL" => $sql, "a_resultType" => $this->output_type);
            ...
            function PMA_SQLValidator()
            {
                ...
                $this->calling_program_version       = '$Revision: 1.2 $';
