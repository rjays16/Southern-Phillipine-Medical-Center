...
$allowedarea=&$allow_area['phicrvu'];
$phic = $_GET['phic'];

$fileforward='icpm_manage.php'.URL_REDIRECT_APPEND.'&phic='.$phic;
$thisfile=basename(__FILE__);
$breakfile=$root_path.'main/spediens.php'.URL_APPEND;

$lognote="$LDicpmMngr ok";
...
<FONT  COLOR=<?php echo $cfg[top_txtcolor] ?>  SIZE=6  FACE="verdana"> <b><?php echo $LDicpmManager; ?></b></font>
