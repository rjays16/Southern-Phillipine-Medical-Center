...
echo '</td></tr>';
// ***************
//$frow=  '<tr bgcolor="#f9f9f9">';
//$frow .= '<td><font face="verdana,arial" size="1"><b>&nbsp; heheheh</b></td>';
//$frow .='</tr>';
//
//echo $frow;
//***************
...
//Comment by mark 
//$frow = '<table id="oplogmainTable" name="oplogmainTable" with="100%" border="0" cellpadding="0" cellspacing="1"> '.
//			'<thead></thead> '.
//			'<tr bgcolor="#f9f9f9">No Data'.
//			'</tbody>'.
//		'</table>';
//echo $frow;		
...
//		    echo "<br> myPersonell_nr=>".$myPersonell_nr;
