...
//								$sbuf=$result[$element]." ~n=".$ln.",+".$fn."&x=".$nx;
								...
								echo "<br> operator+1 =".$unserialize['operator+1'];
								echo "<br> operator+2 =".$unserialize['operator+2'];
								echo "<br> operator+3 =".$unserialize['operator+3'];
