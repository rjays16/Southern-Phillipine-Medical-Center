		...
		if (nr) {
				...
				alt = (dRows.length%2)+1;
					rowSrc = '<tr class="wardlistrow'+alt+'">' +
									'<td>&nbsp;<input type="radio" name="saal" value="'+room_nr+'" id="'+nr+'" onClick="ShowContinueButton(this.value);">&nbsp;&nbsp; '+room_nr+'&nbsp;</td>'+
									'<td>&nbsp;'+info+'&nbsp;</td>'+
								'</tr>';
		} 
		else {
  ...
  <tr>
	...
	<!--  Start of the OR room numbers block -->
		<table  cellpadding="2" cellspacing=0 border="0">
			...
			<!-- edited by VAN 06-24-08 -->
			<!--<table  cellpadding="2" cellspacing=0 border="0">-->
			<table id="ORRoomList"  cellpadding="2" cellspacing=0 border="0" width="100%">
		...
		if(is_object($ORNrs)){
			...
			while($room=$ORNrs->FetchRow()){
				...
				#echo '>&nbsp;&nbsp;'.$bold;
				#edited by VAN 06-24-08
				echo ' onClick="ShowContinueButton(this.value);" >&nbsp;&nbsp;'.$bold;
