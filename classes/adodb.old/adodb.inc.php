	...
	*/
	...
	function BeginTrans() {
		switch ($this->databaseType) {
			case 'mysql':
				$this->Execute("START TRANSACTION");		// Added by LST 4.18.2008 - For MySQL support.
				break;
	...
	function CommitTrans($ok=true) { 
		switch ($this->databaseType) {
			case 'mysql':	
				$this->Execute("COMMIT");					// Added by LST 4.18.2008 - For MySQL support.
				break;
	...
	function RollbackTrans() { 
		switch ($this->databaseType) {
			case 'mysql':
				$this->Execute("ROLLBACK");					// Added by LST 4.18.2008 - For MySQL support.
				break;
