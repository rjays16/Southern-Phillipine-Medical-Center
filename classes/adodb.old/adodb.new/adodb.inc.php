...
*/
	...
	*/
	function CompleteTrans($autoComplete = true)
	{
        ...
        $this->SetAutoCommit();             // Added by LST for transactions. 11.26.2008
   ...
   * If $sql == false, then we purge all files in the cache.
	...
	*/
	...
	function Close()
	{
     ...
     // Added by LST for transactions. 11.26.2008
    function SetAutoCommit($on = true) {
        if (!$on) {
	...
	function BeginTrans() 
	{
        ...
        switch ($this->databaseType) {
            case 'mysql':    
                $this->SetAutoCommit(false);                // Added by LST for transactions. 11.26.2008
