...
/******
*
*	Class containing all properties and methods related to an encounter's medicines.
*
...
class PerMedicineCoverage {	
    ...
    function setMedsAddedFlag($bflag) {
        $this->bMedsAddedByBilling = $bflag;
    }
    ...
    function getMedsAddedFlag() {
        return($this->bMedsAddedByBilling);
    }
