 ...
 * @package
 */
require_once($root_path . 'include/care_api_classes/ehr/Curl.php');
require_once($root_path . 'include/care_api_classes/class_hospital_admin.php');

class ServiceContext extends Curl {
    ...
    protected function getBaseUrl() {
        ...
        $baseUrl = 'localhost'; // for local development, comment in  production. rnel
        
        if (isset($baseUrl)) {
            //allows ip address only as base url
            // self::$baseUrl = preg_replace('/[^0-9.]/', '', $baseUrl);            // uncomment this line in production. rnel
            self::$baseUrl = $baseUrl; // for local development, comment in  production. rnel
            return self::$baseUrl;
        }
        return null;
    }
