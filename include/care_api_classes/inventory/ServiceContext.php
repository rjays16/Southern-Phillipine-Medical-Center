...
class INVServiceContext extends Curl {
    ...
    public function execute() {
        ...
        exec(sprintf('ping -c 1 -W 1 %s', escapeshellarg(self::$baseUrl)), $res, $rval);
        if($rval !== 0)
            return false;

       // $apiKey = Hospital_Admin::get('INV_api_key');
       // $this->params['SEGAPIK'] = $apiKey;
    ...
    protected function getBaseUrl() {
        $baseUrl = Hospital_Admin::get('INV_address');
