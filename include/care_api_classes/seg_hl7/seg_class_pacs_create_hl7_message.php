	...
	class seg_create_msg_HL7{
		...
		function createSegmentPID($details){
           ...
           # street address^other designation^city^state or province^postal code
             ...
             $_pid_11 = preg_replace('/\'/', "\\\'", $details->address);
		...
		function createSegmentOBR($details){
            ...
            # 5.1 priority comment
            # default _BLANK
            $_obr_5_1 = $details->POH_PRIORITY_COMMENT;
            ...
            */
            ...
            $obr = "OBR|1|".$_obr_2."||".$_obr_4."|".$_obr_5."^".$_obr_5_1."|".$_obr_6."|||||||".$_obr_13."|||".$_obr_16."||".$_obr_18."||||||".$_obr_24."||||".$this->delimiter;
