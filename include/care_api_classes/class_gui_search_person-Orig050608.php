...
#echo "<br>class_gui_search_person : C getDateFormat() = '".getDateFormat()."' <br><br> \n";
	...
	#echo "sql = ".$sql3;
			...
			#echo "mode = ".$mode;
#echo "class_gui_search_person.php : HTTP_SESSION_VARS['sess_searchkey'] = '".$HTTP_SESSION_VARS['sess_searchkey']."'; mode = '".$mode."' <br> \n";
...
#				$sql='SELECT pid, name_last, name_first, date_birth, addr_zip, sex, death_date, status FROM '.$fromwhere.$sql3;   # burn commented: March 8, 2007
				$sql="SELECT cp.pid, cp.name_last, cp.name_first, cp.date_birth, cp.addr_zip, cp.sex, cp.death_date, cp.status ".
