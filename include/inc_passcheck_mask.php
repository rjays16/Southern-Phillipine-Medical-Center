...
if (isset($pass)&&($pass=='check')&&($passtag)){
	...
	switch($passtag){
		...
		case 2:$errbuf="$errbuf $LDNoAuth";
					...
					break;
		case 4:$errbuf="$errbuf $LDOneSignalUnsubscribed";
					$err_msg="<div class=\"warnprompt\">$LDOneSignalUnsubscribed</div><br>$LDPlsContactEDP";
					//echo '<img '.createLDImgSrc($root_path,'cat-noacc.gif','0','left').'>';
					break;
...
<input type="hidden" name="onesignalidLogin" id="onesignalidLogin">
