...
#$LDOrLogBook='Operating Room Nursing Journal';
$LDOrLogBook='Operating Room Journal';
#$LDOrLogBookTxt='Documenting the nursing services in OP Room, archive files';
$LDOrLogBookTxt='Documenting operations or Operating Room services and viewing the archived files';
...
$LDCaseNr='Case nr.';	#-----added by pet, 2008apr21-----
...
$LDSProcedure = 'Surgical Procedure';	#---added by pet, 2008apr22---
...
$LDOpMainElements=array(
										...
										ana=>'Anesthesia', //---edited from 'An�sthesie', 11-08-2007, fdp---
										cutclose=>'Cut/Suture',
										#therapy=>'Therapy',
										therapy=>'Operation/Surgical Procedure',	#---replaced by pet, 2008apr22---
										result=>'Result',
										inout=>'Entry/Exit'
										);
$LDOpCut='Cut';
...
$tbuf=array('O','A','S','R');
$cbuf=array('Surgeon','Assistant','Scrub nurse','Circulating nurse');
...
//$LDPromptSearch='Please enter a search keyword.<br>Like for example a given name, family name, or a birthdate, etc.	(See also "Help")'; ---edited, 11-06-2007, fdp---
$LDPromptSearch='Please enter a search keyword.<br>Such as a given name, family name, or a birthdate.	(See also "Help")';
$LDKeyword='Keyword';
