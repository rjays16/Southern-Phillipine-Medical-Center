...
$LDMedDepotRetail="Retail";   # burn added: August 3, 2006
$LDMedDepotRetailTxt="Medical Depot retail module";   # burn added: August 3, 2006

$LDMedDepotNewsTxt='Read or write news articles pertaining to medical depot';   # burn added: August 7, 2006
$LDMedDepotWasSent='Somebody has either already sent the order to the medical depot or erased it! Please create a new order list. Thank you.';   # burn added: August 7, 2006
$LDMedDepotOrderSent='The following order list was sent to the medical depot. Thank you!';   # burn added: August 7, 2006
$LDMedDepotDataRemoved='The information could have been removed from the medical depot\'s databank.';   # burn added: August 7, 2006
$LDMedDepotNewProductTxt='Enter new medical depot product in the databank';   # burn added: August 7, 2006
     # medlager-datenbank-functions.php Line 66
$LDMedDepotInfoTxt='Search and read information pertaining to medical depot';   # burn added: August 7, 2006
$LDMedDepotSearchDb='Search in the medical depot databank';   # burn added: August 7, 2006
     # medlager-datenbank-functions.php Line 76
$LDMedDepotDataNoFoundTxt='The information cannot be found. An error occured somewhere. Please click the \'Close\' button and try to
reopen the order list. If this problems occurs even after several trials, please notify the medical depot and the EDP departments. Thank you.';    # burn added: August 7, 2006

$LDPharmaRetail="Retail";
$LDPharmaRetailTxt="Pharmacy retail module";
